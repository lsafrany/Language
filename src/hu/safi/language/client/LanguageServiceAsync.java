...
public interface LanguageServiceAsync {
	...
	void addSubTheme(String subTheme, SubThemeSer subThemeSer, AsyncCallback<SubThemeSer> callback) throws IllegalArgumentException;

	void items(String subTheme, AsyncCallback<List<ItemSer>> callback) throws IllegalArgumentException;

	void addItem(String subTheme, ItemSer itemSer, AsyncCallback<ItemSer> callback) throws IllegalArgumentException;
