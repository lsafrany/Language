		...
		if (!subThemeList.isEmpty()) {
			for (SubTheme s : subThemeList) {
				if (s.getName().equals("Fordítási gyakorlat")) {
					Item item1   = new Item(s.getKey(),"Mióta vársz magasabb életszínvonalra?","How long have you been waiting for a higher standard of living?");
					Item item2   = new Item(s.getKey(),"Mióta próbálja visszaszerezni?","How long has he been trying to get it back?");
					Item item3   = new Item(s.getKey(),"Mióta tervezik, hogy összeházasodnak?","Since when have they been planning to get married?");
					Item item4   = new Item(s.getKey(),"6 éve vagyok nős/férjnél.","I have been married for 6 years.");
					Item item5   = new Item(s.getKey(),"Első találkozásunk óta szeretlek.","I have been in love with you since we first met.");
					...
					Item item13  = new Item(s.getKey(),"Tizennégy éves kora óta ír naplót.","She’s been keeping a diary since she was fourteen.");
					Item item14  = new Item(s.getKey(),"Dél óta alszik.","He has been sleeping since noon.");
					Item item15  = new Item(s.getKey(),"Már öt perce szól a telefon.","The phone has been ringing for five minutes.");
					Item item16  = new Item(s.getKey(),"Azóta horkol, mióta kivették a manduláját.","He has been snoring since his tonsils were removed.");
					...
					Item item21  = new Item(s.getKey(),"Mióta miniszter lett, autóval jár.","He has been travelling in a car since he became a minister.");
					Item item22  = new Item(s.getKey(),"Már egy hete csak a mamára gondolok.","I’ve been thinking of mum for a week.");
					Item item23  = new Item(s.getKey(),"Ősz óta az öbölben úsznak a magányos hattyúk.","The lonely swans have been floating in the bay since autumn/fall.");
					Item item24  = new Item(s.getKey(),"Mióta jár Jóska Gézával?","How long has Joe been dating Géza?");
					Item item25  = new Item(s.getKey(),"Már egy hete csak a mamára gondolok.","I've been thinking of Mum for a week now.");
					Item item26  = new Item(s.getKey(),"Még fél évig sem éltek együtt, mikor elváltak.","They had been living together for less than half a year when they got divorced. ");
					Item item27  = new Item(s.getKey(),"Mióta megnosült, egész másképp viselkedik.","Since she got married, she's been behaving rather differently.");
					Item item28  = new Item(s.getKey(),"Egész nap úgy hiányoztál.","I've been missing you all day.");
					Item item29  = new Item(s.getKey(),"Te jó isten, mennyit ittál! Nyugi, anyukám, nem ittam többet, mint a Józsi, pedig o már tegnap elkezdte, és még most sem fejezte be.","Oh, my God, you've been drinking a lot! Easy, mum, I haven't drunk more than Joe, mind you, he started it yesterday and hasn't finished it yet.");
					Item item30  = new Item(s.getKey(),"Három éve hordja azt a rongyos farmert.","She's been wearing that shabby pair if jeans for three years.");
					Item item31  = new Item(s.getKey(),"Mióta megláttalak a bokrok alatt, csak rólad álmodom.","I've been dreaming about you since I saw you under the bushes.");
					Item item32  = new Item(s.getKey(),"Mióta megérkezett a városba, a legdrágább szállodában lakik.","Since he arrived in town, he has been living in the ritziest hotel.");
					Item item33  = new Item(s.getKey(),"Úgyhogy most három napja táncol.","So now she's been dancing for three days.");
					Item item34  = new Item(s.getKey(),"Egy hete lakom a California szállodában.","I've been living in the Hotel California for a week.");
					Item item35  = new Item(s.getKey(),"Már egy órája olvassa azt a kurta cikket.","Ha has been reading that short article for an hour already.");
					...
					Item item38  = new Item(s.getKey(),"Lábát törte, így nem jöhet velem diszkózni.","He has broken his leg he can’t come with me to the disco.");
					...
					Item item54  = new Item(s.getKey(),"Egész mostanáig boldogok voltunk.","We have been very happy until recently.");
					...
					Item item60  = new Item(s.getKey(),"A kezét már megkérte, de még nem vette el.","He’s already popped the question, but he hasn’t married yet.");
					Item item61  = new Item(s.getKey(),"Még sose féltem így.","I’ve never been so scared.");
					Item item62  = new Item(s.getKey(),"Még mindig nem felelt.","He hasn’t yet answered. (He still hasn’t answered.)");
					...
					Item item65  = new Item(s.getKey(),"Évek óta nem ettem ilyen jó véreshurkát.","I haven't eaten such good blood pudding for years.");
					Item item66  = new Item(s.getKey(),"A mai napig nem felejtettem el azt a szeptemberi estét, mikor eloször láttalak meg a szénakazal tövibe'.","I haven't forgotten the night in September when I first saw you in the shade of the haybale.");
					...
					Item item70  = new Item(s.getKey(),"Kettőkor jöttek meg, de azóta se láttuk őket.","They arrived at two we haven't seen them ever since.");
					Item item71  = new Item(s.getKey(),"Az összes húst bepaníroztad?","Have you coated all the meat with breadcrumbs?");
					...
					Item item74  = new Item(s.getKey(),"Láttál te már felnőtt férfit meztelen?","Have you ever seen a brown man naked?");
					Item item75  = new Item(s.getKey(),"Megetted már amit tegnap főztem?","Have you yet eaten what I cooked yesterday?");
					Item item76  = new Item(s.getKey(),"A cipőjét és a kabátját levette, az ingét épp most gombolja, de a fülbevalóját még nem kattintotta ki.","She has taken off her shoes and coat, she's undoing her louse right now, but she hasn't unclipped her earrings yet.");
					Item item77  = new Item(s.getKey(),"Mondtam már neked, hogy ne szopd az ujjad!","I've already told you not to suck your finger!");
					...
					Item item81  = new Item(s.getKey(),"Nem említettem még neked azt az estét, mikor véletlenül rossz buszra szálltam?","Haven't I mentioned to you the case when I accidentally took the wrong bus?");
					Item item82  = new Item(s.getKey(),"Ugye még nem meséltem azokról az időkről, mikor kéz a kézben mentünk a Dózsa György úton május 1-jén?","I haven't told you about the days when we were walking hand in hand on Dózsa György road on May Day, have I?");
					Item item83  = new Item(s.getKey(),"Felfújta a lufit, és az most akkora, mint egy ház.","He has blown up the balloon and now it's as big as a house.");
					Item item84  = new Item(s.getKey(),"Most már befejeztem.","I've finished it now.");
					Item item85  = new Item(s.getKey(),"Meglocsoltad már a feleséged? Ot még nem locsoltam meg, de a barátnomet már igen. Tegnap mentem hozzá és kaptam tole piros tojást. A feleségemtol piros tojást még nem kaptam, de a sodrófát már elovette. Még nem csapott a fejemre, de nagyon félek, mert tavaly úgy kupán vágott, hogy még most sem ment le a púp a fejemrol.","Have you sprinkled your wife? No, I haven't, but I've already sprinkled my girlfriend. I went to her place yesterday and I got a red egg from her. I haven't got a red from my wife yet, but she has already produced the rolling pin. She hasn't yet hit me on the head but I'm scared because last year she hit me on the head so hard that the lump hasn't gone down from my head yet.");
					Item item86  = new Item(s.getKey(),"Ittam egy kis kólát, és most csuklok.","I've drunk some coke and now I'm hiccuping.");
					Item item87  = new Item(s.getKey(),"Te csöngettél, Tasziló?","Have you rung the bell, Tasziló?");
					Item item88  = new Item(s.getKey(),"A hullámvasúton már ültem, de az elvarázsolt kastélyban még nem voltam.","I've already traveled on the roller coaster but I haven't been to the haunted castle.");
					Item item89  = new Item(s.getKey(),"Ivott egy pohár vodkát és most itt kacsázik az utcán.","He has drunk a glass of vodka and now he's zigzagging in the street.");
					Item item90  = new Item(s.getKey(),"Még sosem volt ilyen szerencsém.","I've never been so lucky.");
					Item item91  = new Item(s.getKey(),"Én még sohasem utaztam a szellemvasúton, soha sem láttam a nagy sárkányt.","I have never ever traveled on the ghost train, I have never ever seen the large dragon.");
					Item item92  = new Item(s.getKey(),"Láttál te már mackót málnásban?","Have you ever seen a bear in raspberries?");
					...
					Item item98  = new Item(s.getKey(),"Amikor majd elolvasod, légyszives add ide.","When you've read it, please give it to me.");
					Item item99  = new Item(s.getKey(),"Amikor befejezi, összesen hat napja fog táncolni.","When she has finished, she'll have been dancing for six days altogether.");
					Item item100 = new Item(s.getKey(),"Ugye milyen sokat javult az életszínvonaluk? De idétlen vagy.","Our living standard has improved greatly, hasn't it? How stupid can you get!");
					...
					Item item103 = new Item(s.getKey(),"Általában 7-kor kel, de e héten 8-kor.","He usually gets up at 7, but this week he is getting up at 8.");
					Item item104 = new Item(s.getKey(),"Általában Camparit iszik, de ma este kevertet.","She generally drinks Campari, but this evening she is drinking “kevert”.");
					Item item105 = new Item(s.getKey(),"Állandóan ezt a hülye disco-lemezt hallgatja!","He is always listening to that stupid disco record!");
					...
					Item item109 = new Item(s.getKey(),"Holnap este színházba megyek.","I am going to the theatre tomorrow night.");
					...
					Item item130 = new Item(s.getKey(),"Ezen a tavaszon fogok férjhez menni.","I'm going to get married this spring.");
					Item item131 = new Item(s.getKey(),"Itt ül az ido a nyakamon.","Time is sitting on my neck.");
					Item item132 = new Item(s.getKey(),"Nincs hozzászokva ahhoz, hogy busszal járjon a piacra.","She is not used to going to the market by bus.");
					...
					Item item136 = new Item(s.getKey(),"Ballag a katona, szájában csutora.","The GI is trudging with a mouthpiece in his mouth.");
					Item item137 = new Item(s.getKey(),"Apu, mit csinál a kutya a fánál?","Daddy, what's the dog doing by the tree?");
					Item item138 = new Item(s.getKey(),"Állandóan újságot olvas reggeli közben.","He is always reading a paper during breakfast.");
					Item item139 = new Item(s.getKey(),"Hu de köhögsz. Csak nem fáztál meg?","Hey, you are coughing a lot. I hope you haven't caught a cold.");
					Item item140 = new Item(s.getKey(),"Hegyek között, völgyek között zakatol a vonat.","The train is rattling along between mountains and valleys.");
					Item item141 = new Item(s.getKey(),"Csörög a lánc. Mi? Csörög a lánc. Nem hallom, mert csörög a lánc.","The chain is rattling! What? The chain is rattling! I can't hear you because the chain is rattling.");
					Item item142 = new Item(s.getKey(),"Mit sütsz kis szucs? Sós húst sütsz kis szucs?","What are you frying little furrier? Are you frying salty meat, furrier? ");
					Item item143 = new Item(s.getKey(),"Süt a pék, süt a pék gezemice lángost.","The baker is frying, the baker is frying hotchpotch dough.");
					...
					Item item151 = new Item(s.getKey(),"Idáig vagyok az üzleti problémáiddal.","I'm having to here with your business problems.");
					...
					Item item157 = new Item(s.getKey(),"Az állatok sosem ölnek pénzért.","Animals never kill each other for money.");
					...
					Item item179 = new Item(s.getKey(),"Futni szoktam, de úszni nem járok.","I usually go running but I never go swimming.");
					...
					Item item187 = new Item(s.getKey(),"Hányszor mosol naponta fogat?","How many times a day do you clean your teeth?");
					Item item188 = new Item(s.getKey(),"Józsi bácsi már nem dolgozik itt.","Józsi bácsi doesn't work here anymore.");
					Item item189 = new Item(s.getKey(),"Malacka minden nap meglátogatja Micimackót.","Piglet goes to see Winnie-the-Pooh every day.");
					...
					Item item192 = new Item(s.getKey(),"Mindig este zuhanyozok, mert reggel rohanok.","I always take a shower in the evening because in the morning I'm in a hurry.");
					...
					Item item199 = new Item(s.getKey(),"Mindig azt mondod, hogy visszafogott vagyok.","You always say I'm too reserved.");
					Item item200 = new Item(s.getKey(),"Sose olvas.","He never reads.");
					Item item201 = new Item(s.getKey(),"Néha olvas.","Sometimes he reads.");
					Item item202 = new Item(s.getKey(),"Minden este étteremben vacsorázik.","He has dinner in a restaurant every evening.");
					Item item203 = new Item(s.getKey(),"Mikor felébredtem, már 10 perce ment a vonat.","When I woke up, the train had been going for ten minutes.");
					Item item204 = new Item(s.getKey(),"Mikor a sarokra értem, a lány már 20 perce ott várt.","When I got to the corner, the girl had been waiting for twenty minutes. ");
					Item item205 = new Item(s.getKey(),"Már tíz perce gépelt, mikor látta, hogy nincs papír a gépben.","He had been typing for ten minutes when he saw there was no sheet in the typewriter. ");
					Item item206 = new Item(s.getKey(),"Mikor felébredt, a kakas már fél órája kukorékolt.","When he woke up, the cock had been crowing for half an hour.");
					Item item207 = new Item(s.getKey(),"Még csak öt perce ettek, mikor újabb vendégek érkeztek.","They had only been eating for five minutes when more guests arrived.");
					Item item208 = new Item(s.getKey(),"Már egy órája ugatott a kutya, mikor végre kiment.","The dog had been barking for an hour when at least he went out.");
					Item item209 = new Item(s.getKey(),"Nagy elánnal bontotta a csirkét, amikor rájött, hogy nincs otthon zsír.","She had been easily carving up the chicken when she realized there was no lard at home.");
					Item item210 = new Item(s.getKey(),"Órák hosszat ült a rókalyuk elott, mikor végre feltunt egy nyuszi.","He had been sitting at the fox-hole for hours when at least a hare/rabbit/bunny showed up.");
					Item item211 = new Item(s.getKey(),"Még tíz percet sem vezetett a forgalomban, mikor a vizsgabiztos megkérte, hogy cseréljenek helyet.","She had been driving in the traffic for less than 10 minutes when the examiner asked her to change seats.");
					Item item212 = new Item(s.getKey(),"Már vagy három órája nyomta a csengot, mikor a házmester végre kinézett.","He had been ringing the bell for three hours when the caretaker looked out at last.");
					Item item213 = new Item(s.getKey(),"Már két órája beszélt, mikor rájött, hogy senki nincs a szobában.","She had been talking for two hours when she realized there was nobody in the room.");
					Item item214 = new Item(s.getKey(),"Magas lovon ült, mielott lebukott.","He had been riding high before he had a fall.");
					Item item215 = new Item(s.getKey(),"Tegnap már két napja táncolt.","Yesterday she had been dancing for two days.");
					Item item216 = new Item(s.getKey(),"Csak olvasta, olvasta, mikor látta, hogy fejjel lefelé van.","He had been reading and reading when he saw it was upside down.");
					Item item217 = new Item(s.getKey(),"Mire kiért az állomásra, a vonat már elment.","By the he got to the station, the train had already left.");
					Item item218 = new Item(s.getKey(),"Mire rájöttem, hogy szélhámos, már összetört a szívem.","When I realized she was a swindler, she had already broken my heart.");
					Item item219 = new Item(s.getKey(),"Dühös voltam rá, mert elfelejtete föladni a levelet.","I was angry with him because he had forgotten to post the letter.");
					Item item220 = new Item(s.getKey(),"Mire a vadász megtöltötte a pukáját, a nyuszi már elszaladt.","By the time the hunter had loaded his gun, the hare had already run away.");
					Item item221 = new Item(s.getKey(),"Mielott elszaladt, sárgarépát dugott a puska csövébe.","Before she run away she had put a carrot into the muzzle of the rifle.");
					Item item222 = new Item(s.getKey(),"Már rég megsavanyodott a túró rudi, mire rászánta magát, hogy megegye. ","CCR (Cottage Cheese Rudolph) had gone sour long before he brought himself to eat it.");
					Item item223 = new Item(s.getKey(),"Miután megette, rosszul lett.","After he had eaten it, he got sick.");
					Item item224 = new Item(s.getKey(),"Egész tavaly nyárig Mehemed nem is látott tehenet.","Until the very last summer Mehemed hadn’t even seen a cow.");
					Item item225 = new Item(s.getKey(),"Mesélt a lovakról, akiket lovászfiú korából ismert.","He droned on about horses he had known when he was an ostler.");
					Item item226 = new Item(s.getKey(),"Pipa volt, mikor látta, hogy nem hoztam kenyeret.","She went mad when she saw I hadn’t brought bread.");
					Item item227 = new Item(s.getKey(),"Megoszültem, mire ezt megírtam.","My hair had turned grey by the time I wrote this.");
					Item item228 = new Item(s.getKey(),"Jól megrágta, mielott kiköpte.","He had chewed it well before he spat it out.");
					Item item229 = new Item(s.getKey(),"Nem látott semmit, míg fel nem rakta a szemüvegét.","He hadn't seen a thing until he put on his glasses.");
					Item item230 = new Item(s.getKey(),"Korán lefeküdt, így aztán hazaért nyolcra.","She had gone to bed early, so she got home by eight.");
					Item item231 = new Item(s.getKey(),"A nap is lement mire elolvastad.","The sun had set by the time you read it.");
					Item item232 = new Item(s.getKey(),"Épp egy dalt dúdoltam, mikor a gyerekek betörték az ablakot.","I was singing a song when the children broke the window.");
					Item item233 = new Item(s.getKey(),"A lámpát szerelte, mikor agyonvágta az áram.","He was repairing the electricity when a short circuit killed him.");
					Item item234 = new Item(s.getKey(),"Épp sütotököket ettünk, mikor lazán megszólalt:…","We were eating pumpkin pie when he casually said…");
					Item item235 = new Item(s.getKey(),"Aludtál az eloadás alatt?","Were you sleeping during the show?");
					Item item236 = new Item(s.getKey(),"Miközben golfozott, a száját harapdálta.","While he was playing golf, he was biting his lips.");
					Item item237 = new Item(s.getKey(),"Fél nyolckor nem a hiradót nézte, hanem a fiát fürdette.","At seven-thirty he was not watching the news but he was bathing his son.");
					Item item238 = new Item(s.getKey(),"Sokáig tartotta Toldi Miklós a petrencét.","T.M. was holding the hay shaft for a long time.");
					Item item239 = new Item(s.getKey(),"Útközben a lányokról beszélgettek.","On the way they were talking about girls.");
					Item item240 = new Item(s.getKey(),"Épp krumpliért állt sorba, mikor meglátta a karfiolfülüt.","She was queuing for potatoes when she saw the one with cauliflower ears.");
					Item item241 = new Item(s.getKey(),"Végig a film alatt a hátát vakargatta.","She was scratching his back during the whole film.");
					Item item242 = new Item(s.getKey(),"Még éjfélkor is a mesét nézte.","He was watching the tale even at midnight.");
					Item item243 = new Item(s.getKey(),"Míg a nyuszi magyarázott, Micimackó mézre gondolt, Malacka a földet nézte, Bagoly meg a haját tépte.","Whlie Rabbit was explaining, Winnie-the-Pooh was thinking of honey, Piglet was staring at ground, and Owl was tearing his hair.");
					Item item244 = new Item(s.getKey(),"Egész úton hazafelé azon gondolkodám…","All my way home I was wondering…");
					Item item245 = new Item(s.getKey(),"Amíg a lányok csevegtek, addig a fiúk a bányában dolgoztak.","While the girls were chatting, the boys were working in the colliery.");
					Item item246 = new Item(s.getKey(),"A rakodópart alsó kövén ültem, és néztem, hogy úszik a dinnyehéj.","I was sitting on the lower stone of the quay watching the melon rind foating.");
					Item item247 = new Item(s.getKey(),"Nagyon esett, mikor leszálltál a buszról?","Was it pouring when you got off the bus?");
					Item item248 = new Item(s.getKey(),"Egész este dünnyögött.","He was mumbling all evening.");
					Item item249 = new Item(s.getKey(),"Épp az utcán sétáltam, mikor a baleset történt.","I was walking in the street when the accident happened.");
					Item item250 = new Item(s.getKey(),"Meredten bámult a távolba, mikor egyszercsak megpillantotta Aljosát.","She was staring into space when out of a sudden she caught sight of Aliosha.");
					Item item251 = new Item(s.getKey(),"A bártündér a villanyokat oltogatta, a lány a fogasnál állt, mikor egy fiatal rendor lépett be a hátsó ajtón át.","The bartender was putting out the lights, the girl was standing by the clothes tree, when a young cop entered the back door.");
					Item item252 = new Item(s.getKey(),"Az istálló hátsó részében tehenek aludtak szalmán. ","At the far side of the barn cows were sleeping on straw.");
					Item item253 = new Item(s.getKey(),"Szóval borotválkozott, megcsúszott és levágta az orrát. Aztán elejtette a borotvát és levágta a lába ujját. Az orvos elszúrt valamit és a lábujját varrta az arcára, az orrát meg a lábára, és most azért reklamál, mert amikor tüsszent, mindig lerepül a cipoje. ","So, you were shaving, you slipped and cut your nose off. Then you dropped the razor and cut your off. The doctor made a mistake and he sewed your toe onto your face and your nose onto your foot, and now you complain that every time you sneeze you blow your shoe off.");
					Item item254 = new Item(s.getKey(),"Az egyikük a könyvet tartotta, a másik meg olvasott.","One of them was holding the book, the other one was reading.");
					...
					Item item264 = new Item(s.getKey(),"Eloször Csorvásra ment, aztán meg kardoskútra.","First he went to Csorvás, then to Kardoskút.");
					Item item265 = new Item(s.getKey(),"Te is vidéken nottél fel?","Did you also grow up in the provinces.");
					Item item266 = new Item(s.getKey(),"Ezt a céklát még júniusban raktam el.","I pickeled this beetroot in June.");
					...
					Item item272 = new Item(s.getKey(),"Ránézett a lányra, kacsintott, búcsút intett neki, aztán belépett a liftaknába.","He looked at the girl, winked at her, waved good bye and stepped into the lift shaft.");
					Item item273 = new Item(s.getKey(),"Belépett a szobába. De elotte lezuhanyozott.","He entered the room. But he had taken a shower before.");
					Item item274 = new Item(s.getKey(),"Amikor én még kissrác voltam, minden nap elmentem meglesni a lányokat a munkásszállás fürdojében.","When I was a little boy I used to go and see girls in the bath of the workers' hostel every day.");
					Item item275 = new Item(s.getKey(),"Ez elment vadászni, ez meglotte, ez hazavitte, ez megsütötte, ez az iciripiciri meg mind megette.","This one went hunting, this one shot it, this one took it home, this one fried it and this teeny weenie one ate it.");
					Item item276 = new Item(s.getKey(),"Mikor meglátta az egeret, felugrott egy székre.","When she saw the mouse she jumped on a chair.");
					Item item277 = new Item(s.getKey(),"Hol születtél?","Where were you born?");
					Item item278 = new Item(s.getKey(),"Lenin élt, Lenin él, Lenin élni fog.","Lenin lived, Lenin lives, Lenin will live.");
					Item item279 = new Item(s.getKey(),"Szerencse, hogy tegnap nem fájt a fejem.","Luckely enough, I didn't have a headache yesterday.");
					Item item280 = new Item(s.getKey(),"Mire megtalálta az anyát, eltunt a csavar.","By the time he found the nut, the bolt had disappeared.");
					Item item281 = new Item(s.getKey(),"Megitta a tejet, megette a kakaóscsigát, megköszönte a reggelit és bement a szobájába.","He drank the milk, ate the cocoa snail, thanked for the breakfast and went into his room.");
					Item item282 = new Item(s.getKey(),"Hétkor találkoztunk a Nemzetinél.","We met at the National Theatre at seven.");
					Item item283 = new Item(s.getKey(),"Nyáreste volt, pacsirta szólt a fán, ott kóborolt egy cigány.","It was a summer night, there was a lark singing in the tree and a gypsy roaming about.");
					Item item284 = new Item(s.getKey(),"Félt, hogy felébresztett valakit az ordibálásával.","He was afraid he had awaked someone with his shout.");
					Item item285 = new Item(s.getKey(),"Úgy megcsókolt, ahogy, soha senki azelott.","She kissed me in a way I had never been kissed before.");
					Item item286 = new Item(s.getKey(),"Piroska karjára akasztotta a kosarat, amit a nagymamája font.","Little Red Riding Hood put the basket on her arm that her grandma had woven.");
					Item item287 = new Item(s.getKey(),"Olyan nehézségekkel találtam szembe magam, amilyeneket azelott nem tapasztaltam.","I met with difficulties I had never met before.");
					Item item288 = new Item(s.getKey(),"A bíró az ujjával fütyült, mert elfelejtette elhozni a sípját.","The referee used his fingers to whistle, because he had forgotten to take his whistle.");
					...
					Item item291 = new Item(s.getKey(),"Jövore lesz négy éve, hogy Tengizben dolgozik.","Next he’ll have been working in Tengiz for four years.");
					Item item292 = new Item(s.getKey(),"Tiz perc múlva tiz perce lesz, hogy tizóraizik.","In ten minutes he will have been eating his elevenses for ten minutes.");
					Item item293 = new Item(s.getKey(),"Egy óra múlva fél órája fog takaritani.","In an hour she will have been doing the rooms for half an hour.");
					Item item294 = new Item(s.getKey(),"Majd ha lemegy a nap, egy napja lesz, hogy napozik.","When the sun sets she will have been lying in the sun for a day.");
					Item item295 = new Item(s.getKey(),"Mikor feljön a nap, fél napja lesz, hogy alszik.","When the sun rises he will have been sleeping for half a day.");
					Item item296 = new Item(s.getKey(),"Jövo ilyenkor lesz két éve, hogy épiti a házát.","This time next year he will have been building his house for 2 years.");
					Item item297 = new Item(s.getKey(),"Holnap lesz egy éve, hogy csöpög a csap.","Tomorrow the tap will have been dripping for a year.");
					Item item298 = new Item(s.getKey(),"Még egy perc, és pont félórája lesz, hogy itt ordibálsz.","One more minute and you’ll have been yelling here for half an hour.");
					Item item299 = new Item(s.getKey(),"A hónap utolsó vasárnapján lesz egy éve, hogy önmagát keresi.","On the last Sunday of the month he’ll have been looking for himself for a year.");
					Item item300 = new Item(s.getKey(),"Holnap háromkor? Nem, akkor épp a fogorvosnál fog ülni. Ötkor? Nem, akkor épp a fogát fogja borogatni. Úgy érted, hogy hétkor? Nem, akkor már aludni fog. Ja, hogy tegnap hétkor? Nem, akkor vasalt. Tegnapelott hétkor? Akkor meg mosott. Hogy most? Most itt ül mellettem és kuncog.","At three tomorrow? No, then he'll be sitting at the dentist's. At five? No, at that time he'll be having a cold compress on his tooth. You mean at seven? No, he'll be sleeping then. You mean at seven yesterday? No, he was ironing then. At seven the day before yesterday? He was washing then. You mean now? Now, he is sitting next to me and tittering.");
					Item item301 = new Item(s.getKey(),"Vasárnap már három napja lesz, hogy táncol.","On Sunday she'll have been dancing for three days.");
					Item item302 = new Item(s.getKey(),"Kedden lesz egy hete, hogy olvassa.","On Tuesday he'll have been reading it for a week.");
					Item item303 = new Item(s.getKey(),"Holnap reggel négyre az összes gyümölcsöt kiszállitják a piacra.","All the fruit will have been delivered to the market by 4 next morning.");
					Item item304 = new Item(s.getKey(),"Holnap 6-ra a gép már leszáll (leszállt).","The plan will have landed by 6 tomorrow.");
					Item item305 = new Item(s.getKey(),"Mire új gyertyát gyújtasz, a többi már leég. (leégett).","By the time you light a new candle, the other ones will have burnt down.");
					Item item306 = new Item(s.getKey(),"Majd délutánra megirom.","I’ll have written it by this afternoon.");
					Item item307 = new Item(s.getKey(),"Mire hármat számolsz, megcsinálom.","By the time you count up to three, I’ll have done it.");
					Item item308 = new Item(s.getKey(),"Mire megvénülünk, megspórolunk annyit, hogy legyen egy lakásunk.","By the time we get old, we’ll have saved up enough money to buy a flat.");
					Item item309 = new Item(s.getKey(),"Mire fölébredsz, az összes poharat elmosogatom.","By the time you wake up, I’ll have washed up all the glasses.");
					Item item310 = new Item(s.getKey(),"Szeptember végére kinyilnak a kerti virágok.","By the end of September the flowers in the garden will have blossomed.");
					Item item311 = new Item(s.getKey(),"Holnap délutánra fogja megtalpalni a cipomet.","He will have soled my shoes by tomorrow afternoon.");
					Item item312 = new Item(s.getKey(),"Tizenegyre legépelem.","I’ll have typed it by eleven.");
					Item item313 = new Item(s.getKey(),"Jövore lesz 15 éve, hogy nos vagyok.","Next year I'll have been married for 15 years.");
					Item item314 = new Item(s.getKey(),"Megcsinálod mire visszajövök?","Will you have done it by the time I return?");
					Item item315 = new Item(s.getKey(),"Holnap lesz egy hete, hogy sztrájkolnak.","Tomorrow they'll have been on strike for a week.");
					Item item316 = new Item(s.getKey(),"Mire a végére érsz, el fogod felejteni az elejét.","By the time you get to the end, you'll have forgotten the beginning.");
					Item item317 = new Item(s.getKey(),"Mire kisül a hús, kihül a krumpli.","By the time the meat fries, the chips will have got cold.");
					Item item318 = new Item(s.getKey(),"Holnap lesz egy hete, hogy nem mos lábat.","Tomorrow he won't have washed his feet for a week.");
					Item item319 = new Item(s.getKey(),"Úgyis elfelejti az elso részét mire végigolvassa.","He will have forgotten the first part by the time he reads it.");
					Item item320 = new Item(s.getKey(),"Most volt a hirekben, hogy egész jövo héten esni fog.","It has just been on the news that it will be raining all next week.");
					...
					Item item323 = new Item(s.getKey(),"Amig én vasalok, Mari néni foltozni fogja a farmeremet.","While I’m ironing, Mari néni will be sewing a patch on my jeans.");
					Item item324 = new Item(s.getKey(),"Holnap este tizkor a házunk fölött fog elrepülni.","At 10 tomorrow night she’ll be flying over our house.");
					Item item325 = new Item(s.getKey(),"Jövo ilyenkor már a kisbabáját fogja tolni.","This time next year she will be pushing her baby carriage.");
					Item item326 = new Item(s.getKey(),"Jövo ilyenkor nem a Leninkörúton, hanem az Erzsébet körúton fogja tolni a babakocsit.","This time next year she will be pushing the baby carriage on Erzsébet boulevard and not on Lenin Boulevard.");
					Item item327 = new Item(s.getKey(),"Egész délután próbálni fognak.","They’ll be rehearsing all afternoon.");
					Item item328 = new Item(s.getKey(),"Kopogj, ha jössz, mert a fényképeket fogom elohivni.","Knock when you come, because I’ll be developing the photos.");
					Item item329 = new Item(s.getKey(),"A tervek szerint, amikor belép a polgármester, a kórus épp a refrént fogja énekelni.","According to the plans the chorus will be singing the refrain when the Mayor enters.");
					Item item330 = new Item(s.getKey(),"Lefogadom, hogy akkor is olvasni fog, ha néger gyerekek potyognak az égbol.","I bet he'll be reading even when black kids are falling from the sky.");
					...
					Item item335 = new Item(s.getKey(),"A hét végén nem megyünk Nagyszakácsiba.","At the weekend we won’t go to Nagyszakácsi.");
					...
					Item item340 = new Item(s.getKey(),"Ha kisebb mint én, orrbaverem.","If he is smaller than me, I’ll punch him.");
					...
					Item item346 = new Item(s.getKey(),"Igen, azt hiszem, te is fogsz hiányozni nekem.","Yes, I think, I’ll miss you, too.");
					...
					Item item349 = new Item(s.getKey(),"Aigner Szilárd most mondta, hogy eso lesz.","Aigner Szilárd has just said it will rain.");
					Item item350 = new Item(s.getKey(),"Ott az a nagy kövér felho, biztos eso lesz.","There is big fat cloud, it’s going to rain.");
					Item item351 = new Item(s.getKey(),"Te, ez mindjárt leveszi a cipojét.","Hey, he’s going to take off his shoes.");
					Item item352 = new Item(s.getKey(),"Majd a konyhában leveszem a cipomet.","I’ll take off my shoes in the kitchen.");
					Item item353 = new Item(s.getKey(),"Vissza fogom adni, mihelyst megtalálom.","I'll give it back as soon as possible.");
					Item item354 = new Item(s.getKey(),"Hol fogsz dolgozni?","Where will you work?");
					Item item355 = new Item(s.getKey(),"Senki nem fog egy könnycseppet sem hullatni érte.","Not a tear will be shed for him.");
					...
					Item item363 = new Item(s.getKey(),"Eddig még semmit nem mondtak róla.","Nothing has been said about it so far.");
					Item item364 = new Item(s.getKey(),"Épp teritettek, mikor leesett a tányér.","The table was beinnd laid when the plate fell down.");
					Item item365 = new Item(s.getKey(),"A levelet elégették még mielott megtalálták volna.","The letter had been burnt before it was found.");
					Item item366 = new Item(s.getKey(),"Elmozdult, pont amikor fényképezték.","He moved just as the photo was being taken of him.");
					...
					Item item369 = new Item(s.getKey(),"Jövo ?szre learatják a termést.","The crop will have been harvested by next fall.");
					...
					Item item376 = new Item(s.getKey(),"Ezt a könyvet még semmilyen nyelvre nem fordították le.","This book has not been translated into any language yet.");
					Item item377 = new Item(s.getKey(),"Mondd, téged meghívtak?","Say, have you been invited?");
					Item item378 = new Item(s.getKey(),"Új iskolát építenek a falunkban.","A new school is being built in our village.");
					Item item379 = new Item(s.getKey(),"Most viszik, most viszik Danikáné lányát, bíborban, bársonyban…","Old Mrs. Danika's daughter is being taken, right now, in a fancy velvet garment.");
					Item item380 = new Item(s.getKey(),"Legújabb filmjét tartják a legjobbnak.","His latest film is thought to be the best.");
					Item item381 = new Item(s.getKey(),"Nemsoká fölszolgálják a jéghideg söröket.","The ice-cold beer will be served up in no time.");
					...
					Item item384 = new Item(s.getKey(),"Épp most bontják az új felüljárót.","The new flyover is being pulled down.");
					Item item385 = new Item(s.getKey(),"Mire rendorség odaért, a képeket már rég ellopták.","By the time the police got there, the pictures had been stolen.");
					Item item386 = new Item(s.getKey(),"Jó állást ígértek neki.","He has been promised a good job.");
					Item item387 = new Item(s.getKey(),"Manapság sokkal több pénzt költenek húsra, mint tegnapság.","Nowadays much more money is spent on meat than before.");
					Item item388 = new Item(s.getKey(),"Még tíz ilyen mondat, és biztos a diliházba visznek.","Another ten sentences like this, and I'll surely be taken to hospital.");
					Item item389 = new Item(s.getKey(),"A csónakot szem elol tévesztették a suru ködben.","The boat was lost in the dense fog.");
					Item item390 = new Item(s.getKey(),"Már egy csomószor megmondták neked, hogy ne nyúl hozzá.","You've been told lots of times not to touch it.");
					Item item391 = new Item(s.getKey(),"Föl kéne már építeni ezt a házat.","This house should be built now.");
					Item item392 = new Item(s.getKey(),"Most már kell találni valakit, aki ért hozzá.","Somebody has to be found who is good at it.");
					Item item393 = new Item(s.getKey(),"Egy csomó embert följelentettek adócsalásért.","A lot of people were reported for tax evasion.");
					Item item394 = new Item(s.getKey(),"Meg kéne mondani nekik, hogy ezt ne csinálják többé.","They should be told not to do this again.");
					...
					Item item398 = new Item(s.getKey(),"Ötezerre értékelték a vadonatúj nercbundáját.","Her brand new mink has been valued at 5,000.");
					Item item399 = new Item(s.getKey(),"Két lövést hallottak.","Two shots were heard.");
					Item item400 = new Item(s.getKey(),"Ha nem Hong Kongban készült volna, nem venném meg.","If it hadn't been made in Hong Kong, I wouldn't buy it.");
					...
					Item item405 = new Item(s.getKey(),"Jövore talán majd elfogadják a jelentkezésedet.","Maybe your application will be accepted next year.");
					Item item406 = new Item(s.getKey(),"Vettek nékem piros csizmát, rojtosat.","I've been bought red boots with fringes.");
					Item item407 = new Item(s.getKey(),"Hány embert visznek Amerikába a Sorosalapítvánnyal?","How many people will be taken to the States by Soros fund?");
					Item item408 = new Item(s.getKey(),"Az önéletrajzot sajnos angolul kell megírni.","Unfortunately the autobiography has to be written in English.");
					Item item409 = new Item(s.getKey(),"A házat már jóval azelott felépítették, hogy beköltöztek.","The house has been built long before they moved in.");
					Item item410 = new Item(s.getKey(),"A repülogép szerencsétlenség következtében 200 ember vesztette életét.","200 people were killed in the plane crash.");
					Item item411 = new Item(s.getKey(),"A mai napig titkolják a baleset okait.","The causes of the accidents have been concealed so far.");
					Item item412 = new Item(s.getKey(),"Nem létezik, hogy kimosták ezeket a pulóvereket?","These pullovers couldn't have been washed.");
					Item item413 = new Item(s.getKey(),"Ezt mind hibáltanul kellet vona lefordítani?","Should all this have been translated with no mistakes?");
					Item item414 = new Item(s.getKey(),"Az összes pénzt elvitték.","All the money was stolen.");
					Item item415 = new Item(s.getKey(),"Csak néhány bizsut hagytak az öltözködoasztalon.","Only some bijou was left on the dressing table.");
					Item item416 = new Item(s.getKey(),"Vettek ujjlenyomatot, de nem sok remény van.","Some fingerprints were taken but there is not much hope.");
					Item item417 = new Item(s.getKey(),"A biztosító persze egy fillért nem adott.","I wasn't given a penny by the insurance company.");
					Item item418 = new Item(s.getKey(),"Összességében tehát jól paffra vágtak.","All in all I was put out.");
					Item item419 = new Item(s.getKey(),"A Kangákat általában vadállatnak tekintik.","A Kanga is generally regarded as a fierce animal.");
					Item item420 = new Item(s.getKey(),"A radványi sötét erdoben halva találták Bárci Benot.","In the dark forest of Radvány Bárci Beno was found dead.");
					Item item421 = new Item(s.getKey(),"Látták, hogy bemászik az ablakon, úgyhogy nem lehetett titokban tartani.","She was seen climbing through the window, so it couldn't be kept a secret.");
					...
					Item item424 = new Item(s.getKey(),"Elmozdította a fejét épp akkor, mikor a fényképet csinálták.","She moved her head just as the photo was being taken.");
					...
					Item item427 = new Item(s.getKey(),"Annuska azt mondta, hogy még semmit nem mondott Janinak.","Annuska said she hadn’t told Jani a word.");
					Item item428 = new Item(s.getKey(),"Azt mondta, hogy már nem vár tovább.","He said he wouldn’t wait any longer.");
					Item item429 = new Item(s.getKey(),"Szólt, hogy kapcsoljam ki a rádiót.","He told me to turn off the radio.");
					Item item430 = new Item(s.getKey(),"Azt mondta, hogy azért nem nyitott ajtót, mert épp a fülét mosta és nem hallott semmit.","He said he hadn’t open the door because he was cleaning (he had been cleaning) his ears and couldn’t hear anything.");
					Item item431 = new Item(s.getKey(),"Azt mondta, ha már úgyis megyek a boltba, hozzak neki narancsot.","He said if I went to the shop I should bring him some oranges.");
					Item item432 = new Item(s.getKey(),"Azt mondta, hogy tegnap egész nap otthon volt.","He said he had been at home all day the day before.");
					Item item433 = new Item(s.getKey(),"Azt mondta, hogy kész a kávé. ","He has just said that the coffee is ready.");
					Item item434 = new Item(s.getKey(),"Azt hitte, holnap kell elhoznia a ruhát a patyolatból.","She thought she would have to fetch the dress from the laundry the next day.");
					Item item435 = new Item(s.getKey(),"Azt hitte, ha sír, mindent megbocsájtok.","She thought I forgive her if she was crying.");
					Item item436 = new Item(s.getKey(),"Azt állította, hogy azért nem no a narancsfája, mert nem kap elég napfényt.","He claimed his orange tree doesn’t grow because it doesn’t get any sunshine.");
					Item item437 = new Item(s.getKey(),"Most szólt a házmester, hogy jönnek az APEH-tól.","The caretaker has just said that the Tax Office guys are approaching.");
					Item item438 = new Item(s.getKey(),"Azt hitték, hogy elkésnek.","They thought they were late.");
					Item item439 = new Item(s.getKey(),"Azt mondta az anyukám, hogy nem tetszik a frizurám.","My mother said she didn’t liked my hair.");
					Item item440 = new Item(s.getKey(),"Mondtam neki, hogy próbálja meg a zöldet.","I told her to try the green one.");
					Item item441 = new Item(s.getKey(),"Azt mondta, hogy unatkozik.","She said she was bored.");
					Item item442 = new Item(s.getKey(),"Mondtam, hogy hétre ott kell lennünk.","I told you we would have to be there to seven.");
					...
					Item item445 = new Item(s.getKey(),"Azt hitte kolbászból van a kerítés.","He thought the fence was made of sausages.");
					Item item446 = new Item(s.getKey(),"Azt mondta bemehetek.","He said I might come in.");
					Item item447 = new Item(s.getKey(),"Megkérdezte, hogy mi van a borödömben.","He asked what I had in my suitcase.");
					Item item448 = new Item(s.getKey(),"Tudni akarta, hogy mikor érkeznek.","He wanted to know when they would arrive.");
					Item item449 = new Item(s.getKey(),"Nem tudtam, hogy mit vegyek fel.","I didn't know what to put on/what I should put on.");
					Item item450 = new Item(s.getKey(),"Nem tudtam, hogy vegyek-e fel valamit.","I didn't know whether to put on something/if I should put on something.");
					Item item451 = new Item(s.getKey(),"Nem tudtam, hogy honnan tudja.","I didn't know how she could tell.");
					Item item452 = new Item(s.getKey(),"Azon tunodtem, hogy mit jelent mindez.","I was wondering what it all meant.");
					Item item453 = new Item(s.getKey(),"Megkérdezte, hogy miért nincs kész az ebéd.","He asked why dinner was not ready.");
					Item item454 = new Item(s.getKey(),"A vámos azt kérdezte, van-e elvámolni valóm.","The customs officer asked me if I had anything to declare.");
					Item item455 = new Item(s.getKey(),"Tudni akarta, hol vettem a cipofuzot.","He wanted to know where I had bought the shoe lace.");
					Item item456 = new Item(s.getKey(),"Azt kérdezte, jól aludtam-e.","He asked if I had slept well.");
					Item item457 = new Item(s.getKey(),"Nem tudtam, hogy van-e levelem.","I didn't know whether there were any letters for me.");
					Item item458 = new Item(s.getKey(),"Nem tudtam, melyik kólát kérjem, a szokét, vagy a barnát.","I didn't know which coke to ask for, the blond one, or the brown one.");
					Item item459 = new Item(s.getKey(),"Azon tunodtem, hogy elmenjek-e vagy maradjak.","I was wondering whether to go or stay.");
					Item item460 = new Item(s.getKey(),"Azt mondta, hogy három éve van lova.","He said he had have a horse for three years.");
					Item item461 = new Item(s.getKey(),"Azt mondta, hogy van lova.","He said he had a horse.");
					Item item462 = new Item(s.getKey(),"Azt mondta, hogy három évet tanult lovagolni.","He said he had learnt how to ride for three years.");
					Item item463 = new Item(s.getKey(),"Azt mondta, hogy három éve tanul lovagolni.","He said he had been learning how to ride for three years.");
					Item item464 = new Item(s.getKey(),"Nem tudtam fog-e rám emlékezni.","I didn't know if she would remember me.");
					Item item465 = new Item(s.getKey(),"Azt kérdezte, hogy jártam-e már Tótkomlóson.","She asked if I had ever been to Tótkomlós.");
					Item item466 = new Item(s.getKey(),"Azt javasolta, hogy pöttyöset vegyem.","She suggested I should buy the spotted one.");
					Item item467 = new Item(s.getKey(),"Nem tudtam hány poharat tegyek az asztalra.","I didn't know how many glasses to put on the table.");
					Item item468 = new Item(s.getKey(),"A fiú megígérte, hogy feleségül veszi a lányt, ha az megteszi amire kéri.","The boy promised he would marry the girl is she did what he asked her to do.");
					Item item469 = new Item(s.getKey(),"Többször is megkérdezte, hogy értem-e amit mond.","She asked me several times if I understood what she was saying.");
					...
					Item item472 = new Item(s.getKey(),"Azt mondta, hogy az anyósának ír.","He said he was writing to his mother-in-law.");
					Item item473 = new Item(s.getKey(),"Szólt, hogy ha esik, vigyek esernyot.","She told me to take an umbrella in case it rained.");
					...
					Item item476 = new Item(s.getKey(),"Fogalmam se volt, tegyek-e egyáltalán valamit.","I had no idea whether to do anything at all.");
					Item item477 = new Item(s.getKey(),"Rögtön láttam, hogy nem fog tejelni.","I immediately saw she wouldn't milk.");
					...
					Item item480 = new Item(s.getKey(),"Szólt, hogy ne csináljak semmit, o majd mindent elintéz.","She told me not to do anything, she would arrange everything.");
					Item item481 = new Item(s.getKey(),"Nem tudom, hogyan gyógyítsam meg a náthámat.","I don't know how to cure my sniffle.");
					Item item482 = new Item(s.getKey(),"Nem tudom, hogy elhiszed-e még.","I don't know whether you still believe it.");
					Item item483 = new Item(s.getKey(),"Azt se tudtam fiú vagyok-e vagy lány.","I didn't know whether I was coming or going.");
					...
					Item item486 = new Item(s.getKey(),"Azt se tudta, hogy eldugta-e?","She didn't know if she had hidden it at all.");
					...
					Item item491 = new Item(s.getKey(),"Nem tudom mire gondol a katona orség idején.","I don't know what the soldier on guard has in mind.");
					Item item492 = new Item(s.getKey(),"Vajon adsz-e helyet magad mellett.","I don't know if you'll give me room beside you.");
					...
					Item item495 = new Item(s.getKey(),"Megkérdezte, hogy levegye-e a nadrágját.","He asked whether he should take off his pants.");
					Item item496 = new Item(s.getKey(),"Azt hitte, rosszul hall.","He thought he heard wrong.");
					Item item497 = new Item(s.getKey(),"Azon gondolkodott, vegyen-e egy fél disznót.","He was wondering whether to buy half a hog.");
					Item item498 = new Item(s.getKey(),"A nagymama azt hitte, hogy Piroska az.","Grandmother thought it was Little Red Riding Hood.");
					Item item499 = new Item(s.getKey(),"Felrohantam, hogy megnézzem alszik-e a gyerek.","I ran up to see if the child was sleeping.");
					Item item500 = new Item(s.getKey(),"Mondtam már, hogy nosülök?","500) Have I told you I'm going to get married?");
					Item item501 = new Item(s.getKey(),"Azt mondtad, hogy nem akarsz mindenáron férjhez menni.","You said you didn't want to get married at any cost.");
					...
					Item item506 = new Item(s.getKey(),"Azt mondta csak 10 perce van, mert délre az irodában kell lennie.","She said she had only ten minutes left because she would have to be in the office at noon.");
					Item item507 = new Item(s.getKey(),"Nem tudtam miért takarja el az arcát.","I didn't know why she was hiding her face.");
					Item item508 = new Item(s.getKey(),"Azt hitte nem bolha, hanem elefánt.","He thought it was not a flea but an elephant.");
					...
					Item item513 = new Item(s.getKey(),"Azt mondta, hogy alig lépett be, máris kilépett.","She said hardly had she joined when she had left.");
					...
					Item item517 = new Item(s.getKey(),"Mondd meg a tejesnek, hogy ne hozzon több sajtot.","Tell the milkman to bring no more cheese.");
					Item item518 = new Item(s.getKey(),"Azt mondta, egész éjjel énelkelt.","He said she singing all night.");
					Item item519 = new Item(s.getKey(),"Azt mondta, hogy megenné, ha éhes volna.","She said she would eat if she was hungry.");
					Item item520 = new Item(s.getKey(),"Azt mondta, hogy mihelyt elkészül jön.","She said she would come as soon as she was ready.");
					Item item521 = new Item(s.getKey(),"Fogalmam se volt, hány éves lehet.","I had no idea how old she could be.");
					Item item522 = new Item(s.getKey(),"Micimackó azt mondta, hogy azt hitte, a Nyuszi a családjáról beszélt.","Pooh said he thought Rabbit had been talking about his family.");
					Item item523 = new Item(s.getKey(),"Kukorica Jancsi azt mondta, hogy kicsit ugyan parasztos a neve, de nem szégyelli.","Johnny Corn said his name was a bit peasant-like, but he wasn't ashamed of it.");
					Item item524 = new Item(s.getKey(),"Azt mondta, jobb ha nem nézek oda.","She said I had better not watch it.");
					Item item525 = new Item(s.getKey(),"Az orvos szerint egy-két napig még ágyban kell maradnia.","The doctor said she would have to stay in bed for another day or two.");
					Item item526 = new Item(s.getKey(),"Azt mondta, próbáljuk meg még egyszer.","He suggested trying it again.");
					Item item527 = new Item(s.getKey(),"Azt mondtam, hogy nincs értelme mégegyszer megpróbálni.","I said it was no use trying it again.");
					...
					Item item530 = new Item(s.getKey(),"Meg kell csináltatnom a lemezjátszómat.","I must have/get my record-player repaired.");
					Item item531 = new Item(s.getKey(),"Vajat hozattam a közértbol.","I had/got some butter brought from the shop.");
					Item item532 = new Item(s.getKey(),"Levágattad a szoknyád alját?","Did you have/get your skirt shortened?");
					Item item533 = new Item(s.getKey(),"Minden nap lemosatod a kocsidat?","Do you have your car washed every day?");
					...
					Item item536 = new Item(s.getKey(),"Az újoncokkal mosatta fel a folyosót.","He had the rookies wash the corridor.");
					Item item537 = new Item(s.getKey(),"Bélával fogja megfizettetni a kárt.","He’ll make Béla pay for the damage.");
					...
					Item item545 = new Item(s.getKey(),"Rávette, hogy álljon be rendornek.","He forced her to join the police force.");
					...
					Item item548 = new Item(s.getKey(),"Úgy intézte, hogy holnap kettokor érkezem meg (kettokor érkeztet meg) New York legnagyobb repüloterére.","She’ll have me arriving at Kennedy at 2:00 tomorrow.");
					Item item549 = new Item(s.getKey(),"Megismételtetnéd vele?","Would you make him repeat it?");
					Item item550 = new Item(s.getKey(),"Egy néger fiúval pucoltatja a cipojét.","He gets a black boy to clean his shoes.");
					...
					Item item553 = new Item(s.getKey(),"Mikor fogod megéleztetni a késeket?","When will you have the knives sharpened?");
					Item item554 = new Item(s.getKey(),"A szomszéddal hozatott cigarettát.","He had his neighbour bring cigarettes.");
					Item item555 = new Item(s.getKey(),"Vak zongorahangolóval hangoltatta fel a zongorát.","He had a blind piano tuner tune the piano.");
					Item item556 = new Item(s.getKey(),"Épp most másoltatom.","I’m having it copied right now.");
					Item item557 = new Item(s.getKey(),"A borbéllyal húzatta ki a fogát.","He got the barber to take out his tooth.");
					Item item558 = new Item(s.getKey(),"A macskával etette meg a párizsit.","He made the cat eat the párizsi.");
					Item item559 = new Item(s.getKey(),"A jókedvu tizedes fogkefével mosatta fel a folyosót.","The cheerful corporal had the corridor washed with a toothbrush.");
					Item item560 = new Item(s.getKey(),"Virágot küldettem a névnapjára.","I had lowers sent to her nameday.");
					Item item561 = new Item(s.getKey(),"Piros palát fogok rakatni a házam tetejére.","I'll get red slate put on the roof of my house.");
					Item item562 = new Item(s.getKey(),"Az a sok szilva jól megszalasztott.","That lot of plums made me run.");
					Item item563 = new Item(s.getKey(),"Ne Technocol Rapidot szagoltass vele, hanem repülosót.","Don't make him smell Technocol Rapid, but smelling salts.");
					Item item564 = new Item(s.getKey(),"Mondd, te kivel csináltattad a futést?","Say, who did you get to install heating?");
					Item item565 = new Item(s.getKey(),"Mindig velem fordíttatja le az idétlen mondatait.","She is always making me translate her stupid sentences.");
					Item item566 = new Item(s.getKey(),"Na, ezt a szerencsétlent is jól megszivatták.","They got that unfortunate guy to suck.");
					Item item567 = new Item(s.getKey(),"Kicseréltettem a féltengelyt és a levegoszurot.","I had the half axle and the air filter replaced.");
					Item item568 = new Item(s.getKey(),"Mindenáron tükröt akar szereltetni a hálószoba plafonjára.","She wants to get a mirror fixed onto the ceiling of the bedroom at any cost.");
					Item item569 = new Item(s.getKey(),"Mindig velem iratja a szerelmes leveleit.","She is always making me write her love letters.");
					Item item570 = new Item(s.getKey(),"Miért nem a villanyszerelovel kötteted be a mosógépet?","Why didn't you get the electrician to connect up your washing machine?");
					Item item571 = new Item(s.getKey(),"Mibol gondolod, hogy van még idonk?","What makes you think we still have time?");
					Item item572 = new Item(s.getKey(),"Te is kertésszel gondoztatod a kertedet?","Do you also get a gardener to look after your garden?");
					Item item573 = new Item(s.getKey(),"A vacsorán egy fél disznót megetettek velem.","They made me eat half a hog for dinner.");
					Item item574 = new Item(s.getKey(),"Egy rendorrel magyaráztatta el a helyes útirányt.","She has had a policeman explain the right way.");
					...
					Item item577 = new Item(s.getKey(),"Elhitettem vele, hogy minden rendben van.","I made him believe that everything was alright.");
					Item item578 = new Item(s.getKey(),"Messzirol kell szállíttatnia a tejet.","He's got to get the milk delivered from far away.");
					...
					Item item582 = new Item(s.getKey(),"Az utolsó szemig felszedettem vele, amit eldobált.","I've made him pick up every scrap he's thrown.");
					Item item583 = new Item(s.getKey(),"Szörnyu szegénységemben lopni kezdtem.","My terrible poverty made me start stealing.");
					Item item584 = new Item(s.getKey(),"Szörnyu izgalmamban dadogni kezdtem.","My terrible excitement made me sart stammering.");
					Item item585 = new Item(s.getKey(),"Akkor se vetetem el, ha nem veszel el!","I won't have it taken even if you don't marry me.");
					Item item586 = new Item(s.getKey(),"Csak nem akarod velem elhitetni, hogy én voltam neked az elso?","I hope you don't want to make me believe I was the first for you!");
					Item item587 = new Item(s.getKey(),"Ki kényszeríthet arra, hogy megtedd?","Who can get you to do it?");
					Item item588 = new Item(s.getKey(),"Szerinted nem szörnyu dolog kitömetni a kedvenc állataidat?","Don't you think it's a horrible thing to have your pets stuffed?");
					Item item589 = new Item(s.getKey(),"Miért nem csinálataod már meg ezt a vacak magnót?","Why don't you have that shoddy tape recorder mended?");
					Item item590 = new Item(s.getKey(),"Nem tudtam kiverni a fejébol, amit az anyósa mondott neki.","I couldn't make him forget what his mother-in-law had told him.");
					Item item591 = new Item(s.getKey(),"A tizedik felesége se tudta feledtetni vele a legelsot.","Even his tenth wife was unable to make him forget the first one.");
					Item item592 = new Item(s.getKey(),"Egy kis sírással mindent elérek nála.","With some crying I can make him do anything I want.");
					Item item593 = new Item(s.getKey(),"Miért nem vágatod le, ha túl hosszú?","Why don't you have it cut if it's too long?");
					Item item594 = new Item(s.getKey(),"Eloszedettem vele mindent, amit eldugott.","I've had her produce everything she's hidden.");
					Item item595 = new Item(s.getKey(),"Hányszor építtetted át a házadat?","How many times have you had your house rebuilt?");
					Item item596 = new Item(s.getKey(),"Itasd meg vele az egészet.","Get him to drink it all.");
					Item item597 = new Item(s.getKey(),"Érd el, hogy bevallja, kivel, hol, hányszor.","Get her to confess where, with whom, and how many times.");
					Item item598 = new Item(s.getKey(),"Az az idióta tanár mindig ilyen hülye mondatokat fordíttat velünk.","That foolish teacher is always making us translate such stupid sentences.");
					Item item599 = new Item(s.getKey(),"Ha szeretsz, eljössz délután.","If you love me, you will come to my place in the afternoon.");
					Item item600 = new Item(s.getKey(),"Ha szeretnél, eljönnél délután.","If you loved me, you will come to my place in the afternoon.");
					Item item601 = new Item(s.getKey(),"Ha szerettél volna, eljöttél volna délután.","If you had loved me, you would have come to my place in the afternoon.");
					Item item602 = new Item(s.getKey(),"Ha többet dolgoztál volna, most több pénzt kapnál.","If you had worked harder, you would get more money now.");
					Item item603 = new Item(s.getKey(),"Ha akkor leszoksz a dohányzásról, nem kerültél volna kórházba.","If you had given up smoking, you wouldn’t have been taking to hospital.");
					Item item604 = new Item(s.getKey(),"A tej megsavanyodik, ha néhány napra elöl hagyod.","Milk goes sour if you leave it outside for some days.");
					Item item605 = new Item(s.getKey(),"A virág elpusztul, ha nem öntözöd.","Flowers die if you do not water them.");
					Item item606 = new Item(s.getKey(),"Mindig segítek neki, ha megkér rá.","I always help her if she asks me to.");
					Item item607 = new Item(s.getKey(),"Ha neked lennék,…","If I were you,...");
					Item item608 = new Item(s.getKey(),"Nem adok neki pénzt, hacsak tényleg nincs rá szüksége.","I won’t give her money unless she really needs it.");
					Item item609 = new Item(s.getKey(),"Ha hajlandó lenne ideadni a kocsidat, el tudnék menni Püspökladányba.","If you would lend me your car, I would go to Püspökladány.");
					Item item610 = new Item(s.getKey(),"Ha lennél szíves segíteni, hamarabb befejezném.","If you would be so kind as to help me, I would finish it sooner.");
					Item item611 = new Item(s.getKey(),"Ha esetleg, netalántán találkoznál a barátommal, mond meg neki, hogy látni szeretném.","If you should meet my friend, tell him I want to see him.");
					Item item612 = new Item(s.getKey(),"Ha nem lenne rossz a kocsi, idoben odaérnénk.","If it weren’t for the bad car, we would get it there in time.");
					Item item613 = new Item(s.getKey(),"Ha nem termeszthettek volna zöldséget, biztos, hogy éheztek volna.","If it weren’t for a few vegetables they grew, they would surely have starved.");
					Item item614 = new Item(s.getKey(),"Ha el tudsz jönni délután, kimehetünk a Fradi meccsre.","If you can come in the afternoon, we can go to the Fradi's match.");
					Item item615 = new Item(s.getKey(),"Vigyél kabátot arra az esetre, ha esne.","Take your coat in case it rains.");
					Item item616 = new Item(s.getKey(),"Fozök egy csomó levest, arra az esetre, ha úgy döntenek, hogy itt maradnak vacsorára.","I’ll cook plenty of soap just in case they decide to stay for dinner.");
					Item item617 = new Item(s.getKey(),"Elmegyek, feltéve ha te is mész.","I’ll go provided you go, too.");
					Item item618 = new Item(s.getKey(),"Feltéve ha nincs ellenvélemény, itt tartjuk a gyulést.","Provided there is no opposition, we’ll hold the meeting here.");
					Item item619 = new Item(s.getKey(),"Két szegény legény szántani menne, ha volna kenyere.","The two poor chaps would go ploughing if they had bread.");
					Item item620 = new Item(s.getKey(),"Ha adsz egy zsebkendot, megtörlöm az orrom.","If you give me a tissue paper, I’ll wipe my nose.");
					Item item621 = new Item(s.getKey(),"Ha a kutya nem ébresztett volna fel, nem hallottuk volna a betöroket.","If the dog hadn’t woken us, we wouldn’t have heard the burglars.");
					Item item622 = new Item(s.getKey(),"Ha a japánok nem építenének olyan jó hajókat, Lengyelország volna a csúcson.","Were it not for the Nips being so good at building ships, Poland would be on the top.");
					Item item623 = new Item(s.getKey(),"Elcserélnéd két 16 évesre, ha fiatalabb volnál?","Would you change her for two 16-year old chicks if you were younger?");
					Item item624 = new Item(s.getKey(),"Megszámoltam volna, ha tudtam volna.","I would have counted it if I had been able to.");
					Item item625 = new Item(s.getKey(),"Ha vártak volna, találkoztunk volna.","Had they waited, we would have met.");
					Item item626 = new Item(s.getKey(),"Ha a lónak hat lába volna, nem botlana meg.","If a horse had six legs, it wouldn't stumble.");
					Item item627 = new Item(s.getKey(),"Táncoltam volan én veled, ha nem fáj a fogam.","I would have danced with you if I hadn't had a toothache.");
					Item item628 = new Item(s.getKey(),"Majd meglátogatlak, ha lesz elég idom.","I'll visit you if I have enough time.");
					Item item629 = new Item(s.getKey(),"Mit vennél, ha lenne egy milliód?","What would you buy if you had a million.");
					Item item630 = new Item(s.getKey(),"Ha nem sietsz, még elkésünk.","If you don't hurry we'll be late.");
					Item item631 = new Item(s.getKey(),"Ha megvetted volna, most nem lenne pénzed.","If you had bought it, now you wouldn't have money.");
					Item item632 = new Item(s.getKey(),"Meginnám, ha nem lenne olyan hideg.","I would drink it if it wasn't so cold.");
					Item item633 = new Item(s.getKey(),"A helyedben nem fogadnám el azt az állást.","If I were you I wouldn't take that job.");
					Item item634 = new Item(s.getKey(),"Ha tovább kerested volna, megtaláltad volna.","Had you kept on looking for it, you would have found it.");
					Item item635 = new Item(s.getKey(),"Ha megfáztál volna, most nem jöhetnél velünk.","If you had caught a cold, you couldn't come with us now.");
					Item item636 = new Item(s.getKey(),"Ha már úgyis mész a zöldségeshez, hozz egy fél kiló uborkát.","If you go to the greengrocer's anyway, please bring me half a kilo of cucumber.");
					Item item637 = new Item(s.getKey(),"Örülnék, ha nem szórakoznál annyit.","I'd be happy if you didn't keep fooling around.");
					Item item638 = new Item(s.getKey(),"Ha nem lettek volna téveszméi, már rég elhagyta volna az országot.","If he hadn't had delusions, he would have left the country long ago.");
					Item item639 = new Item(s.getKey(),"Ha a nyuszi medve volna, a vadásznak is kisebb szája lenne.","If a rabbit were a bear, the hunter would be less boastful.");
					Item item640 = new Item(s.getKey(),"Elmennék, ha nem kéne nyakkendot kötnöm.","I would go if I didn't need to put on a tie.");
					Item item641 = new Item(s.getKey(),"Ha esetleg megtalálod, add vissza neki.","If you should find it, give it back to him.");
					Item item642 = new Item(s.getKey(),"Ha hajlandó lennél rámfigyelni, már túl lennénk rajta.","If you would listen to me, we would be over with it.");
					Item item643 = new Item(s.getKey(),"El tudtam volna vágni, ha jobb kést adtál volna.","I would have been able to cut it if you had given me a better knife.");
					Item item644 = new Item(s.getKey(),"Nem örülnék, ha máris elmennél.","I wouldn't be glad if you left right away.");
					Item item645 = new Item(s.getKey(),"Ha nem lett volna ez a sok új szó, most én lennék a legokosabb.","If there hadn't been so many new words. I'd be the cleverest now.");
					Item item646 = new Item(s.getKey(),"Ha én lennék a téeszelnök, Jóska lenne a párttitkár.","If I were the farm manager, Joe would be the secretary of the party.");
					Item item647 = new Item(s.getKey(),"Megszámoltam volna, ha tudtam volna.","I would have counted it if I had been able to.");
					Item item648 = new Item(s.getKey(),"Ha csak azért jöttél, hogy veszekedj, jobb lett volna, ha otthon maradsz.","If you've come only to quarrel, you'd better have stayed at home.");
					Item item649 = new Item(s.getKey(),"Ha örökké attól félnél, hogy nem tudsz hozzájutni elég nohöz, elobb vagy utóbb épp oly zavart lennél szellemileg, mint a pszichiáter, aki kezel.","If you were always afraid of not getting enough women, sooner or later you would be as confused as the psychiatrist who treated you.");
					Item item650 = new Item(s.getKey(),"Ha mégis elveszettnek érzed magad, kérj segítséget bárkitol.","Should you feel lost, you could ask anybody for help.");
					Item item651 = new Item(s.getKey(),"Ha hajlandó lennél szép csendben elmenni, minden egyszerubb lenne.","If you would leave in silence, everything would be more simple.");
					Item item652 = new Item(s.getKey(),"Megcsináltam volna, ha kellett volna.","I would have done it if I had had it.");
					Item item653 = new Item(s.getKey(),"Ha netán felébredne, mondd meg neki, hogy hamarosan visszajövök.","If he should wake up, tell him I'll be back in no time.");
					Item item654 = new Item(s.getKey(),"Ha nem huzod meg a farkát nem rúg meg.","If you don't pull his tail, he won't kick you.");
					Item item655 = new Item(s.getKey(),"Ha el tudnám olvasni az írásodat, egybol válaszolnék is.","If I could read your writing, I would answer immediately.");
					Item item656 = new Item(s.getKey(),"Ha kibirnám, hogy ne nézzem örökké az ajkad, soha nem kérnél meg, hogy az extázis új magasságaiba vigyelek.","If I could help keeping my eyes away from your lips, you would never ask me to take you to the new heights of ecstasy.");
					Item item657 = new Item(s.getKey(),"Ha a halálbüntetést nem törölték volna el, most nem ölelhetnélek itt karjaimban.","If capital punishment had not been cancelled, I could certainly not be holding you in my arms.");
					Item item658 = new Item(s.getKey(),"A helyedben nem hinném el, mit mond.","If I were you, I wouldn't believe what he says.");
					Item item659 = new Item(s.getKey(),"Ha figyelted volna, hogy rakja a lábát, most te is tudnád járni ezt a táncot.","Had you watched her putting her feet, you would be able now to do this dance.");
					Item item660 = new Item(s.getKey(),"Ha gondját viselnéd a családnak, elmehetnénk végre nyaralni.","If you looked after the family, we could have our holiday at last.");
					Item item661 = new Item(s.getKey(),"Ha véletlenül ült volna rá a kalapomra, meg is bocsájtanék neki.","If she sat on my hat by accident, I would forgive her.");
					Item item662 = new Item(s.getKey(),"Nem tudunk elutazni, hacsak meg nem ütjük a fonyereményt.","We can't go away unless we win the first prize.");
					Item item663 = new Item(s.getKey(),"Ha nem a férjemhez mentem volna feleségül, hanem hozzád, most nem engedhetnénk meg magunknak, hogy együtt utazzunk Hawaiba.","Had I married you and not my husband, we couldn't afford now to go together to Hawaii.");
					Item item664 = new Item(s.getKey(),"Ha idoben telefonáltál volna, nem kellett volna megkérnem az ikreket, hogy hozzanak virágot.","If you had telephoned in time, I wouldn't have had to ask the twins to bring glowers.");
					Item item665 = new Item(s.getKey(),"Ha nagyobb halat tudtam volna fogni, korábban hazajöttem volna.","If I had been able to catch a bigger fish, I would have come home earlier.");
					Item item666 = new Item(s.getKey(),"Ha nem lenne olyan önzo, nekem is adna egy túró rudit.","If he wasn't so selfish, he would give a cottage cheese Rudolph to me, too.");
					Item item667 = new Item(s.getKey(),"Ha esetleg megtalálod, hívj fel.","If you should find it, give me a ring.");
					Item item668 = new Item(s.getKey(),"Megcímezném a borítékot, ha volnál szíves adni egy tollat.","I'd address the envelope if you would give me a pen.");
					Item item669 = new Item(s.getKey(),"Csiga-biga told ki szarvadat, ha nem tolod összetöröm házadat.","Snaily snail, push out your horn, if you don't push it out, I'll break your house.");
					Item item670 = new Item(s.getKey(),"Ha nem teszed a tejet hutobe, megsavanyodik.","If you don't put milk in the fridge, it goes sour.");
					Item item671 = new Item(s.getKey(),"Ha nem lettek volna olyan igézo szemei, észre se vette volna.","Were it not for her eyes being so ravishing, he would never have noticed her.");
					Item item672 = new Item(s.getKey(),"Itthon maradok, hacsak meg nem hívnak.","I'll stay at home unless I'm invited.");
					Item item673 = new Item(s.getKey(),"Hacsak a kormány nem ad több pénzt, be kell zárni a színházat.","Unless the government agrees to give extra money, the theatre will have to be closed.");
					Item item674 = new Item(s.getKey(),"Ha nem segítettél volna, sose fejeztük volna be.","If it hadn't been for your help, we'd never have finished it.");
					Item item675 = new Item(s.getKey(),"Ha hallgattál volna, bölcs maradtál volna.","Had you kept silent, you would have stayed wise.");
					Item item676 = new Item(s.getKey(),"Hangosan beszélt, hogy mindenki hallja.","He spoke loudly so (that) everybody could hear him.");
					Item item677 = new Item(s.getKey(),"Jobb ha taxival mész, nehogy megint elkéss.","You’d better take a taxi so as not to be late again.");
					Item item678 = new Item(s.getKey(),"Fölvette a szemüvegét, hogy jobban lásson.","He put on his glasses to be able to see better/so that he could see better.");
					Item item679 = new Item(s.getKey(),"Újságot tett a székre, nehogy a kéménysepro összemaszatolja.","He put a newspaper on the chair so (that) the chimney sweep wouldn’t stain it.");
					Item item680 = new Item(s.getKey(),"Kinyitotta az ajtót, hogy a gyerekek kimehessenek az utcára.","He opened the door so that the kids could go out to the street.");
					Item item681 = new Item(s.getKey(),"Kesztyut húzott, nehogy ujjlenyomatot hagyjon.","He put on gloves so as not to leave his fingerprints there.");
					Item item682 = new Item(s.getKey(),"Mindjárt ablakot nyitok, hogy kimenjen a füst.","I’m going to open the window so (that) the smoke will go out.");
					Item item683 = new Item(s.getKey(),"Temetni jöttem Caesart nem dicsérni.","I came to bury Caesar not to praise him.");
					Item item684 = new Item(s.getKey(),"Korán kelt, hogy még napnyugta elott elérje a hegy csúcsát.","He got up early (so as) to reach the summit before sunset.");
					Item item685 = new Item(s.getKey(),"Berohant az égo házba, hogy kimentse a gyereket.","He rushed into the burning house to rescue the child.");
					Item item686 = new Item(s.getKey(),"Felhúzta a szoknyáját, hogy gyorsabban tudjon futni.","She pulled up her skirt so that she could run faster.");
					Item item687 = new Item(s.getKey(),"Elkezdett reszketni, hogy jobban sajnálják.","She started trembling to raise more sympathy.");
					Item item688 = new Item(s.getKey(),"Összetörte a tükröt, hogy a felesége ne tudja nézegetni magát.","He broke the mirror into pieces so that his wife couldn't look at herself any more.");
					Item item689 = new Item(s.getKey(),"Jancsi elfordult, hogy ne lássa a leány, hogy könnye kicsordul.","Jancsi turned away so that the girl couldn't see the tears roll down his cheeks.");
					Item item690 = new Item(s.getKey(),"A fejére húzta a szoknyáját, hogy ne ázzon el a frizurája.","She pulled her skirt over her head so that her hairdo wouldn't get ruined.");
					Item item691 = new Item(s.getKey(),"Felemelte a szonyeget, hogy alásöpörhesse a szemetet.","She lifted the rug so as to sweep the garbage under it.");
					Item item692 = new Item(s.getKey(),"Megmutattam neki mim van, nehogy aztán csalódjon.","I showed her what I had so that she shouldn't be disappointed later on.");
					Item item693 = new Item(s.getKey(),"Lenyelte a gyémántot, nehogy a vámos megtalálja nála.","He swallowed the diamond so that the customs officer couldn't find it.");
					Item item694 = new Item(s.getKey(),"Vettem neki virágot, hogy szagolgathassa.","I've bought her some flowers so that she can enjoy the fragrance.");
					Item item695 = new Item(s.getKey(),"Elvált a nyolcadiktól, hogy elvehesse a kilencediket.","He divorced the eight one so as to marry the ninth one.");
					Item item696 = new Item(s.getKey(),"Levettem a cipomet, hogy ne csapjak zajt.","I took off my shoes so as not to make any noise.");
					Item item697 = new Item(s.getKey(),"Levettem a cipomet, hogy ne hallja a nejem, amint bemegyek.","I took off my shoes so that my wife couldn't hear me go in.");
					Item item698 = new Item(s.getKey(),"Nagyon halkan zongorázz, hogy ne zavarj senkit.","Play the piano very soft so as not to disturb anybody.");
					Item item699 = new Item(s.getKey(),"Odaadtam neki a kulcsot, hogy be tudjon menni a szobába.","I've given her the key so that she can go into the room.");
					Item item700 = new Item(s.getKey(),"Kikapcsolta a rádiót, nehogy felébredjen a szomszéd.","He turned the radio off so the neighbor wouldn't wake up.");
					Item item701 = new Item(s.getKey(),"Add ide a poharad, hogy mi is ihassunk.","Give us your glass so we can also drink.");
					Item item702 = new Item(s.getKey(),"Kint hagyta a pisztolyát, nehogy lelojön valakit.","He left his gun outside so as not to shoot anyone.");
					Item item703 = new Item(s.getKey(),"Minden reggel iszik egy felest, hogy vidáman kezdje a napot.","She drinks a 'feles' every morning so as to start the day cheerfully.");
					Item item704 = new Item(s.getKey(),"Kolompot akasztottak a tehén nyakába, hogy a bika mindig tudja merre jár.","A bell was hung in the neck of the cow so that the bull would always know which way she was going.");
					Item item705 = new Item(s.getKey(),"Korán indulj, nehogy elkéss.","Start early not to be late.");
					Item item706 = new Item(s.getKey(),"Örökké változtatta a címét, hogy becsapja a rendorséget.","She kept changing her address so as to fool the police.");
					Item item707 = new Item(s.getKey(),"Adj neki egy nagy pofont, hogy tudja merre mennyi.","Give him a big slap so that he knows the limit.");
					Item item708 = new Item(s.getKey(),"Vett egy macskát, hogy a kutya ne unatkozzon.","He bought a cat so that the dog wouldn't be bored.");
					Item item709 = new Item(s.getKey(),"Felállított egy madárijesztot, hogy nehogy a seregélyek ellopják a szolot.","He set up a scarecrow so that the starlings wouldn't steal the grapes.");
					Item item710 = new Item(s.getKey(),"Azért mondjuk, hogy 'AHA', hogy Kanga tudja, hogy mi tudjuk, hol van a Zsebibaba.","We say 'AHA' so that Kanga knows that we know where Baby Roo is.");
					Item item711 = new Item(s.getKey(),"Beöltözött apácának, hogy kiszökhessen a börtönbol.","He disguised himself as a nun so that he would be able to run away from prison.");
					Item item712 = new Item(s.getKey(),"Foztem szegény fiamnak egy kis mákostésztát, hadd egyen egy jót.","I cooked some noodles with poppy seeds for my poor son, so that he would have something good to eat.");
					Item item713 = new Item(s.getKey(),"Tedd ki, hogy mindenki láthassa.","Put it out so that everybody can see it.");
					Item item714 = new Item(s.getKey(),"Ültetett egy kis spenótot, hogy legyen majd mit ennünk.","She planted some spinach so that we should have something to eat.");
					...
					Item item717 = new Item(s.getKey(),"Elmesélte azt, amit tudott az esetrol.","He told me what he knew about the event.");
					Item item718 = new Item(s.getKey(),"Emlékszem arra, amit elmeséltél.","I remember what you told me.");
					Item item719 = new Item(s.getKey(),"Emlékszem arra a történetre, amit elmeséltél.","I remember the story which/that you told me.");
					Item item720 = new Item(s.getKey(),"Elhoztam azt a könyvet, amit kértél.","I’ve brought the book that you asked for.");
					Item item721 = new Item(s.getKey(),"Olyan ember O, akinek nincs múltja.","He’s a man who has no past.");
					Item item722 = new Item(s.getKey(),"Ez az a ház, ahol áll az ido.","This is the house where time has stopped existing.");
					Item item723 = new Item(s.getKey(),"Emlékeztettem arra, amit ígért.","I reminded him of what he had promised.");
					Item item724 = new Item(s.getKey(),"Ez az, amit nem szabad elfelejtened.","This is what you mustn't forget.");
					Item item725 = new Item(s.getKey(),"A lány, akinek olyan szép az arca, az én feleségem.","The girl whose face is so pretty is my wife.");
					...
					Item item733 = new Item(s.getKey(),"Abban a pillanatban, amikor belépett a szobába.","The moment he entered the room.");
					Item item734 = new Item(s.getKey(),"Abban az évben találkoztam vele, amikor megnosültem.","I met him the year I got married.");
					Item item735 = new Item(s.getKey(),"Oda megyek, ahova akarod.","I’ll got to any place you want me to.");
					Item item736 = new Item(s.getKey(),"Ez az, amiért szeret ide jönni.","That is the reason he likes to come here.");
					Item item737 = new Item(s.getKey(),"Ronald Reagan, aki valaha színész volt, nem nagy dicsosége az amerikai népnek.","Ronald Reagan, who used to be an actor, is an embarrassment for the American people.");
					Item item738 = new Item(s.getKey(),"Budapest, melyet sokan látogatnak, gyönyöru.","Budapest, which lots of tourists visit, is beautiful.");
					Item item739 = new Item(s.getKey(),"Körbefutotta a Szigetet, ami teljesen kimerítette.","He ran around the island, which exhausted him.");
					Item item740 = new Item(s.getKey(),"Ellopta a fonöke tollát, ami nagyon kínos volt.","He stole his boss’s pen, which was very embarrassing.");
					Item item741 = new Item(s.getKey(),"Kösz az ajándékot, amit küldtél.","Thank you for the present you sent me.");
					Item item742 = new Item(s.getKey(),"Az ágy, amin alszom, lószorbol van.","The bed I sleep on is made of horse hair.");
					Item item743 = new Item(s.getKey(),"Elfelejtettem, amit mondtál.","I’ve forgotten what you've told me.");
					Item item744 = new Item(s.getKey(),"Rómeo, aki szerette Júliát, felmászott az erkélyre.","Romeo, who loved Juliet, limbed up to the balcony.");
					...
					Item item747 = new Item(s.getKey(),"A lány, akinek a bátyja nagyon eros…","The girl whose brother is very strong…");
					Item item748 = new Item(s.getKey(),"Nem értettem a tréfát, amit mondott.","I didn’t quite understand the joke he said.");
					Item item749 = new Item(s.getKey(),"Nem értettem, amit mondott.","I didn’t understand what he said.");
					Item item750 = new Item(s.getKey(),"Egy könyvet akar elolvasni, ami teljesen szokatlan tole.","He wants to read a book, which is quite unusual of him.");
					Item item751 = new Item(s.getKey(),"Ez az a szálloda, amelyikben tavaly laktam.","This is the hotel I lived in last year.");
					Item item752 = new Item(s.getKey(),"Szeret Mariskával táncolni, aki úgy mozog, mint a higany.","I like dancing with Mary, who moves like mercury.");
					Item item753 = new Item(s.getKey(),"A hajó, amit amott látsz, a sógoromé.","The ship you can see over there belongs to my brotherin-law.");
					Item item754 = new Item(s.getKey(),"Félek, ez minden, amit adhatok.","I'm afraid that's all I can give you.");
					Item item755 = new Item(s.getKey(),"Az autó, amiért egy vagyont fizettem, meg se mozdul.","The car I've paid an absolute fortune for doesn't even move.");
					Item item756 = new Item(s.getKey(),"Te úristen, elfelejtettem, amit kértél.","Oh my God, I've forgotten what you've asked me for.");
					Item item757 = new Item(s.getKey(),"Lekéste a vonatot, ami fölöttébb bosszantotta.","She missed the train, which really annoyed her.");
					Item item758 = new Item(s.getKey(),"Jóska, akinek a szülei vidéken élnek, tegnap meglátogatott.","Joe, whose parents live in the country, visited me yesterday.");
					Item item759 = new Item(s.getKey(),"Mindig azt tette, amihez kedve volt.","He always did what he felt like doing.");
					Item item760 = new Item(s.getKey(),"A hölgy, akivel tegnap találkoztál, a nagynéném.","The lady you met yesterday is my aunt.");
					Item item761 = new Item(s.getKey(),"Meglepodtem azon, amit láttam.","I was surprised at what I had to see.");
					Item item762 = new Item(s.getKey(),"Az állás, amire pályázik, már nem üres.","The job he applies for is not vacant anymore.");
					Item item763 = new Item(s.getKey(),"Aztán bementünk egy bárba, ami teljesen üres volt.","Then we went into a pub which was completely empty.");
					Item item764 = new Item(s.getKey(),"A pincér, aki a rendelést vette föl, olyan koszos volt, mint a föld.","The waiter who took our order was as dirty as earth.");
					Item item765 = new Item(s.getKey(),"A számla, amit késve kaptunk, tele volt olvashatatlan számokkal.","The bill we got late was full of illegible numbers.");
					Item item766 = new Item(s.getKey(),"Az üzletvezeto, akit már 20 éve ismerek, elnézést kért.","The landlord, whom I have known for twenty years, apologized to me.");
					Item item767 = new Item(s.getKey(),"A pofon, amit a pincértol kaptam, nagyon fájt.","The slap I got from the waiter was very painful.");
					Item item768 = new Item(s.getKey(),"A mento, amivel kórházba vittek, úgy zötykölodött, mint egy talicska.","The ambulance I was taken into hospital in was jolting like a barrow.");
					Item item769 = new Item(s.getKey(),"Az ápolóno, akinek a keze selymes volt, megsimogatta a homlokomat.","The nurse whose hand was silky caressed my fore head.");
					Item item770 = new Item(s.getKey(),"A férfi, aki a fa alatt áll, tegnap még börtönben volt.","The man who is standing under the tree was in prison yesterday.");
					Item item771 = new Item(s.getKey(),"A baleset, amit láttunk, nagyon súlyos volt.","The accident we have seen has been very serious.");
					Item item772 = new Item(s.getKey(),"A tehenek, akik ott legelésznek nagyon szomjasak.","The cows who are grazing there are very thirsty.");
					Item item773 = new Item(s.getKey(),"A labda, amit elvesztettél, még teljesen új volt.","The ball you've lost was absolutely new.");
					Item item774 = new Item(s.getKey(),"A tanár, akinek a tanítványa megnyerte a versenyt, szereti a mézet.","The teacher whose student won the competition likes honey.");
					Item item775 = new Item(s.getKey(),"Apukám, aki vidéken született, nagyon eros.","My father, who was born in the country, is a very strong man.");
					Item item776 = new Item(s.getKey(),"Az a fivérem, aki ebbe az iskolába jár, sokat dohányzik.","My brother who attends this school smokes a lot.");
					Item item777 = new Item(s.getKey(),"A novérem, aki újságíró nem szereti a híradót.","My sister, who is a journalist, doesn't like TV news.");
					Item item778 = new Item(s.getKey(),"Budapest, mely Magyarország fovárosa, a Duna két partján terül el.","Budapest, which is the capital of Hungary, lies on the banks of the Danube.");
					Item item779 = new Item(s.getKey(),"A ház, melyben lakom, elég kicsi.","The house I live in is quite small.");
					Item item780 = new Item(s.getKey(),"Karcsi, akit mindnyájan szeretünk, a város KISZtitkára volt.","Karcsi, whom we all love, used to be the secretary of the Young Communists of the town.");
					Item item781 = new Item(s.getKey(),"A toll, amivel írsz, az enyém.","The pen you're writing with is mine.");
					Item item782 = new Item(s.getKey(),"A ház, melynek zöldek az ablakai a Dunára néz.","The house whose windows are green overlooks the Danube.");
					Item item783 = new Item(s.getKey(),"Azt mondja, hogy lekéste a vonatot, ami nem igaz.","He says he's missed the train, which is not true.");
					...
					Item item788 = new Item(s.getKey(),"Egy szót se értek abból, amit mondasz.","I don't understand a word you say.");
					Item item789 = new Item(s.getKey(),"Nem érted amit mondok?","Don't you understand what I'm telling you?");
					Item item790 = new Item(s.getKey(),"Talán ez az az ember, akit keres a rendorség.","Maybe this is the guy the police want.");
					Item item791 = new Item(s.getKey(),"Mindnyájunkat meghívott, ami nagyon kedves volt tole.","She invited us all, which was very kind of her.");
					Item item792 = new Item(s.getKey(),"Te vagy a legnagyszerubb lány, akivel valaha találkoztam.","You are the most fantastic girl I've ever met.");
					Item item793 = new Item(s.getKey(),"De hisz ez nem az a férfi, aki megkérte a kezemet!","But this is not the man who popped the question.");
					Item item794 = new Item(s.getKey(),"Emlékszel már arra, amit tegnap tettél velem?","Do you remember now what you did to me yesterday?");
					Item item795 = new Item(s.getKey(),"A rádió, ami az asztalon van, bedöglött.","The radio which is on the table has broken down.");
					Item item796 = new Item(s.getKey(),"A hó, amit a hókotró elkotort, ott feketéllik az út mentén.","The snow that was pushed off by a snow plough is blackening by the road side. ");
					Item item797 = new Item(s.getKey(),"A kopár szik sarja, amin tikkadt szöcskenyájak legelésznek, ég a napmelegtol.","The off shoots of the barren wastelands that parched flocks of grasshoppers are grazing are toiling in the hot sun. ");
					Item item798 = new Item(s.getKey(),"A vasorrú bába, akit Jancsi elégetett, egy mézeskalács házban lakott.","The iron nosed witch, who was burnt by Johnny, used to live in gingerbread house.");
					Item item799 = new Item(s.getKey(),"A törpe, akinek az ágyába Hófehérke belefeküdt, szemérmesen mosolygott.","The dwarf whose bed Snow White lay in was smiling shyly.");
					Item item800 = new Item(s.getKey(),"A farkas, aki a ngymama ruháját vette föl, izgatottan várta Piroskát.","The wolf, who put on Grandmother's robe, was expecting Little Red Riding Hood excitedly.");
					Item item801 = new Item(s.getKey(),"Lenin, akit az úttörok nagyon tiszteltek, a Nagy Októberi Szocialista forradalom atyja volt.","Lenin, who was deeplyrespected by pioneers, was the father of the Great October Socialist Revolution.");
					Item item802 = new Item(s.getKey(),"Az Auróra, ami a Volga folyón ringott, a forradalom szimbóluma volt.","Aurora, which was floating on river Volga, was the symbol of the revolution.");
					Item item803 = new Item(s.getKey(),"A puska, amit a lány levett a falról, töltve volt.","The shotgun the girl took off the wall was loaded.");
					Item item804 = new Item(s.getKey(),"A kés, amibe a fiú tízszer belerohant, csirketrancsírozó szerszám volt.","The knife the boy ran into ten minutes times was a chicken carving tool.");
					Item item805 = new Item(s.getKey(),"A hevero, amin a fiú feküdt, a nagyszobában volt.","The couch the boy was lying on was in the living room.");
					...
					Item item809 = new Item(s.getKey(),"Semmi mást nem tudtam enni, csak egy kis húslevest, töltöttkáposztát, meg egy sültcsirkét.","All I could eat was some meat soup, stuffed cabbage and a fried chicken.");
					Item item810 = new Item(s.getKey(),"Csak egy ötös van nálam.","All I have on me is a fiver.");
					Item item811 = new Item(s.getKey(),"Csak annyit tudok róla, hogy van egy háza Sukorón.","All I know about her is that she has a house at Sukoró.");
					Item item812 = new Item(s.getKey(),"Nem volt más rajta, csak a kalapja.","All she had on was her hat.");
					Item item813 = new Item(s.getKey(),"Minden amit ott látsz, a volt férjemé.","All that you can see there belongs to my ex-husband.");
					Item item814 = new Item(s.getKey(),"Nem hagyott itt semmi mást, csak egy koszlott konyharuhát.","All he's left here is a ragged dishcloth.");
					Item item815 = new Item(s.getKey(),"Nem láttam semmi mást, csak sötétséget.","All that I could see was darkness.");
					Item item816 = new Item(s.getKey(),"Ne csináljon semmi mást, csak mossa meg, vágja le, és szárítsa meg.","All you have to do is wash it, cut it, and dry it.");
					...
					Item item819 = new Item(s.getKey(),"Azt mondta, hogy megcsinálta, ami igaz volt.","She said she'd done it, which was true.");
					Item item820 = new Item(s.getKey(),"Fiatal koromban jól úsztam.","I could swim very well when I was young.");
					Item item821 = new Item(s.getKey(),"Olyan nehéz volt, hogy nem tudta megcsinálni.","It was so difficult that he couldn’t do it.");
					Item item822 = new Item(s.getKey(),"Jó úszó voltam, és még abban a viharban is sikerült kijutnom a partra.","I could swim very well, and even in that storm I was able to reach the shore.");
					...
					Item item832 = new Item(s.getKey(),"Nem gyújthatott rá abban a szobában.","He wasn’t allowed to light a cigarette in that room.");
					Item item833 = new Item(s.getKey(),"Nem építhettek úszómedencét a kertben.","They weren’t allowed to build a swimming pool in the garden.");
					Item item834 = new Item(s.getKey(),"Nem csókolhatom meg, mióta bárányhimlos.","I haven’t been allowed to give her a kiss since she has had chicken pox.");
					Item item835 = new Item(s.getKey(),"Soha nem fogják megengedni, hogy átlépd az országhatárt.","You will never be allowed to cross the border.");
					Item item836 = new Item(s.getKey(),"Azt mondta, hogy nem vezethet, mióta összetörte a papa kocsiját.","He said he hadn’t been allowed to drive a car since he had crashed his father’s.");
					...
					Item item842 = new Item(s.getKey(),"Nem szabad azt gondolnod, hogy valaha is elfeledlek.","You mustn’t think I’ll ever forget you.");
					Item item843 = new Item(s.getKey(),"Az orvos azt mondja, hogy nem szabad sok kenyeret ennem.","The doctor says I am not to eat much bread.");
					Item item844 = new Item(s.getKey(),"Nem szabad kopogtatás nélkül belépni.","You aren’t to enter the room without knocking.");
					Item item845 = new Item(s.getKey(),"Nem volt szabad velük mennie.","She wasn’t to go with them.");
					Item item846 = new Item(s.getKey(),"Nem volt szabad kimenned a szobából engedély nélkül.","You weren’t to leave the room without permission.");
					Item item847 = new Item(s.getKey(),"Virágok szedése tilos!","People may not pick flowers in this park.");
					Item item848 = new Item(s.getKey(),"A kocsiba kutyát behozni tilos.","Dogs may not be taken into these carriages.");
					Item item849 = new Item(s.getKey(),"Nem találkozhatott a családjával a múlt évben.","He wasn’t allowed to meet his family last year.");
					Item item850 = new Item(s.getKey(),"Három hónapja nem találkozhatom a szerelmemmel.","I haven’t been allowed to meet my love for three months.");
					...
					Item item855 = new Item(s.getKey(),"Nem volna szabad ígérgetned, hogy randevúzol velem, ha egyszer nem áll szándékodban így tenni.","You oughtn’t to promise you’ll date me, when you have no intention of doing so.");
					Item item856 = new Item(s.getKey(),"Nem kellett volna kinevetned.","You shouldn’t have laughed at him.");
					Item item857 = new Item(s.getKey(),"Nem lett volna szabad átmenned a piroson.","You oughtn't to have crossed the road when the lights were red.");
					Item item858 = new Item(s.getKey(),"Kilencre vissza kell érned az irodába.","You must be back in the office by nine.");
					...
					Item item861 = new Item(s.getKey(),"Nem kell részt vennie a konferencián.","She needn’t take part in the conference.");
					Item item862 = new Item(s.getKey(),"Nem kell (nem szükséges), hogy a legszebb ruhádban gyere a bulira.","You needn’t put on your smartest dress for the party.");
					...
					Item item865 = new Item(s.getKey(),"Minden reggel el kell vinnie a kislányát iskolába.","She has to take her daughter to school every morning.");
					Item item866 = new Item(s.getKey(),"Kilenckor otthon kell lennem.","I have (got) to be at home at nine.");
					Item item867 = new Item(s.getKey(),"Itt kell maradnod éjszakára (mert nem engedlek el).","You must stay here for the night.");
					Item item868 = new Item(s.getKey(),"Itt kell maradnod éjszakára (mert már sehogy sem tudsz hazamenni).","You have (to stay here for the night.");
					...
					Item item871 = new Item(s.getKey(),"Cigarettát kellett vennie, mert nálam már nem volt.","She had to buy some cigarettes, because I didn’t have any.");
					Item item872 = new Item(s.getKey(),"Nem kellett válaszolniuk arra a buta kérdésre.","They didn’t have to answer that stupid question.");
					Item item873 = new Item(s.getKey(),"Nem kellett (nem volt szükséfestot hívnia, mert a férje kifestette az egész lakást.","873) She didn’t need to send for a painter, because her husband could paint the flat.");
					Item item874 = new Item(s.getKey(),"Segítenem kéne neki.","I ought to help her.");
					Item item875 = new Item(s.getKey(),"Meg kellene (illene) tartanod az ígéretedet.","You should keep your promise.");
					Item item876 = new Item(s.getKey(),"Vigyáznod kéne, hogy mit beszélsz.","You ought to/should be more careful of what you say.");
					Item item877 = new Item(s.getKey(),"Taxival kellett volna menned.","You should have taken a taxi.");
					Item item878 = new Item(s.getKey(),"Ezeket a könyveket is el kellett volna olvasnom.","I ought to have read these books, too.");
					Item item879 = new Item(s.getKey(),"Már iskolában kellene lenniük.","They would have to be at school now.");
					Item item880 = new Item(s.getKey(),"El kéne vinnie a kocsiját muszaki vizsgára.","He would have to take his car for an official test.");
					Item item881 = new Item(s.getKey(),"Udvariasabbnak kellett volna lennem.","I would have had to be politer.");
					Item item882 = new Item(s.getKey(),"Megértobbnek kellett volna lennie velem szemben.","She would have had to be more understandable to me.");
					Item item883 = new Item(s.getKey(),"Ha felmentem volna hozzá, ott is kellett volna maradnom.","If I had gone to his place, I would have had to stay there.");
					Item item884 = new Item(s.getKey(),"Legalább egy fél órát ott kellett volna maradnod.","You should have stayed there for at least half an hour.");
					Item item885 = new Item(s.getKey(),"Jövo szombaton kellett volna összeházasodniuk, de összevesztek, így lottek a lagzinak.","They were to have wedded next Saturday, but they fell out.");
					Item item886 = new Item(s.getKey(),"Holnap kellett volna indulnia Amerikába, de elvették az útlevelét.","He was to have left for America tomorrow, but his passport was withdrawn.");
					Item item887 = new Item(s.getKey(),"Végül is nem kellett volna annyira sietned.","You needn’t have been in such a hurry after all.");
					Item item888 = new Item(s.getKey(),"Nem kellett volna idejönnöd.","You needn’t have come here.");
					Item item889 = new Item(s.getKey(),"Nem kellett volna félbehagynod a munkát.","You oughtn’t to have stopped your work half way.");
					Item item890 = new Item(s.getKey(),"Nem kellett volna hibáztatnod, ha egyszer nem az o bune volt.","You shouldn’t have blamed him, it wasn’t his fault.");
					Item item891 = new Item(s.getKey(),"Mindig kopogj, ha be akarsz jönni hozzám.","You are always to knock before you enter my room.");
					...
					Item item903 = new Item(s.getKey(),"Biztos, hogy nem o okozta a balesetet.","She couldn’t have caused that accident.");
					Item item904 = new Item(s.getKey(),"Az ki van csukva, hogy ot láttad a Pipacsban, hisz az egy rendes no.","You can’t have seen her at Pipacs night club; she is a decent lady.");
					Item item905 = new Item(s.getKey(),"Bizonyára ez az a hely, ahol a régi iskola állt.","This will be the place where the old school stood.");
					...
					Item item908 = new Item(s.getKey(),"Vidd magaddal az esokabátod, lehet, hogy esni fog.","Take your raincoat, it may rain.");
					Item item909 = new Item(s.getKey(),"Ne menj el, még megjöhetnek.","Don’t go away, they may come yet.");
					Item item910 = new Item(s.getKey(),"Lehet, hogy épp a férjével beszélget.","She may be talking now to her husband.");
					Item item911 = new Item(s.getKey(),"Lehet, hogy az esti vonattal jönnek.","They might come by the night train.");
					Item item912 = new Item(s.getKey(),"Lehet, hogy nyerünk egy csomót a lóversenyen.","We might win a lot at the races.");
					...
					Item item916 = new Item(s.getKey(),"Lehet, hogy megsérült, vagy meg is sérülhetett volna.","She might have been hurt.");
					Item item917 = new Item(s.getKey(),"Lehet, hogy jelentették a tervüket.","They might have reported their plan.");
					...
					Item item926 = new Item(s.getKey(),"Egy ilyen lányt nem szabad elvenni.","You mustn’t marry a girl like that.");
					...
					Item item934 = new Item(s.getKey(),"Nem kellett volna megházasodnia. (Nem lett volna szabad értelemben.)","He shouldn’t have got married.");
					Item item935 = new Item(s.getKey(),"Nem kellett volna megházasodnia. (Nem lett volna szükséges értelemben.)","He needn’t have got married.");
					...
					Item item950 = new Item(s.getKey(),"Lehetséges, hogy szerette a knédlit.","It is possible he liked dumplings.");
					...
					Item item996 = new Item(s.getKey(),"Senkinek nem szabad beszélni róla.","You mustn't talk to anyone about it.");
					Item item997 = new Item(s.getKey(),"Biztos fáradt vagy a sok kutyagolás után.","You must feel tired after your long walk.");
					...
					Item item1001= new Item(s.getKey(),"Az nem lehet, hogy elfeledkeztél a születésnapomról!","You couldn’t have forgotten about my birthday!");
					...
					Item item1007= new Item(s.getKey(),"Ma reggel nem kellett korán kelnem.","I didn’t need to get up early this morning.");
					Item item1008= new Item(s.getKey(),"Nem kellett volna ajándékot hoznod.","You needn’t have brought me a present.");
					Item item1009= new Item(s.getKey(),"Abba kéne hagynod a dohányzást.","You should give up smoking.");
					Item item1010= new Item(s.getKey(),"Lehet, hogy Józsi lekéste a vonatot.","Joe may/might have missed the train.");
					Item item1011= new Item(s.getKey(),"Meg kellett volna beszélniük az ügyet.","They should have discussed the matter.");
					Item item1012= new Item(s.getKey(),"Nem lett volna szabad kiköpni az ablakon.","You shouldn’t have spat it out of the window.");
					Item item1013= new Item(s.getKey(),"Lehet, hogy Jóska írta a falra azt a gusztustalan mondatot.","Joe may have written that disgusting sentence on the wall.");
					Item item1014= new Item(s.getKey(),"Az ki van csukva, hogy Jóska írta, hisz nem is tud írni.","Joe can't have written it, as he can't even write.");
					Item item1015= new Item(s.getKey(),"Biztos a fészekbol esett ki az a kismadár.","That little bird must have fallen out of the nest.");
					Item item1016= new Item(s.getKey(),"Nem kellett volna táviratot küldened, egy levél is megtette volna.","You needn't have sent a telegram; a letter would also have done.");
					Item item1017= new Item(s.getKey(),"Akár az egész dinnyét megehetted volna, nekem nem kell.","You might as well have eaten all the melon; I don't need any.");
					Item item1018= new Item(s.getKey(),"A végállomásig kellet volna menned és ott átszállni egy buszra.","You should have gone as far as the terminus and there change for a bus.");
					Item item1019= new Item(s.getKey(),"Attól még nem kellett volna lecsavarnod az orrát.","You shouldn't have twisted his nose off!");
					Item item1020= new Item(s.getKey(),"Valószínu, hogy telefonált, csak nem voltam otthon.","She may have given me a ring but I wasn't at home.");
					Item item1021= new Item(s.getKey(),"Lehet, hogy megint elvált, mert hetek óta gyakrabban jön.","He may have got divorced again because he's been coming more and more often for weeks.");
					Item item1022= new Item(s.getKey(),"Ha jó leszel, vacsora után ehetsz egy banánt.","If you are good, you may eat a banana after dinner.");
					Item item1023= new Item(s.getKey(),"Nem kellett volna fölizgatnod magad, nem ér annyit az egész.","You shouldn't have upset yourself, it's not worth it.");
					Item item1024= new Item(s.getKey(),"Lehet, hogy megcsináltatom a horoszkópom.","I might have my horoscope made.");
					Item item1025= new Item(s.getKey(),"Ne izgulj, biztos megjön holnap.","Don't worry, he'll surely come tomorrow.");
					Item item1026= new Item(s.getKey(),"Nem lehetsz ilyen érzéketlen!","You can't be so unfeeling!");
					Item item1027= new Item(s.getKey(),"Esetleg kihullhat a hajad, ha annyit fogyókúrázol.","You might lose your hair if you're dieting so hard.");
					Item item1028= new Item(s.getKey(),"Hamarább is szólhattál volna, hogy nincs pénzed.","You could have told me earlier that you had no money.");
					Item item1029= new Item(s.getKey(),"Biztos épp a halakat etette, mikor csöngettél.","He must have been feeding the fish when you rang.");
					Item item1030= new Item(s.getKey(),"Az nem lehet, hogy annyi szív hiába onta vért…","So many hearts can't have shed that much blood in vain…");
					Item item1031= new Item(s.getKey(),"Biztos agyára ment a jólét.","Living in clover must have driven him crazy.");
					Item item1032= new Item(s.getKey(),"Lehet, hogy összekevertelek valakivel. ","I may have confused you with somebody else.");
					Item item1033= new Item(s.getKey(),"Valószínu lemerevedett, amikor meglátta a húgát egy rendor karjaiban.","He must have been transfixed seeing his sister in a cop's arms.");
					Item item1034= new Item(s.getKey(),"Meg kellett volna élezned a kaszát.","You should have sharpened the scythe.");
					Item item1035= new Item(s.getKey(),"Biztos krumplit hámoz.","She must be peeling potatoes.");
					Item item1036= new Item(s.getKey(),"Esetleg megvakulhatsz, ha annyit nézed a lábam.","You might go blind if you keep looking at my legs.");
					Item item1037= new Item(s.getKey(),"Be kéne tenni a hutobe.","It should be put in the fridge.");
					Item item1038= new Item(s.getKey(),"Nem kellett volna hozzámenned ahhoz a részeg tengerészhez.","You shouldn't have married that drunken sailor.");
					Item item1039= new Item(s.getKey(),"Ehetek egy banánt?","May I eat a banana?");
					Item item1040= new Item(s.getKey(),"Akár fejbe is verhetett volna.","He might as well have hit you on the head.");
					Item item1041= new Item(s.getKey(),"Biztos kikelt volna, ha öntözöd.","It would surely have sprouted if you had watered it.");
					Item item1042= new Item(s.getKey(),"Hála istennek nem kellett mind meginnom.","Thank God, I didn't need to drink it all.");
					Item item1043= new Item(s.getKey(),"Nem lett volna fontos kiszedni a mellébol a csontot.","You needn't have taken the bone out of its breast.");
					Item item1044= new Item(s.getKey(),"Holnapra kellett volna megírnia, de közben disszidált.","He was to have written it by tomorrow, but in the meantime he had defected.");
					Item item1045= new Item(s.getKey(),"Biztos a fejébe vette, hogy nem száll le rólam.","He must have put his mind on not leaving me alone.");
					Item item1046= new Item(s.getKey(),"Lehetetlen, hogy mind megitta.","He couldn1t have drunk it all.");
					Item item1047= new Item(s.getKey(),"Be kellett volna olajoznod a bicikliláncot.","You should have oiled the bike chain.");
					Item item1048= new Item(s.getKey(),"Lehet, hogy nyitva maradt az ajtó.","The door may have been left open.");
					Item item1049= new Item(s.getKey(),"Biztos borotválkozik, az serceg így.","He must be shaving, that's what gives that crackling sound.");
					Item item1050= new Item(s.getKey(),"Biztos, hogy tévedsz.","You must be mistaken.");
					Item item1051= new Item(s.getKey(),"Ki van zárva, hogy ot láttad, hisz Baltimore-ban van.","You couldn't have seen him, since he's in Baltimore now.");
					...
					Item item1056= new Item(s.getKey(),"Lehet, hogy elmentek paradicsomot szedni.","They may have gone to pick tomatoes.");
					...
					Item item1059= new Item(s.getKey(),"Nem kellett zöldséget venni, volt elég a kertben.","We didn't need to buy vegetables, there was enough in the garden.");
					Item item1060= new Item(s.getKey(),"Biztos, hogy nem Mariskát láttad éjjel a körúton.","You couldn't have seen Mary on the boulevard at night.");
					Item item1061= new Item(s.getKey(),"Nem valószínu, hogy elkapták a tolvajt.","The thief is unlikely to have been caught.");
					Item item1062= new Item(s.getKey(),"Már bizonyára hallottad az újságot.","You must have heard the news.");
					Item item1063= new Item(s.getKey(),"Nem kellett volna mindjárt az elso tánc után letépni a blúzát.","You shouldn't have torn off her blouse right after the first dance.");
					Item item1064= new Item(s.getKey(),"Lehet, hogy nem vagyok egy lángész.","I may not be a genius.");
					Item item1065= new Item(s.getKey(),"Nem valószínu, hogy ma este itt leszek.","I'm likely to be here tonight.");
					Item item1066= new Item(s.getKey(),"Esetleg meglazulhat a gomb és leesik a szoknyád.","The button might get loose and skirt will fall.");
					Item item1067= new Item(s.getKey(),"Biztos a taxiban felejtette a pénztárcáját.","She must have left her purse in the cab.");
					Item item1068= new Item(s.getKey(),"Már rég meg kellett volna mondanod neki.","You should have told her long ago.");
					...
					Item item1072= new Item(s.getKey(),"Nem kéne elmeorvoshoz fordulnod?","Shouldn't you turn to a psychiatrist?");
					Item item1073= new Item(s.getKey(),"Nem kellett volna úgy rohannod, hisz még nem volt ott.","You needn't have run so fast because there was nobody there.");
					...
					Item item1076= new Item(s.getKey(),"Rendőr az nem lehet, mert zöld a sapkája.","He can't be a cop since his cap is green.");
					Item item1077= new Item(s.getKey(),"Méhecske nem lehetett, az hangosabban zümmög.","It couldn't have been a bee, that buzzes more loudly.");
					Item item1078= new Item(s.getKey(),"Lehet, hogy darázs volt.","It may have been a wasp.");
					Item item1079= new Item(s.getKey(),"Esetleg az is lehet, hogy szúnyog volt.","It might have been a mosquito.");
					Item item1080= new Item(s.getKey(),"Biztos a másikat húzta ki.","He must have taken out the other one.");
					Item item1081= new Item(s.getKey(),"A jobb alsó hatost kellett volna kihúznia.","He should have taken out the lower six on the right.");
					Item item1082= new Item(s.getKey(),"Biztos nőtlen, mert olyan simák az arcvonásai.","He must be single as his face is not worn out at all.");
					...
					Item item1088= new Item(s.getKey(),"Elmentem az uszodába egy jót úszni.","I went to the swimming pool to swim a bit.");
					Item item1089= new Item(s.getKey(),"Még mielott felkérte volna a lányt, Jóska úgy döntött, hogy közelebbrol is megnézi, hogy megbizonyosodjon, nem fiú-e az illeto.","Before asking the girl to dance Joe decided to take a close look at her to make sure it was not a boy.");
					Item item1090= new Item(s.getKey(),"Tévedni emberi dolog.","To err is human.");
					Item item1091= new Item(s.getKey(),"Lenni vagy nem lenni volt az egyik hamleti kérdés.","To be or not to be was a question of Hamlet’s.");
					...
					Item item1096= new Item(s.getKey(),"Érdekes dolog esoben énekelni.","Singing in the rain is very interesting.");
					Item item1097= new Item(s.getKey(),"Repülővel gyorsabb menni mint lóháton.","Travelling by air is faster than riding a horse.");
					Item item1098= new Item(s.getKey(),"A sírás noi praktika.","Crying is a female trick.");
					Item item1099= new Item(s.getKey(),"A tanulás az élet fontos része.","Studying is an important part of your life.");
					Item item1100= new Item(s.getKey(),"Izgalmas dolog a belvárosban vezetni.","It's exciting to drive a car downtown.");
					Item item1101= new Item(s.getKey(),"Érdekes volt végighallgatni, hogy mit mond.","It was interesting to hear what he said.");
					Item item1102= new Item(s.getKey(),"Jó lesz találkozni veled.","It will be lovely to meet you there.");
					Item item1103= new Item(s.getKey(),"Nehéz a boldogságtól búcsút venni.","It’s hard to say goodbye to happiness.");
					Item item1104= new Item(s.getKey(),"Udvariatlanság lenne nem meghívni.","It would be very impolite not to invite him.");
					Item item1105= new Item(s.getKey(),"Fontos, hogy higgy abban amit csinálsz.","It is important to believe in what you do.");
					Item item1106= new Item(s.getKey(),"Könnyu ilyen fajta mondatokat lefordítani.","It is easy to translate sentences of the kind.");
					Item item1107= new Item(s.getKey(),"Jézus, örülök, hogy személyesen találkozhatunk.","Jesus, I’m overjoyed to meet you face to face. (Superstar)");
					...
					Item item1111= new Item(s.getKey(),"Meglepetéssel hallottuk a híreket.","We were surprised to hear the news.");
					Item item1112= new Item(s.getKey(),"Boldog vagyok, hogy vendégül láthatlak.","I’m happy to give you a treat.");
					Item item1113= new Item(s.getKey(),"Szerencsés vagy, hogy ilyen kabátod van.","You are fortunate to have a coat like that.");
					...
					Item item1116= new Item(s.getKey(),"Alig várom, hogy a barátaim találkozhassanak velük.","I’m anxious for my friends to meet them.");
					Item item1117= new Item(s.getKey(),"Türelmetlenül vártuk, hogy busz végre elinduljon.","We were impatient for the bus to start.");
					Item item1118= new Item(s.getKey(),"Derogál neki, hogy eljöjjön hozzánk.","It’s inconvenient for him to visit us.");
					Item item1119= new Item(s.getKey(),"Veszélyes az, ha egy öreg ember gyorsan fut.","It’s dangerous for an old man to run fast.");
					Item item1120= new Item(s.getKey(),"Sajnáltuk, hogy olyan korán elmennek.","We were sorry for them to leave so soon.");
					...
					Item item1124= new Item(s.getKey(),"Szégyen, hogy nem élvezel egy ilyen könyvet.","It’s a shame not to enjoy a book like that.");
					Item item1125= new Item(s.getKey(),"Milyen kellemes meglepetés, hogy itt vagy.","It’s a pleasant surprise to see you here.");
					Item item1126= new Item(s.getKey(),"Ideje, hogy búcsúzzunk.","It’s time to say our farewells.");
					Item item1127= new Item(s.getKey(),"Tiszta időpocsékolás akkor beszélni vele, mikor ilyen hangulatban van.","It’s a waste of time to talk to her when she’s in this mood.");
					Item item1128= new Item(s.getKey(),"Maga a paradicsom forró kádban pihegni egy nehéz nap után.","It’s a sheer paradise to relax in a hot bath after a hard day’s work.");
					Item item1129= new Item(s.getKey(),"Döbbenetes volt meglátni a számlát.","It was a shock to see the size of the bill.");
					Item item1130= new Item(s.getKey(),"Nem vagyok olyan hangulatban, hogy beszélgessek veled.","I’m not in the mood to talk to you now.");
					...
					Item item1138= new Item(s.getKey(),"Mi vagyunk azok, akik boldogságot hoznak.","We are the ones to make a brighter day.");
					Item item1139= new Item(s.getKey(),"Sok a dolgom.","I have a lot of work to do.");
					Item item1140= new Item(s.getKey(),"Nem volt semmi ok arra, hogy Párizsba menjek.","I had no occasion to go to Paris.");
					...
					Item item1143= new Item(s.getKey(),"Nem volt lehetoségünk, hogy megnézzük a várost.","There was no possibility for us to see the town.");
					Item item1144= new Item(s.getKey(),"Nincs számodra pénzem.","I have no money for your to spend.");
					Item item1145= new Item(s.getKey(),"Van hely ahova leülhetek?","Is there any room for me to sit down in here?");
					...
					Item item1148= new Item(s.getKey(),"Nincs sok értelme beszélni hozzá úgyse figyel sose.","It’s no good talking to him because he never listens.");
					Item item1149= new Item(s.getKey(),"Nem érdemes várni rá.","It isn’t worth waiting for him.");
					Item item1150= new Item(s.getKey(),"Azzal volt elfoglalva, hogy játszotta a nagyfonököt.","He was busy bossing around him.");
					Item item1151= new Item(s.getKey(),"Érdemes meghallgatni azt a lemezt.","That record is worth listening to.");
					Item item1152= new Item(s.getKey(),"Tele van a hócipom azzal, hogy rá várjak.","I’m fed up with waiting for him.");
					Item item1153= new Item(s.getKey(),"Elegem van, hogy annyit járkálsz a nyakamra.","I’m sick of you coming round here.");
					...
					Item item1157= new Item(s.getKey(),"Engem tett felelossé, hogy elveszett a pénz.","She made me responsible for losing the money.");
					...
					Item item1165= new Item(s.getKey(),"Öt éve kezdett zongorázni tanulni.","1165) She began learning the piano five years ago.");
					...
					Item item1175= new Item(s.getKey(),"Emlékszem, hogy bezártam az ajtót, mikor elmentem hazulról.","I remember locking the door as I left the house.");
					Item item1176= new Item(s.getKey(),"Nem felejtettem el bezárni az ajtót, mikor elmentem hazulról.","I remembered to lock the door as I left the house.");
					Item item1177= new Item(s.getKey(),"Soha nem fogom elfelejteni az, amikor megtaláltam azt a régi érmét a kertben.","I’ll never forget finding that old coin in my garden.");
					...
					Item item1180= new Item(s.getKey(),"Sajnálattal kell közölnöm, hogy tartozol egy ezressel.","I regret to inform you that you owe me a grand.");
		...
		if (!subThemeList.isEmpty()) {
			for (SubTheme s : subThemeList) {
				if (s.getName().equals("Fordítási gyakorlat")) {
					...
					Item item1224= new Item(s.getKey(),"Nem engedhetem meg magamnak, hogy a Fordommal gázoljak át a folyón.","I can’t afford to ford the river in a Ford.");
					Item item1225= new Item(s.getKey(),"Úgy döntöttek, hogy új dalt tanulnak.","They decided to learn a new song.");
					...
					Item item1233= new Item(s.getKey(),"Nem volt hajlandó megmutatni neki a cicijét. (Adrian Mole)","She refused to show him her nipple.");
					Item item1234= new Item(s.getKey(),"Könyörögtem, hogy vigyen el egy magán orrászhoz. (Adrian Mole)","I’ve begged her to take me to a private nose specialist.");
					...
					Item item1256= new Item(s.getKey(),"Egyre csak azt hajtogatta: “Csavaroztál a tejesemberrel!” (Chicago)","He kept saying: “You went screwing the milkman”.");
					Item item1257= new Item(s.getKey(),"Tiltakozom, hogy hátulról gyere ilyen módszerekkel.","I object to your using that kind of dirty tricks to get at me.");
					Item item1258= new Item(s.getKey(),"Muszáj volt egy-két célzást ejtenem.","I couldn’t help dropping a thing or two.");
					Item item1259= new Item(s.getKey(),"Élvezed, hogy ezt csinálod?","Do you enjoy doing that?");
					Item item1260= new Item(s.getKey(),"Megpróbálta kikerülni, hogy válaszolnia kelljen a kérdéseimre.","He tried to avoid answering my questions.");
					Item item1261= new Item(s.getKey(),"Bevallotta, hogy o lopta el a biciklit.","She admitted stealing the bicycle.");
					Item item1262= new Item(s.getKey(),"Késleltették a jelentés nyilvánosságra hozatalát.","They delayed publishing the report.");
					Item item1263= new Item(s.getKey(),"A rendorségnek végül sikerült megoldania a rejtélyt.","Police have finally succeeded in solving the mystery.");
					Item item1264= new Item(s.getKey(),"Nem emlékszem, hogy valaha is találkoztam volna vele.","I don’t recall ever meeting her.");
					Item item1265= new Item(s.getKey(),"Ragaszkodik hozzá, hogy minden évben külföldön nyaraljon.","She insists on having a holiday abroad every year.");
					...
					Item item1273= new Item(s.getKey(),"Reggeli elott szoktam fürödni.","I usually take a bath before having breakfast.");
					Item item1274= new Item(s.getKey(),"Nem sokkal azután hogy elvégezte az egyetemet, munkába állt.","She started the job soon after leaving the university.");
					Item item1275= new Item(s.getKey(),"Mióta eljöttünk Párizsból, már megnéztük Brüsszelt és Amszterdamot.","Since leaving Paris, we’ve visited Brussels and Amsterdam.");
					Item item1276= new Item(s.getKey(),"Azonkívül hogy profi focista, még fagyizót is vezet.","Besides being a pro football player, he also runs an ice-cream shop.");
					Item item1277= new Item(s.getKey(),"Anélkül hogy hálátlannak akarnék mutatkozni, meg kell jegyezzem, hogy nászajándékuk nagyobb léptéku is lehetett volna.","Without wishing to appear ungrateful I think their wedding present could have been a bit more generous.");
					Item item1278= new Item(s.getKey(),"Dolgoznod kéne ahelyett hogy ott döglesz.","You should be working instead of lying there in bed.");
					Item item1279= new Item(s.getKey(),"Miután megette a csontot, a kutya macskát kért.","Having eaten the bone the dog asked for a cat.");
					Item item1280= new Item(s.getKey(),"Miután bejejezte a mosogatást fozni kezdett.","Finishing the wash up she started to cook.");
					Item item1281= new Item(s.getKey(),"Miután visszatért külföldrol, elhatározta, hogy új életet kezd.","Having returned from abroad she decided to start a new life.");
					Item item1282= new Item(s.getKey(),"Az üzletbe menvén balesetet láttunk.","Going to the shop we saw an accident.");
					Item item1283= new Item(s.getKey(),"Napoleon kijött a házból, s közben a kutyái ugattak körülötte.","Napoleon came out of the farmhouse with his dogs barking around him.");
					Item item1284= new Item(s.getKey(),"Hangosan nevetve léptek a gyerekek a szobába be.","The children came into the room laughing loudly.");
					Item item1285= new Item(s.getKey(),"A választások közeledtével a kormánynak egyre kevesebb ideje van arra, hogy világossá tegye nézeteit.","With the elections approaching the government is running out of time to settle its views.");
					Item item1286= new Item(s.getKey(),"Megállt az út közepén megdöbbenve a hatalmas autó látványától.","She stopped in the middle of the road surprised by the sight of the car.");
					Item item1287= new Item(s.getKey(),"A férfi folytatta az ivást, miközben a felesége hamutartókat vagdosott hozzá.","The man went on drinking with his wife throwing ashtrays at him.");
					Item item1288= new Item(s.getKey(),"Egy pillanatra megállt és a fiút tanulmányozta.","He paused for a moment studying the boy.");
					Item item1289= new Item(s.getKey(),"A földön feküdt és levego után kapkodott.","He was lying on the floor gasping for breath.");
					Item item1290= new Item(s.getKey(),"Az idos hölgy a rendorség felé tartott, miközben egy ifjú ember ugrált körülötte bocsánatért esedezve.","The old lady was heading for the police station with a young man jumping around her and begging her pardon.");
					Item item1291= new Item(s.getKey(),"Mivel elfogyott a hentes húsa, hát bezárta a boltot.","Having run out of meat, the butcher closed his shop.");
					Item item1292= new Item(s.getKey(),"Mivel szegények volta, nem tudtak házat venni maguknak.","Being very poor, they couldn’t afford to buy a house.");
					Item item1293= new Item(s.getKey(),"Mivel félt az esotol, úgy döntött, hogy otthon marad.","Being afraid of the rain, she decided to stay at home.");
					Item item1294= new Item(s.getKey(),"Miután zavarta a lányt a kukák látványa, függönyt tett az ablakra.","Troubled by the sight of the dustbins she put a curtain on the window. ");
					Item item1295= new Item(s.getKey(),"Mivel más már nem volt, hát az anyósához fordult.","Having no one else to turn to, she turned to her mother-in-law.");
					Item item1296= new Item(s.getKey(),"Mivel pénzt nem talált a betöro, hát mindent szétvert.","Finding no money in the house the burglar smashed the place.");
					Item item1297= new Item(s.getKey(),"Mivel elfogyott a jég, kiment hogy hozzon.","Having run out of ice, she went out to get some.");
					...
					Item item1316= new Item(s.getKey(),"A pancsoló kislány a füstölt szalonnát nyalogatja.","The splashing girl is licking the smoked bacon.");
					Item item1317= new Item(s.getKey(),"A megfoltozott farmer ott lóg a szárító kötélen.","The patched jeans are hanging on the drying rope.");
					Item item1318= new Item(s.getKey(),"A nyávogó macska zárt ajtók mögött ül.","The meowing cat is sitting behind locked doors.");
					Item item1319= new Item(s.getKey(),"Az éneklo kutya a kimeszelt házban vonyít.","The singing dog is whining in the whitewashed house.");
					Item item1320= new Item(s.getKey(),"A megpucolt tuzhelyen van a rotyogó húsleves.","The boiling meat soup is on the cleaned cooker.");
					Item item1321= new Item(s.getKey(),"Ismered azt a lányt, aki azzal a férfival táncol?","Do you know the girl dancing with that man?");
					Item item1322= new Item(s.getKey(),"A könyvek, melyek az asztalon vannak, sokba kerültek.","The books lying on the desk were very expensive.");
					Item item1323= new Item(s.getKey(),"Olyan ház ez, mely évszázadokkal ezelott épült. (“lett építve”)","This is a house built some hundred years ago.");
					Item item1324= new Item(s.getKey(),"Olyan ember o, akit mindenki becsül. (“becsülve van mindenki által”)","He is a man trusted by everybody.");
					Item item1325= new Item(s.getKey(),"Ki az a lány, aki a sarkon áll?","Who is the girl standing at the corner?");
					Item item1326= new Item(s.getKey(),"Kié az a Trabant, mely a Soroksári úton száguldozik?","Whose is the Trabant racing on Soroksári road?");
					Item item1327= new Item(s.getKey(),"A lány, aki az asztalnál ül, a novérem.","The girl sitting at the table is my sister.");
					Item item1328= new Item(s.getKey(),"A kígyó, mely a fuben fekszik, megmar, ha rálépsz.","The snake sleeping in the grass will bite you if you tread upon it.");
					Item item1329= new Item(s.getKey(),"A férfi, aki az autómat javítja, kiváló szakember.","The man repairing my car is very good at his job.");
					Item item1330= new Item(s.getKey(),"Az utcán rohanó fiú javító iskolából szökött meg.","The boy running in the street escaped from a reform school.");
					Item item1331= new Item(s.getKey(),"Hozd ide a papagájt, amelyik a ketrecében beszélget.","Bring me the parrot speaking in its cage.");
					Item item1332= new Item(s.getKey(),"A férfit, aki a bíró elott áll, rablógyilkossággal vádolják.","The man standing in front of the judge is charged with capital murder.");
					Item item1333= new Item(s.getKey(),"Hozd ide a borral teli flaskát.","Get me the flask filled with wine.");
					Item item1334= new Item(s.getKey(),"A csótányok megették az összes ennivalót, ami a konyhában maradt.","The cockroaches ate all the food left in the kitchen.");
					Item item1335= new Item(s.getKey(),"A fénykép, mely rólad készült, gyönyöru.","The photo taken of you is beautiful.");
					Item item1336= new Item(s.getKey(),"A Magyarországon készült kolbász világhíru.","Sausages made in Hungary are very famous.");
					Item item1337= new Item(s.getKey(),"A New York-ban eltöltött napok csodásak voltak.","The days spent in New York were amazing.");
					Item item1338= new Item(s.getKey(),"A kertben talált óra az enyém.","The watch found in the garden belongs to me.");
					Item item1339= new Item(s.getKey(),"Nehéz bátornak lenni, mikor az ember csak egy nagyon kicsi állat.","It's hard to be brave when you are only a very small animal.");
					...
					Item item1342= new Item(s.getKey(),"A futés borzasztó drága lett az idén.","Heating has become very expensive this year.");
					Item item1343= new Item(s.getKey(),"A napozás olcsó, ha nem kell venni napolajat.","Lying in the sun is cheap if you don't have to buy suntan lotion.");
					...
					Item item1347= new Item(s.getKey(),"Nehezen tudta eldönteni melyiket vegye.","It was difficult for him to decide which one to buy.");
					Item item1348= new Item(s.getKey(),"Szörnyu volt látni, ahogy ott szenvednek a pályán.","It was terrible to see them suffering in the field.");
					Item item1349= new Item(s.getKey(),"Szerintem könnyu volt megírni.","I think it was easy to write it.");
					Item item1350= new Item(s.getKey(),"Lepihenni melletted, menedék a szívednek.","To lie down and rest beside you is a shelter for my heart.");
					Item item1351= new Item(s.getKey(),"Utálok csavarogni, mikor minden zsúfolt.","I hate hanging about when everything is packed.");
					...
					Item item1355= new Item(s.getKey(),"Mindig iszik almalevet lefekvés elott.","She always drinks apple juice before going to bed.");
					...
					Item item1360= new Item(s.getKey(),"Unom már, hogy mindig én húzlak ki a csávából.","I'm getting tired of saving your butt.");
					Item item1361= new Item(s.getKey(),"Megpróbálunk valami jó megoldást találni mindenki számára.","We're trying to find a proper solution for everybody.");
					Item item1362= new Item(s.getKey(),"Nem felejtettél el tököt hozni?","Did you remember to bring pumpkin?");
					Item item1363= new Item(s.getKey(),"Emlékszem, hogy az asztalra tettem, de most nem találom sehol.","I remember putting it on the table but now I can't find it anywhere.");
					...
					Item item1369= new Item(s.getKey(),"Vállaltam, hogy a hónap végére megcsinálom.","I managed to catch up with him.");
					Item item1370= new Item(s.getKey(),"Nem sikerült utolérnem.","I failed to catch up with him.");
					Item item1371= new Item(s.getKey(),"Felajánlottam, hogy kifizetem a szállodát.","I offered to pay for the hotel.");
					Item item1372= new Item(s.getKey(),"Remélem, hogy hamarosan találkozunk.","I hope to see you as soon as possible.");
					Item item1373= new Item(s.getKey(),"Szólj, hogy hívjam fel az állatkertet.","Remind me to call the zoo, please.");
					Item item1374= new Item(s.getKey(),"Ez téged arra fog kötelezni, hogy minden kívánságát teljesítsd.","That will oblige you to fulfil all her wishes.");
					Item item1375= new Item(s.getKey(),"Tényleg akartam veled beszélni a dologról, de nem gondoltam, hogy ma ilyen korán hazajössz.","I really meant to tell you about the situation very soon, but I didn't expect you to come home as early as that.");
					...
					Item item1378= new Item(s.getKey(),"A zsugori fazonja nem volt hajlandó kipengetni egy rongyot.","The main gift refused to fork out a grand.");
					Item item1379= new Item(s.getKey(),"Ne felejtsd el megnézni, nem hagytam-e nálad a csipkés kombiném.","Don't forget to check if I have left my laced slip in your house.");
					Item item1380= new Item(s.getKey(),"Fontos lesz majd, hogy tudj angolul.","It will be very important for you to speak English.");
					Item item1381= new Item(s.getKey(),"Nagyon betegnek tettette magát, de engem nem tudott átverni.","He pretended to be very sick, but he failed to fool me.");
					Item item1382= new Item(s.getKey(),"A rendor meglátott egy embert, aki közszemérem elleni vétséget követett el és úgy döntött, hogy eltartóztatja.","The policeman caught sight of a man committing a public nuisance, so he decided to arrest him.");
					Item item1383= new Item(s.getKey(),"Nem akartalak megbántani.","I didn't mean to hurt your feelings.");
					Item item1384= new Item(s.getKey(),"Abbahagytam az ivást meg dohányzást, mert nagyon drága mulatság.","I gave up smoking and drinking because they are very expensive habits.");
					Item item1385= new Item(s.getKey(),"Nem bánom ha itt maradsz éjszakára, de légyszíves ne horkolj.","I don't mind you staying here for the night, but please don't snore.");
					Item item1386= new Item(s.getKey(),"Érdemes megvenni ezt a csinos kis olasz cipot.","It's worth buying that pretty little Italian pair of shoes.");
					Item item1387= new Item(s.getKey(),"Érdemes venni ilyen bölcsot, mert a baba álomba tudja ringatni magát.","It's worth buying a cradle like that because the baby can rock itself into sleep.");
					Item item1388= new Item(s.getKey(),"Nem érdemes sírni elszalasztott lehetoségek miatt.","It's no use crying after missed opportunities.");
					Item item1389= new Item(s.getKey(),"Muszáj kiszelloztetnem, amikor elmegy.","I can never help airing the room after she leaves.");
					Item item1390= new Item(s.getKey(),"Mikor eloször ránéztem, nevetnem kellett, aztán meg sírnom.","When I first looked at her I couldn't help laughing, but then I couldn't help crying.");
					Item item1391= new Item(s.getKey(),"Ki nem állhatom, amikor telefüstöli a szobát.","I can't stand him filling the room with smoke.");
					Item item1392= new Item(s.getKey(),"Én élvezem, mikor kint vagyunk a nyílt tengeren egy kis gumicsónakban, és körülöttünk cápák.","I really enjoy being out there upon the high sea in a small rubber boat surrounded by sharks.");
					Item item1393= new Item(s.getKey(),"Élvezte, hogy itt fekszik a függoágyban és tíz szép lány kínálgatja itallal.","He enjoyed lying in the hammock with ten girls offering him drinks.");
					Item item1394= new Item(s.getKey(),"Nem tudtam megúszni, hogy ne találkozzam vele.","I couldn't avoid meeting him.");
					Item item1395= new Item(s.getKey(),"Javaslom, hogy mindent szavazzunk le.","I suggest voting against everything.");
					Item item1396= new Item(s.getKey(),"Nekem hiányzik, hogy minden reggel ötkor keljek.","I miss having to go to work at five every morning.");
					Item item1397= new Item(s.getKey(),"Megint kezdett pukkasztgatni, bár figyelmeztettem, hogy ne tegye.","He started popping again, though I had warned him not to do it.");
					Item item1398= new Item(s.getKey(),"Nem tudta megállni, hogy ne csússzon egyre közelebb hozzá.","He couldn't help slipping closer and closer to her.");
					Item item1399= new Item(s.getKey(),"Még csak tárgyalni se hajlandó arról, hogy leköltözzön egy libafarmra.","She wouldn't even consider moving to the goose farm.");
					Item item1400= new Item(s.getKey(),"El tudod te képzelni Zsuzsit, amint egy libafarmon él?","Can you imagine Susie living on a goose farm?");
					Item item1401= new Item(s.getKey(),"Kétlem, hogy oszinte egy ügyben.","I doubt him being honest about it.");
					Item item1402= new Item(s.getKey(),"Tagadom, hogy bármi ilyesmit tettem volna, uram.","I deny doing anything like that, sir.");
					Item item1403= new Item(s.getKey(),"A tyúkok nehezményezték, hogy napi két tojást kelljen tojniuk.","The hens resented having to lay two eggs a day.");
					Item item1404= new Item(s.getKey(),"Sosem említetted, hogy volt dolgod vele.","You never mentioned having had an affair with him.");
					Item item1405= new Item(s.getKey(),"Még egyszer nem kockáztatom meg, hogy kölcsönadjak neki.","I won't risk lending him any money once again.");
					Item item1406= new Item(s.getKey(),"Megfogta a tehén farkát, mely az istállóban kérodzött.","He caught the tail of the cow ruminating in the barn.");
					Item item1407= new Item(s.getKey(),"Dühös volt a soforre, aki az ablak alatt túráztatta a kocsiját.","He was angry with the driver revving his car under the window.");
					Item item1408= new Item(s.getKey(),"Megvigasztalta a lányt, aki ott sóhajtozott a szoba sarkában.","He tried to comfort the girl sighing in the corner of the room.");
					Item item1409= new Item(s.getKey(),"Te is láttad a csótányt, amelyik a lefolyó felé rohant?","Did you also see the cockroach running towards the plug-hole?");
					Item item1410= new Item(s.getKey(),"De szép az a medál, ami a nyakadban lóg.","Wow, that's beautiful medal hanging round your neck.");
					Item item1411= new Item(s.getKey(),"Kiszúrta azt az alakot, amelyik az Astoria sarkánál pénzt váltott.","He spotted the guy changing money at the corner of Astoria.");
					Item item1412= new Item(s.getKey(),"Nem vette meg a lovat, amelyik ott nyerített a karám sarkában.","He didn't buy the horse neighing in the corner of the stock yard.");
					Item item1413= new Item(s.getKey(),"Viszont megvette a birkát, amelyik ott bégetett a lovon.","But he bought the sleep bleating on the horse.");
					Item item1414= new Item(s.getKey(),"Levágta a bajszát, amelyik mindig böködte a lány fülcimpáját.","He cut his moustache prickling the girl's earlobe all the time.");
					Item item1415= new Item(s.getKey(),"Karjába kapta a lányt, aki a 'Júliá'-t énekelte.","He held the girl singing 'Júlia'.");
					Item item1416= new Item(s.getKey(),"Piroska észrevette a farkast, amint az a fák közt ólálkodott.","Little Red Riding Hood noticed the wolf lurking in the woods.");
					Item item1417= new Item(s.getKey(),"Minthogy húsz évig élt Olaszországban, tudta hogy kell spagettit fozni.","Having lived in Italy for twenty years, he knew how to cook spaghetti.");
					Item item1418= new Item(s.getKey(),"Minthogy kiválasztott egy pár kesztyut, úgy döntött vesz egy hozzávaló bundát.","Having chosen a pair of gloves she decided to but a matching fur-coat.");
					Item item1419= new Item(s.getKey(),"Miután már tíz éve o volt a legnagyobb sztár, elhatározta, hogy örökre visszavonul.","Having been the greatest star for ten years she decided to retire for good.");
					Item item1420= new Item(s.getKey(),"Miután leszerelt a hadseregtol, elment rendornek.","Having been discharged from the army, he decided to join the police force.");
					Item item1421= new Item(s.getKey(),"Mivel három kituno darabban már látta színpadon, neki szánta filmjének egyik foszerepét.","Having seen her on stage in three excellent plays, he considered her for a leading part in his movie.");
					Item item1422= new Item(s.getKey(),"Megkért, hogy menjek el.","He asked me to leave.");
					Item item1423= new Item(s.getKey(),"Felment a padlásra, s nem is nézett énrám.","She went up to the loft without even glancing at me.");
					Item item1424= new Item(s.getKey(),"Miután kiitta a sörét, elbúcsúzott.","Having drained his beer glass, he said goodbye.");
					Item item1425= new Item(s.getKey(),"Záróra!","Closing time!");
					Item item1426= new Item(s.getKey(),"Bejött a szobába, és mikor meglátott, rájött a csuklás.","She came into the room and seeing me started hiccuping.");
					Item item1427= new Item(s.getKey(),"Az istállóban tárolt széna és gabona illatától nagyon jól érezte magát.","The smell of the hay and grain stored in the barn filled him with a sense of well-being.");
					Item item1428= new Item(s.getKey(),"Sose csináltam még szakállassal.","I've never done it with a bearded guy.");
					Item item1429= new Item(s.getKey(),"Csak ez a takaró van, amire fekhetünk.","I've got just blanket to lie on.");
					Item item1430= new Item(s.getKey(),"A lány holmija mellé tette a cipojét, amibe betuszkolta a zokniját, és a harisnyagumiját.","He placed his shoes stuffed with socks and garter next to her things.");
					Item item1431= new Item(s.getKey(),"Suttogott, ahogy feküdt mellett.","She whispered lying beside him.");
					Item item1432= new Item(s.getKey(),"Nagyon örült, hogy megtalálta a nadrágját.","He was overjoyed to find his pants.");
					Item item1433= new Item(s.getKey(),"Ezt kapom azért, amiért téged szedtelek fel, ahelyett hogy megvártam volna azt, amelyiknek van vér a pucájában.","It's what I get for picking you instead of waiting for the one with guts.");
					Item item1434= new Item(s.getKey(),"Befagy a hátsó felem.","My ass is frozen.");
					Item item1435= new Item(s.getKey(),"Aztán továbbmentek, egy szó nélkül.","Then they went on, neither speaking.");
					...
					Item item1438= new Item(s.getKey(),"Meglepetten látta, hogy teljesen üres az utca.","He was surprised to see that the street was completely deserted.");
					Item item1439= new Item(s.getKey(),"Rá se rántott, hogy megálljon a pirosnál.","He didn't bother to stop at the reed light.");
					...
					Item item1442= new Item(s.getKey(),"Az ablakon beszurodo holdvilág fényében látta meg ot.","By the moonlight straining through the window he saw her.");
					Item item1443= new Item(s.getKey(),"Hangja halk és visszafogott volt.","His voice was low and impressed.");
					Item item1444= new Item(s.getKey(),"Az a szerencsénk, hogy beszéltél vele.","We got lucky with you talking to her.");
					Item item1445= new Item(s.getKey(),"Úgy döntött, hogy a saját feje után megy.","He decided to use his own judgement.");
					Item item1446= new Item(s.getKey(),"Érezte, ahogy egyre jobban feszíti belülrol a düh.","He felt a furious anger rising in him.");
					Item item1447= new Item(s.getKey(),"Nincs itt ma este senki, aki vigyázhatna a kicsire.","There is no one here tonight to look after the nipper.");
					Item item1448= new Item(s.getKey(),"A házból lépcsok vezettek az utcára.","The house had steps leading down into the street.");
					Item item1449= new Item(s.getKey(),"Az életemet mentetted meg azzal, hogy észrevetted a skorpiót.","You saved my life by spotting the scorpion.");
					Item item1450= new Item(s.getKey(),"Egy kocsi dübörgött végig az utcán.","A car came roaring down the street.");
					Item item1451= new Item(s.getKey(),"Te aztán jól elijesztetted a festoket, akiket festeni küldtek!","You scared off the painters sent to paint the flat.");
					Item item1452= new Item(s.getKey(),"Még vagy tíz percig maradtak a szobában és közben dohányoztak.","They stayed in the room smoking for another ten minutes.");
					Item item1453= new Item(s.getKey(),"A Józsi mellett álló lány így szólt…","The girl standing beside Joe said…");
					Item item1454= new Item(s.getKey(),"Érezte, hogy az oldalához szorítják a karját.","He felt his arms pinned to his sides.");
					Item item1455= new Item(s.getKey(),"Alig tudott beszélni.","He had trouble talking.");
					Item item1456= new Item(s.getKey(),"Két csodás órát töltöttek a lány heverojén fekve, miközben egy filmet néztek.","They spent two brillo hours lying on her bed watching a film.");
					Item item1457= new Item(s.getKey(),"Jót fog tenni neked, ha vegyülsz egy kicsit a munkásosztállyal.","It'll do you good to mingle with the proletariat.");
					Item item1458= new Item(s.getKey(),"Az ember hajlamos elfeledkezni a kötelességeirol.","One tends to forget one has obligations to meet.");
					Item item1459= new Item(s.getKey(),"A kínos helyzetet feloldandó, felhívta a nénikéjét.","To create a diversion she telephoned her aunt.");
					Item item1460= new Item(s.getKey(),"Körülnézve láttam, hogy jónéhányan táncolnak.","Looking around I could see quite a few people dancing.");
					Item item1461= new Item(s.getKey(),"Nem volt hajlanó felpróbálni azt az ízléstelen pulóvert.","She refused to try the tasteless pullover on.");
					Item item1462= new Item(s.getKey(),"Úgy vásárolt összevissza, mint egy tébolyult.","She went mad buying clothes.");
					Item item1463= new Item(s.getKey(),"Van valami ötleted, hogy hogyan lehet gyorsan egymilliót szerezni?","Can you think of a way to make a million in a hurry?");
					Item item1464= new Item(s.getKey(),"Tiszta ideg, ha arra gondol, hogy szabadságra kell mennie.","He is getting neurotic about going on holiday.");
					Item item1465= new Item(s.getKey(),"Szenvedett, ha arra gondolt, hogy két hetet kell eltöltenie nélküle.","He was in anguish at the prospect of being without her for two weeks.");
					Item item1466= new Item(s.getKey(),"A lépcson álltak és órákon át csengettek.","They stood on the steps ringing the bell for ages.");
					Item item1467= new Item(s.getKey(),"Lepusztult egy fazon volt.","He was a miserable-looking bloke.");
					Item item1468= new Item(s.getKey(),"Láttad, ahogy ott korzózott és dobozból szürcsölte a sört?","Did you see him walking along the promenade swigging out of a can of lager?");
					Item item1469= new Item(s.getKey(),"Még 339 mondat.","Another 339 sentences to go.");
					Item item1470= new Item(s.getKey(),"A BKV úgy ünnepelt, hogy minden dolgozójának adott egy ingyen buszjegyet.","BPTC celebrated by giving every worker an extra bus ticket.");
					Item item1471= new Item(s.getKey(),"A kutyák a kocsma elott álltak, és a gazdájukat várták.","The dogs stood outside the bar waiting for their masters.");
					...
					Item item1475= new Item(s.getKey(),"Micsoda megaláztatás, hogy nyalókát kaptam a születésnapomra!","The humiliation of being given a lollipop for my birthday.");
					Item item1476= new Item(s.getKey(),"Nem tudtam mit mondani, így hát csöndben maradtam.","I couldn't think of anything to say so I kept quiet.");
					Item item1477= new Item(s.getKey(),"Örülnél, ha megszabadulhatnál tolem, mi?","You would be glad to get rid of me, wouldn't you?");
					Item item1478= new Item(s.getKey(),"Beszélt, és közben fel se nézett az újságból:","He spoke without looking up from his paper.");
					Item item1479= new Item(s.getKey(),"És ha azt mondanám, hogy ez nekem nagyon sokat jelent?","Supposing I said it meant a whole lot to me.");
					Item item1480= new Item(s.getKey(),"Miközben beszélt, a szonyeg szélét rugdosta.","He talked kicking at the edge of the rug.");
					Item item1481= new Item(s.getKey(),"Abbahagynád ezt a témát?","Will you quit harping on that subject?");
					Item item1482= new Item(s.getKey(),"-Figyelj! - mondta, és felugrott.","'Listen', he said leaping to his feet.");
					Item item1483= new Item(s.getKey(),"Akár az igazat is megmondhatnád, ahelyett, hogy itt köntörfalazol.","You might as well tell me the truth instead of beating about the bush.");
					Item item1484= new Item(s.getKey(),"Mindent elrontasz azzal, hogy így állsz hozzá.","You spoil everything by taking that attitude.");
					Item item1485= new Item(s.getKey(),"Oly nagy rössel civakodtak és szidták egymást, hogy elfelejtették lemondani a meghívást. ","They were so busy quarreling and calling each other names that they forgot to cancel the invitation.");
					Item item1486= new Item(s.getKey(),"Nézd már, hogy teszi magát; enyhén szétnyílt ajkak, verdeso szempilák, aztán tágra nyílt szempár, idonként meg a karjára teszi a kezét.","Look what an act she is putting on; parted lips, eyelashes fluttering, and then her eyes opening wide and now and then a hand laid on his sleeve.");
					Item item1487= new Item(s.getKey(),"Nos, miután Józsi olyan volt amilyen, a lány nem tiltakozott a leosztás ellen. ","Well, Joe being what he was, she didn't object to the share out.");
					Item item1488= new Item(s.getKey(),"Azt vártam, hogy bejelentik a lány és Józsi eljegyzését.","I expected to see her engagement to Joe announced.");
					Item item1489= new Item(s.getKey(),"Nem volt senki, aki a számlát fizette volna.","There was no one else to pay the bill.");
					Item item1490= new Item(s.getKey(),"Muszáj volt egy-két célzást ejtenem róla.","I couldn't help dropping a hint or two about him.");
					Item item1491= new Item(s.getKey(),"Felesége is volt valahol titokban.","He had a wife tucked away somewhere.");
					Item item1492= new Item(s.getKey(),"Gondoltam kitesz magáért.","I expected her to do herself well.");
					Item item1493= new Item(s.getKey(),"Ismertem azt a szokást, hogy úgy rendel ételt, hogy az étlapon lévo legdrágább fogást választja, akár szereti, akár nem.","I knew her habit of choosing a dinner by picking the highest prices on the menu, whether she liked the dish or not.");
					Item item1494= new Item(s.getKey(),"Kénytelen vagyok azt mondani, hogy nem sajnállak.","I'm bound to say I don't feel sorry for you.");
					Item item1495= new Item(s.getKey(),"Javára legyen mondva, soha nem titkolta, hogy pénzsóvár.","To do her justice she never concealed she was a mercenary.");
					Item item1496= new Item(s.getKey(),"Olyan fiatal, és olyan jó ránézni.","She is so young and easy to look at.");
					Item item1497= new Item(s.getKey(),"Ha egy lány hajnali kettokor egy taxiban huzakodik, biztos lehet benne, hogy igazi úrihölgy.","Fighting your way home in a taxi at two o'clock in the morning may help you to reassure that you're still a lady.");
					Item item1498= new Item(s.getKey(),"Mindenkivel lekezelo volt, még velem is.","She patronized everyone including me.");
					Item item1499= new Item(s.getKey(),"Ezeknek a muanyag zacskóknak csak ki kéne bírni, hogy ne szakadjanak ki, ha az ember 800 méteren át cipeli oket.","These carrier bags ought to stand up to being dragged half a mile without splitting.");
					Item item1500= new Item(s.getKey(),"Egész este kenyértésztát dagasztottam.","I spent all evening bashing dough about.");
					...
					Item item1503= new Item(s.getKey(),"Nem lehet végigmenni az utcán anélkül, hogy bele ne ütköznél seftesekbe, akik Symphoniát árulnak.","You can't walk down the street without bumping into wheeler dealers selling Symphonia cigarettes.");
					Item item1504= new Item(s.getKey(),"Eltökélt szándéka, hogy beáll rendornek.","It is his ambition to join the police force.");
					Item item1505= new Item(s.getKey(),"Régi filmekben láttam, hogy így csinálják.","I've seen it done in old films.");
					...
					Item item1508= new Item(s.getKey(),"Miközben aludt, felkelt. (Holdkóros.)","While sleeping he got up. (He is a sleepwalker.)");
					Item item1509= new Item(s.getKey(),"Értékes információt adott.","He gave me a valuable piece of information.");
					...
					Item item1517= new Item(s.getKey(),"A hírközlo szervek szerint a rendorség négy libát köröz.","According to the media the police want four geese.");
					Item item1518= new Item(s.getKey(),"Sok férfi van sok bútorban, de egy bútorban csak egy férfi van.","There are a lot of men in a lot of furniture, but in one piece of furniture there's only one man.");
					Item item1519= new Item(s.getKey(),"Nézd azt az intelligens tekintetet a birkák, a szarvasmarhák és az ökrök szemében.","Look at the intelligent eyes of those sheep, cattle, and oxen.");
					Item item1520= new Item(s.getKey(),"Sok kárt okozot már a selejt.","A lot of damage has been caused by imperfect quality.");
					Item item1521= new Item(s.getKey(),"Van néhány hírem; tulajdonképpen két hírem van.","I've got some news; actually I've got two pieces of news.");
					Item item1522= new Item(s.getKey(),"Mi újság?","What is the news?");
					Item item1523= new Item(s.getKey(),"Küldje el adatait a társkereso ügynökséghez.","Send your personal data to the matchmaking agency.");
					Item item1524= new Item(s.getKey(),"Kések és feleségek egyaránt jól meg tudnak vágni.","Knives and wives can be equally sharp.");
					...
					Item item1535= new Item(s.getKey(),"Valamilyen könyvben már olvastam ezt a történetet.","I’ve read that story in some book.");
					...
					Item item1542= new Item(s.getKey(),"Nincs cigaretta az asztalon.","There aren’t any cigarettes on the table.");
					Item item1543= new Item(s.getKey(),"Nincs pénzem.","I ain’t got any money. (slang)");
					Item item1544= new Item(s.getKey(),"Nem hiszem, hogy van tej a kancsóban.","I don’t think there is any milk in the jug.");
					...
					Item item1557= new Item(s.getKey(),"Vannak néhányan, akik nem szeretik a bablevest.","There are some who don't like bean soup.");
					...
					Item item1561= new Item(s.getKey(),"Van aki tud, van aki nem. Ez már csak így van.","Some can, some can't. That's how it is.");
					...
					Item item1564= new Item(s.getKey(),"Van otthon valaki? - Senki. - De valaki csak mondta azt, hogy senki!","Is there anybody at home? - Nobody. - But somebody must have said nobody!");
					...
					Item item1568= new Item(s.getKey(),"Minden évben sokat költenek sörre.","Lots of money is spent on beer every year.");
					...
					Item item1575= new Item(s.getKey(),"A fia nem okozott sok gondot neki.","His son didn’t give him much trouble.");
					...
					Item item1579= new Item(s.getKey(),"Túl sok ember áll a tuz elott.","There are too many people standing in front of the fire.");
					...
					Item item1589= new Item(s.getKey(),"Sok gyereket kiszolgált már ez a bölcso.","This cradle has been used by a lot of children.");
					Item item1590= new Item(s.getKey(),"Sok bába közt elvész a gyerek.","Too many cooks spoil the broth.");
					Item item1591= new Item(s.getKey(),"Sok az eszkimó és kevés a fóka.","There are too many Eskimos and too few seals.");
					...
					Item item1594= new Item(s.getKey(),"Néhány bab meg egy kis leves van a tányérjában.","There are a few beans and there's a little soup in his plate.");
					Item item1595= new Item(s.getKey(),"Az összes pénzem eltunt.","All my money was gone.");
					Item item1596= new Item(s.getKey(),"Az összes ember énekelt az utcán.","All the people in the street were chanting.");
					...
					Item item1600= new Item(s.getKey(),"A gyár összes dolgozója egyesüljön.","All the workers of the factory should unite.");
					Item item1601= new Item(s.getKey(),"A világ minden dolgozója egyesüljön.","All workers should unite.");
					Item item1602= new Item(s.getKey(),"Az összes gyerek az osztályban szereti a csokoládét.","All the children in the class like chocolate.");
					Item item1603= new Item(s.getKey(),"Az összes létezo gyerek szereti a csokoládét.","All children like chocolate.");
					...
					Item item1606= new Item(s.getKey(),"Kinek dollár, kinek gulden, de mindenkinek Nederlanden.","Some need dollar some need gulden but all of us need Nederlanden (that’s an ad)");
					...
					Item item1610= new Item(s.getKey(),"Az egész délután két kétpupú teve társaságában töltöttem.","I spent all the afternoon in the company of two camels.");
					Item item1611= new Item(s.getKey(),"Most, hogy kint vagyok, a szabadság minden egyes napját élvezem.","Now that I’m out of prison, I enjoy each day of my freedom.");
					...
					Item item1614= new Item(s.getKey(),"Minden egyes macskával külön beszéltem.","I spoke to each cat separately.");
					Item item1615= new Item(s.getKey(),"A vén fomacska minden piaci napon a napon üldögél. ","Old Deutoronomy sits in the sun every market day.");
					...
					Item item1618= new Item(s.getKey(),"Mindegyik gyerekem más-más iskolába jár.","Each of my children goes to a different school.");
					...
					Item item1628= new Item(s.getKey(),"Nagy házak vannak az útnak ezen az oldalán is, meg azon is.","There are big houses on either side of the road.");
					Item item1629= new Item(s.getKey(),"Ez az út, meg az is Rómába vezet.","Either road will take you to Rome.");
					Item item1630= new Item(s.getKey(),"Választhatod ezt a csokrot, vagy azt is. (Virágcsokrot természetesen.)","You can choose either bunch.");
					Item item1631= new Item(s.getKey(),"Ez a regény is tetszett, meg az is?","Did you like either of the novels?");
					Item item1632= new Item(s.getKey(),"Nem láttam sem ezt a filmet, sem azt.","I did not see either film.");
					Item item1633= new Item(s.getKey(),"Nem láttam sem ezt a filmet, sem azt.","I did not see either of the films.");
					...
					Item item1641= new Item(s.getKey(),"Mindenki más meg tudta volna csinálni.","Everybody else could have done it.");
					Item item1642= new Item(s.getKey(),"Mindkét szüloje imádja.","Both of his parents love him.");
					Item item1643= new Item(s.getKey(),"Mind az apja, mind az anyja elismerte, hogy igaza volt.","Both his father and mother admitted he was right.");
					...
					Item item1660= new Item(s.getKey(),"Mari néni férje sógorának pipájának karimája.","The brim of the pipe of the brother-in-law of Aunt Mary’s husband.");
					...
					Item item1676= new Item(s.getKey(),"De hisz nem olyan szép, mint gondolod.","But she is not so pretty as you think.");
					Item item1677= new Item(s.getKey(),"De hiszen ez a meccs nem olyan jó, mint vártam.","But this match is not so good as I expected.");
					Item item1678= new Item(s.getKey(),"Domborúbb vagy, mint Bo Derek.","You have a more beautiful figure than Bo Derek.");
					Item item1679= new Item(s.getKey(),"Az én kocsim jobb, mint bárki másé.","My car is better than any other car.");
					Item item1680= new Item(s.getKey(),"A hangod mélyebb, mint Amandáé.","Your voice is deeper than Amanda’s.");
					Item item1681= new Item(s.getKey(),"Ez a disco nem jobb, mint a Csillagfény.","This disco is not better than Starlight.");
					...
					Item item1684= new Item(s.getKey(),"De a te házadban több a csótány, mint az enyémben.","But there are more cockroaches in your house than in mine.");
					Item item1685= new Item(s.getKey(),"Ez a legjobb pop zenekar, amit valaha hallottam.","That’s the best pop group I have ever heard.");
					Item item1686= new Item(s.getKey(),"Te vagy a legszebb lány, akivel valaha találkoztam.","You are the most beautiful girl I have ever met.");
					Item item1687= new Item(s.getKey(),"A legszebb virágot adtam neked, amit csak kapni lehetett.","I gave you the nicest flowers I could buy.");
					Item item1688= new Item(s.getKey(),"Gus a macskatársadalom legokosabb tagja.","Gus is the cleverest cat in the cat society.");
					Item item1689= new Item(s.getKey(),"Te vagy a világ leglustább kölyke.","You are the laziest boy in the world.");
					...
					Item item1692= new Item(s.getKey(),"Ez a legrosszabb bableves, amit valaha ettem.","This is the worst bean soup I've ever eaten.");
					Item item1693= new Item(s.getKey(),"Te betegebb vagy, mint tegnap.","Now you are worse than you were yesterday.");
					Item item1694= new Item(s.getKey(),"Te vagy a legszebb lány a traktorgyárban.","You're the prettiest girl in the tractor factory.");
					...
					Item item1700= new Item(s.getKey(),"Az arany (általában az arany) értékes fém.","Gold is a valuable kind of metal.");
					...
					Item item1704= new Item(s.getKey(),"Nem olyan ember, aki cserbenhagyja a barátait.","He is not a man to desert his friends.");
					Item item1705= new Item(s.getKey(),"Olyan úton mentek, mely hegyek között kanyarog.","They walked along a road winding among rolling hills.");
					Item item1706= new Item(s.getKey(),"Olyan kérdést tett föl, amire nem tudtam válaszolni.","He asked me a question which I could not answer.");
					...
					Item item1713= new Item(s.getKey(),"Tehetséges táncos és énekes.","She is a talented singer and a ballet dancer.");
					...
					Item item1721= new Item(s.getKey(),"Reggel fölébredtem, és láttam, hogy a világ a feje tetejére állt.","I woke up in the morning and found the world turned upside down.");
					Item item1722= new Item(s.getKey(),"Délután egészen más volt a világ.","The world looked so different in the afternoon.");
					Item item1723= new Item(s.getKey(),"Esténként fekszik az ágyban és a szökésre gondol.","In the evening he always lies in bed thinking of escaping.");
					...
					Item item1726= new Item(s.getKey(),"Délben a harangok Hunyadi János emlékét idézik.","At noon the bells ring in the memory of Hunyadi János.");
					Item item1727= new Item(s.getKey(),"Éjfélkor hang sem hallik a járda felol.","At midnight there are no sounds from the pavement.");
					Item item1728= new Item(s.getKey(),"Napnyugtakor vörösbe borul a táj.","At sunset the land turns into red.");
					Item item1729= new Item(s.getKey(),"Az ipar gyorsan fejlodik a múlt század óta.","Industry has been developing rapidly since the last century.");
					Item item1730= new Item(s.getKey(),"Magyarország ipara fejlodik.","The industry of Hungary is developing.");
					Item item1731= new Item(s.getKey(),"A fegyverkezés pont olyan veszélyes a világ számára, mint régen a pestis volt.","Armament is as dangerous to the world nowadays as Black Death was some decades ago.");
					Item item1732= new Item(s.getKey(),"Az infláció mindig ciklikus periódusokban jelenik meg.","Inflation always turns up in cyclical periods.");
					Item item1733= new Item(s.getKey(),"A 30-as évek inflációja alapveto oka volt a második világháború kitörésének.","The inflation of the 30s was a basic reason for World War II.");
					Item item1734= new Item(s.getKey(),"Bábszínház az élet.","Life is a world of puppets.");
					Item item1735= new Item(s.getKey(),"Egy rendor élete teli van kalandokkal.","The life of a policeman is full of adventures.");
					Item item1736= new Item(s.getKey(),"A szerelem nehéz ügy.","Love is problematic.");
					Item item1737= new Item(s.getKey(),"A fiú szerelme keseru csalódásba fordult.","The love of the boy turned into bitter disappointment.");
					Item item1738= new Item(s.getKey(),"A gyerekek iskolában vannak.","The pupils are at school.");
					Item item1739= new Item(s.getKey(),"Csótányok masíroznak az iskola épületében.","There are cockroaches marching in the school.");
					...
					Item item1742= new Item(s.getKey(),"Minden vasárnap templomba megyek.","I always go to church on Sunday mornings.");
					Item item1743= new Item(s.getKey(),"A templom (mint épület) a múlt században épült.","The church was built in the last century.");
					Item item1744= new Item(s.getKey(),"Nagyon rossz volt a kórházban?","Was it very bad in hospital?");
					Item item1745= new Item(s.getKey(),"Tizenhárom éve festik a kórházat (mint épületet).","The hospital has been painted for 13 years.");
					Item item1746= new Item(s.getKey(),"Az elefánt nagyon sokáig él.","An elephant can live for a very long time.");
					...
					Item item1751= new Item(s.getKey(),"Olyan mesét mondott, amit senki nem hitt el.","He told us a story that nobody believed.");
					Item item1752= new Item(s.getKey(),"Nem szeret focizni, de imád zongorázni.","He doesn't like to play football but he loves playing the piano.");
					...
					Item item1756= new Item(s.getKey(),"Bárcsak ne úgy viselkednél mint egy idegen. (de úgy viselkedsz)","If only you didn’t behave like a stranger.");
					Item item1757= new Item(s.getKey(),"Bárcsak ne lennél olyan boldogtalan. (de az vagy)","I wish you weren’t so unhappy.");
					Item item1758= new Item(s.getKey(),"Bárcsak írnál már. (Tudom, hogy fogsz írni, csak siettetni akarom.)","I wish you would write me a letter.");
					...
					Item item1761= new Item(s.getKey(),"Bárcsak mindent megtettem volna azért, hogy boldog légy.","If only I had done my best to make you happy.");
					Item item1762= new Item(s.getKey(),"Bárcsak ne ivott vona annyit tegnap este.","I wish he hadn’t drunk so much last night.");
					Item item1763= new Item(s.getKey(),"Bárcsak el tudnál jönni meglátogatni.","I wish you could come to see me.");
					...
					Item item1773= new Item(s.getKey(),"Bárcsak fiatalabb volnék húsz évvel.","I wish I was twenty years younger.");
					Item item1774= new Item(s.getKey(),"Mindig korán kelt, és reggeli elott sétált egyet.","He would rise early and take a walk before breakfast.");
					Item item1775= new Item(s.getKey(),"A férjem valaha minden szombat este discoba vitt.","My husband used to take me to the disco every Saturday evening.");
					Item item1776= new Item(s.getKey(),"Ebbe az iskolába jártam.","I used to go to this school.");
					Item item1777= new Item(s.getKey(),"Gyerekkorában gyakran mászott fára.","When he was a child he would climb up trees.");
					...
					Item item1780= new Item(s.getKey(),"Valaha 20 cigarettát szívott naponta.","He used to smoke twenty cigarettes a day.");
					...
					Item item1794= new Item(s.getKey(),"Van valami a sarokban, nem?","There is something in the corner, isn’t there?");
					Item item1795= new Item(s.getKey(),"Belépünk a korlátlan lehetoségek korába, nem?","We will enter in the era of infinite possibilities, won’t we?");
					Item item1796= new Item(s.getKey(),"Judynak nem kéne így viselkednie, nem?","Judy shouldn’t behave like that, should she?");
					...
					Item item1810= new Item(s.getKey(),"Nem szereti a könnyfakasztó sztorikat, ugye?","She doesn’t like tearjerkers, does she?");
					Item item1811= new Item(s.getKey(),"Nem vagy vastag, mi?","You ain’t loaded, are you?");
					Item item1812= new Item(s.getKey(),"Oly sok a gonoszság a földön, nem?","There is so much wickedness on earth, isn’t there?");
					Item item1813= new Item(s.getKey(),"Most már fejezd be, O.K.?","Finish it, will you?");
					Item item1814= new Item(s.getKey(),"Ugye megmondtam, hogy ne vidd be a szobába!","I've told you not take it into the room, haven't I?");
					...
					Item item1825= new Item(s.getKey(),"Nem vettél ki pénzt a fiókomból, ugye?","You didn't take money out of my drawer, did you?");
					...
					Item item1839= new Item(s.getKey(),"Te most inkább ne figyelj ide, jó?","I'd rather you didn't listen now, will you?");
					Item item1840= new Item(s.getKey(),"Inkább focizna.","How would rather play football.");
					Item item1841= new Item(s.getKey(),"Szórakozz inkább a nénikéddel, jó?","I'd rather you fooled with your auntie, will you?");
					Item item1842= new Item(s.getKey(),"Úgy néz ki, hogy mindjárt esik.","It looks as if it’s going to rain.");
					Item item1843= new Item(s.getKey(),"Úgy néz ki, hogy hamarosan abbahagyja a munkát.","It looks as if he’s going to give up his job.");
					Item item1844= new Item(s.getKey(),"Úgy néz ki, hogy mindjárt rosszul lesz.","It looks as if he’s going to be sick.");
					Item item1845= new Item(s.getKey(),"Úgy néz ki, hogy o a legszebb lány a partin.","She looks as if she is the most beautiful girl at the party.");
					Item item1846= new Item(s.getKey(),"Úgy tunik, hogy az autó nekiment egy fának (mert most össze van törve - ezért present perfect).","It looks as if the car has hit a tree.");
					Item item1847= new Item(s.getKey(),"Úgy tunik, hogy a tolvajok az ablakon át jöttek be.","It looks as if the thieves got in through the window.");
					Item item1848= new Item(s.getKey(),"Olyan volt, mintha a világ a feje tetejére állt volna.","It was as though the world had turned upside down.");
					Item item1849= new Item(s.getKey(),"Úgy nézel ki, mintha már napok óta nem ettél volna.","You look as if you hadn’t eaten for days.");
					Item item1850= new Item(s.getKey(),"Úgy beszél, mintha megfenyegették volna.","He speaks as if he had been threatened.");
					Item item1851= new Item(s.getKey(),"Úgy látszik mindjárt kiderül (az ég)!","It looks as if it's going to clear up.");
					Item item1852= new Item(s.getKey(),"Úgy látszik mindjárt balra fordul.","He looks as if he's going to turn left.");
					Item item1853= new Item(s.getKey(),"Úgy látszik az ablakon át jött be.","It looks as if he got in through the window.");
					Item item1854= new Item(s.getKey(),"Olyan mintha citromba harapott volna.","It looks as if he's swallowed a lemon.");
					Item item1855= new Item(s.getKey(),"Olyan vagy, mint aki kísértetet látott.","You look as if you've seen a ghost.");
					Item item1856= new Item(s.getKey(),"Úgy látszik bal lábbal kelt föl.","He looks as if he got out of bed the wrong side.");
					Item item1857= new Item(s.getKey(),"Úgy látszik kezd bedilizni.","She looks as if she's cracking up.");
					Item item1858= new Item(s.getKey(),"Olyan volt, mintha földbe gyökerezett volna a lábam.","It was as though my legs were stuck to the floor.");
					Item item1859= new Item(s.getKey(),"Úgy fölugrott, mintha a darázs csípte volna. ","He jumped up as though he had been stung by a wasp.");
					Item item1860= new Item(s.getKey(),"Úgy beszél, mintha o lenne a legjobb horgász.","He talks as if he was the best fisherman.");
					Item item1861= new Item(s.getKey(),"Úgy fut, mintha az életéért futna.","He runs as if he was running for his life.");
					Item item1862= new Item(s.getKey(),"Olyan volt, mintha a világ a feje tetejére állt volna.","It was as if the world had turned upside down.");
					Item item1863= new Item(s.getKey(),"Olyan volt, mintha a mennyben járnék.","I felt as though I was in heaven.");
					Item item1864= new Item(s.getKey(),"Úgy néz ki, mint aki már napok óta nem evett.","He looks as if he hasn't eaten for days.");
					Item item1865= new Item(s.getKey(),"Olyan volt, mintha egy fekete függönyt húztak volna közénk.","It was as though a black curtain had been drawn between them and me.");
					Item item1866= new Item(s.getKey(),"Mit gondolsz, mikor beszélhetek veled?","When do you think I can talk to you?");
					Item item1867= new Item(s.getKey(),"Mit gondolsz, mi ez?","What do you think this is?");
					Item item1868= new Item(s.getKey(),"Mit gondolsz, hogy van az anyósom?","How do you think my mother-in-law is?");
					Item item1869= new Item(s.getKey(),"Mit mondtál, hova dugta a whiskymet?","Where did you say she hid my whisky?");
					...
					Item item1872= new Item(s.getKey(),"Azt gondolod, hogy én Róbert bácsi vagyok?","Do you think I am Róbert bácsi?");
					Item item1873= new Item(s.getKey(),"Mit gondolsz, mi mozog a zöldleveles bokorban?","What do you think is moving in the bush with green leaves?");
					Item item1874= new Item(s.getKey(),"Szerinted róka?","Do you think it's a fox?");
					Item item1875= new Item(s.getKey(),"Mit mondtál, melyik nap érkezik?","Which day did you say he was going to arrive?");
					...
					Item item1878= new Item(s.getKey(),"Mit gondolsz, van benne kolbász?","Do you think there is any sausage in it?");
					Item item1879= new Item(s.getKey(),"Mit gondolsz, ki vagy?","Who do you think you are?");
					Item item1880= new Item(s.getKey(),"Szerinted mikor no már be a feje lágya?","When do you think he'll grow up?");
					Item item1881= new Item(s.getKey(),"Mit gondolsz, hány óra?","What time do you think it is?");
					Item item1882= new Item(s.getKey(),"Mit mondtál, mit mondott, mit gondol, mi van rajta?","What did you say she said she thought she was wearing?");
					...
					Item item1885= new Item(s.getKey(),"Azt hiszem nem tetszik nekem ez a hely.","I don’t think I like this place.");
					...
					Item item1892= new Item(s.getKey(),"Én nem hiszem, hogy normális vagyok.","I don't think I'm in my right mind.");
					...
					Item item1898= new Item(s.getKey(),"Azt hiszem nincs több mondat.","I don't think there are any more sentences.");
					...
					Item item1908= new Item(s.getKey(),"Melyik utcánál forduljak balra?","Which turning shall I take to the left?");
					...
					Item item1918= new Item(s.getKey(),"Azt akarom, hogy menj közelebb, és csólold meg.","I want you to go closer and kiss him.");
					...
					Item item1923= new Item(s.getKey(),"Szeretnék szántani, hat ökröt hajtani.","I'd like to plough and drive six oxen.");
					...
					Item item1933= new Item(s.getKey(),"Legfobb ideje, hogy föladd a levelet.","It’s high time you posted the letter.");
					Item item1934= new Item(s.getKey(),"Itt az ideje, hogy elvedd Judyt.","It’s time you married Judy.");
					Item item1935= new Item(s.getKey(),"Legfobb ideje, hogy leüljünk ebédelni.","It’s high time we sat down to lunch.");
					...
					Item item1938= new Item(s.getKey(),"Ideje, hogy legyen rám egy kis ideje.","It's time you had some time for me.");
					Item item1939= new Item(s.getKey(),"Legfobb ideje, hogy fölöltözz.","It's high time you put on your dress.");
					Item item1940= new Item(s.getKey(),"Ideje hogy újra kihívják a vak zongorahangolót.","It's time the blind piano turner called again.");
					Item item1941= new Item(s.getKey(),"Ideje már, hogy levágasd a hajad!","It's about time you had your hair cut!");
					...
					Item item1944= new Item(s.getKey(),"Van kedved leülni a hideg padlóra?","Do you feel like sitting on the cold floor?");
					Item item1945= new Item(s.getKey(),"Nagy kedve van a pályaudvaron tölteni egy éjszakát.","He feels like spending a night at a station.");
					Item item1946= new Item(s.getKey(),"Tényleg van kedved csavarogni egyet Manhattanben?","Do you really feel like hanging about in Manhattan?");
					...
					Item item1950= new Item(s.getKey(),"Mindig azt tette, amihez kedve volt.","He always did what he felt like doing.");
					...
					Item item1953= new Item(s.getKey(),"A macska szereti a papagájt és a patkányt is.","Cats like parrots and rats, too.");
					Item item1954= new Item(s.getKey(),"A macska szereti a papagájt és a patkány is.","Cats like parrots and so do rats.");
					Item item1955= new Item(s.getKey(),"Táncolni voltam tegnap este és a feleségem is.","I was out to dance last night and so was my wife.");
					...
					Item item1958= new Item(s.getKey(),"A macska nem szereti a papagájt és a patkányt sem.","Cats don’t like parrots and rats, either.");
					Item item1959= new Item(s.getKey(),"A macska nem szereti a papagájt és a patkány sem szereti a papagájt.","Cats don’t like parrots and neither/nor do rats.");
					Item item1960= new Item(s.getKey(),"Nem vette le a csizmáját és a ruháját sem.","She didn’t take off her boots and her dress, either.");
					Item item1961= new Item(s.getKey(),"Nem veheted el azt a not és a barátod sem.","You can’t marry that woman and neither can your friend.");
					Item item1962= new Item(s.getKey(),"A honvéd nem tisztelgett az ormesternek és a tábornoknak sem.","The private didn’t salute to the sergeant and the general, either.");
					Item item1963= new Item(s.getKey(),"Én nem rúgtam ki magát és a fonököm sem.","I didn’t fire you and neither did my boss.");
					Item item1964= new Item(s.getKey(),"Nem látszott fáradtnak és boldogtalannak sem.","He didn’t look worn out and unhappy either.");
					Item item1965= new Item(s.getKey(),"Ua. mint az elozo, de így is lehet képezni.","He didn’t look worn out or unhappy.");
					Item item1966= new Item(s.getKey(),"A cimborám nem reggelizett ágyban és a barátnoje sem.","My buddy didn’t have breakfast in bed and neither did his baby.");
					Item item1967= new Item(s.getKey(),"Tuzoltó leszel, vagy katona.","You will either be a fireman or a soldier.");
					Item item1968= new Item(s.getKey(),"Nem hiszek se magának, se a feleségének.","I don’t believe either you or your wife.");
					Item item1969= new Item(s.getKey(),"Nem hiszek se magának, se a feleségének.","I believe neither you nor your wife.");
					Item item1970= new Item(s.getKey(),"Elveheted ezt is, vagy azt is.","You can take either this or that.");
					Item item1971= new Item(s.getKey(),"Sem o, sem az albérloje nem panaszkodott a körülményekre.","Neither he nor his lodger complained of the circumstances.");
					Item item1972= new Item(s.getKey(),"Nem volt hozzászokva sem a hideghez, sem a ködhöz.","He was accustomed to neither cold nor fog.");
					Item item1973= new Item(s.getKey(),"Nem szeretlek és a kutya sem.","I don't like you and neither does the dog.");
					Item item1974= new Item(s.getKey(),"Icereg a macska, és a hörcsög is.","The cat is fidgeting and so is the hamster.");
					...
					Item item1977= new Item(s.getKey(),"Nem tetszik ez, és nem tetszik az se.","I don't like this, and I don1t like that, either.");
					...
					Item item1981= new Item(s.getKey(),"Nincs rajtam pizsama éa papucs se.","I'm not wearing pyjamas and slippers, either.");
					Item item1982= new Item(s.getKey(),"A nyuszin van sapka és a farkason is. ","The rabbit is wearing a cap and so is the wolf.");
					Item item1983= new Item(s.getKey(),"Remélem elkapják. Én is.","I hope they'll catch him. So do I.");
					Item item1984= new Item(s.getKey(),"Hófehérkének nincs fehér ruhája, és a törpéknek sincs.","Snow White has no whites and neither do the dwarfs.");
					Item item1985= new Item(s.getKey(),"A törpéknek van ágya és Hófehérkének is.","The dwarfs have beds and so does Snow White.");
					Item item1986= new Item(s.getKey(),"A szatyorban volt szalonna és kolbász is, és a hátizsákban is.","The bag contained bacon and sausages, too, and so did the rucksack.");
					Item item1987= new Item(s.getKey(),"Nem találta a helyét és a fejét sem.","She didn't find her place and her head, either.");
					Item item1988= new Item(s.getKey(),"Táncolt a menyasszony és a volegény is.","The bridge was dancing and so was the groom.");
					Item item1989= new Item(s.getKey(),"Csiga-biga palota, ablaka sincs, ajtaja sincs.","Snaily snail castle; it's got neither window, nor door.");
					Item item1990= new Item(s.getKey(),"Nem ehetsz, míg meg nem mostad a kezed.","You may not eat until you have washed your hands.");
					Item item1991= new Item(s.getKey(),"Nem ment be, míg engedélyt nem kapott.","He didn’t go in until he had been given permission.");
					Item item1992= new Item(s.getKey(),"Egy szót sem szólok hozzád, amíg nem adod vissza a pénzem.","I won’t speak to you until you have given me the money you borrowed.");
					Item item1993= new Item(s.getKey(),"Nem értette, míg el nem magyaráztam neki.","He didn’t understand it until I had explained it to him.");
					Item item1994= new Item(s.getKey(),"Semmit nem tudtam róla, míg föl nem hívott.","I didn't know anything about it until he had called.");
					Item item1995= new Item(s.getKey(),"Nem mehetsz be a szobába, amíg le nem vetted a cipodet.","You may not go into the room until you have taken off your shoes.");
					Item item1996= new Item(s.getKey(),"Nem indulunk, amíg Bob meg nem jön.","We won't start until bob has come.");
					Item item1997= new Item(s.getKey(),"Ha lesz pénzem, megadom.","When I have money, I’ll give it back.");
					Item item1998= new Item(s.getKey(),"Ha nagy leszek, meghálálom. ","When I grow up, I’ll return your kindness.");
					Item item1999= new Item(s.getKey(),"Mihelyst beérünk az alagútba, megpróbál majd megölni.","As soon as we get into the tunnel, he will try to kill you.");
					Item item2000= new Item(s.getKey(),"Le kell ülnünk még mielott a lámpák kialszanak.","We will have to take our seats before the lights go out.");
					Item item2001= new Item(s.getKey(),"Pihennünk kell majd miután kocogunk.","We shall need a rest after we’ve been jogging.");
					Item item2002= new Item(s.getKey(),"Nem szabad lonöd, míg meg nem közelítetted a nyuszit.","You mustn’t shoot until you’ve approached the hare.");
					Item item2003= new Item(s.getKey(),"Amikor majd tél lesz elmegyünk szánkózni.","When writer time comes, we'll go sledding.");
					Item item2004= new Item(s.getKey(),"Amikor visszajövök, új életet kezdek.","When I come back, I'm going to start my life all over again.");
					Item item2005= new Item(s.getKey(),"Visszaadom mihelyt megtalálom.","I'll give it back as soon as I find it.");
					Item item2006= new Item(s.getKey(),"Majd bemegyek, ha nem lesz benn az oroszlán.","I'll go in when there's no lion inside.");
					...
					Item item2009= new Item(s.getKey(),"Alig valószínu, hogy megváltozol.","You are hardly likely to change now.");
					Item item2010= new Item(s.getKey(),"Ne játsszatok olyan keményen.","Don’t play so hard.");
					Item item2011= new Item(s.getKey(),"Hozzászoktam, hogy éjszaka dolgozzam.","I’ve got used to working at night.");
					Item item2012= new Item(s.getKey(),"Hozzá van szokva, hogy helikopteren utazzék.","She is used to travelling by helicopter.");
					Item item2013= new Item(s.getKey(),"Valaha hozzá volt szokva, hogy használt kocsit használjon.","He used to be used to using used cars.");
					...
					Item item2016= new Item(s.getKey(),"A lányok régebben rövidebb szoknyát hordtak.","Girls used to wear shorter skirts.");
					Item item2017= new Item(s.getKey(),"Régen mosollyal az arcomon gitároztam.","I used to play my guitar with a smile on my face.");
					Item item2018= new Item(s.getKey(),"Itt valaha vár állott.","There used to be a castle here.");
					Item item2019= new Item(s.getKey(),"A dolgozók régen még kaptak jutalmat november 7-én.","The workers used to get extra money on November 7th.");
					Item item2020= new Item(s.getKey(),"Nem az vagy, aki valaha voltál.","You're not the man you used to be.");
					Item item2021= new Item(s.getKey(),"Amikor még ifjú házasok voltunk, minden nap felhívtál.","When we were just married you used to telephone me every day.");
					Item item2022= new Item(s.getKey(),"Régen azért soványabb voltál.","You used to be thinner.");
					Item item2023= new Item(s.getKey(),"Régen gazember volt, de most barátságos alak.","He used to be a jerk, but now he is a friendly guy.");
					Item item2024= new Item(s.getKey(),"Történtesen (véletlenül) nem találkoztál vele?","Did you happen to meet her?");
					Item item2025= new Item(s.getKey(),"Történetesen ot bámultam, amikor a férje fejbevágott.","I happened to be looking at her when her husband hit me on the head.");
					Item item2026= new Item(s.getKey(),"Úgy alakult, hogy örökölt néhány milliót.","He happened to inherit some million dollars.");
					...
					Item item2037= new Item(s.getKey(),"-Semmi mást nem vacsorázott, csak levest.","He had nothing but soup for dinner.");
					...
					Item item2043= new Item(s.getKey(),"Soha többé nem láthatta a feleségét.","He was never to see his wife again.");
					Item item2044= new Item(s.getKey(),"Az öregember soha többé nem állhatott lábra.","The old man was never to walk again.");
					Item item2045= new Item(s.getKey(),"Hánykor legyek ott?","At what time am I to be there?");
					Item item2046= new Item(s.getKey(),"Egy kis szigeten éljünk, csak te meg én?","Are we to live in a small island?");
					...
					Item item2049= new Item(s.getKey(),"Év végére kellet volna felépíteni az új utat (de már most biztos, hogy nem lesz kész.","Work on the new road was to have been completed by the end of the year.");
					Item item2050= new Item(s.getKey(),"Hatkor kellet volna leszállnia a gépnek, de még mindig München-ben van (most 5 óra van).","His plane was to have landed at six, but it is still in Munich.");
					...
					Item item2053= new Item(s.getKey(),"Úgy volt, hogy pénteken jönnek haza.","They were to come home on Friday.");
					Item item2054= new Item(s.getKey(),"Úgy van, hogy júniusban esküszünk.","We are to be married in June.");
					Item item2055= new Item(s.getKey(),"Másnap kellett volna elmennünk, de megbetegedtem.","We were to have gone away the next day, but I was ill.");
					Item item2056= new Item(s.getKey(),"Az elitélteknek 10-kor ágyban kell lenniük.","All prisoners are to be in bed by 10 o'clock.");
					...
					Item item2063= new Item(s.getKey(),"Néhányan azt gondolják, hogy egy kétszobás lakás elég egy héttagú családnak.","Some think that a two-room flat is enough for a seven membered family.");
					Item item2064= new Item(s.getKey(),"Láttam, amint 16 éves fiúk ragasztót szagolnak.","I saw sixteen-year-old boys sniffing glue.");
					Item item2065= new Item(s.getKey(),"Elso szerelme egy 16 éves, félszemu, háromfülu lány volt.","His first love was a 16-year-old, one-eyed, three-eared girl.");
					Item item2066= new Item(s.getKey(),"A baleset oka gyorshajtás volt.","The reason for the accident was speeding.");
					Item item2067= new Item(s.getKey(),"A tömegkarambol oka a rossz ido volt.","The cause of the pile up was bad weather.");
					Item item2068= new Item(s.getKey(),"A távozásának az oka nem magyarázható.","The reason for his leaving can’t be explained.");
					Item item2069= new Item(s.getKey(),"Azért vagyok itt, mert éhezem.","The reason why I am here is that I’m starving.");
					Item item2070= new Item(s.getKey(),"E könyv megírásának a magyarázata igen egyszeru.","The cause of writing this book is simple.");
					...
					Item item2074= new Item(s.getKey(),"Nem sikerült levágni a füvet azzal a régi funyíróval.","He failed to cut the grass with that old lawn-mower.");
					Item item2075= new Item(s.getKey(),"Végre sikerült kijutnom a megszokott kerékvágásból.","At last I managed to get out of this rut.");
					Item item2076= new Item(s.getKey(),"Sikerült kiszállni a buliból?","Did you succeed in backing out?");
					Item item2077= new Item(s.getKey(),"Már megint nem sikerült kijönnie a fizetésébol.","She failed to make ends meet again.");
					...
					Item item2082= new Item(s.getKey(),"A gazdagoknak sikerült megmenteniük a vagyonukat.","The rich managed to save their wealth.");
					Item item2083= new Item(s.getKey(),"A szegények soha nem tudnak lépést tartani a gazdagokkal.","The poor can never keep up with the rich.");
					Item item2084= new Item(s.getKey(),"Speciális TV musor van a süketnémák számára.","There is a special program on TV for the deaf and the dumb.");
					Item item2085= new Item(s.getKey(),"A magányosok gyakran felidézik gyerekkor emlékeiket.","The lonely often call up their childhood memories.");
					Item item2086= new Item(s.getKey(),"Egyre több és több munkahely létesült mozgássérültek számára.","There are more and more places of work for the disabled.");
					...
					Item item2094= new Item(s.getKey(),"Milyen hülye egy pali az az ormester!","What a stupid guy that sergeant is.");
					...
					Item item2099= new Item(s.getKey(),"Minél több a pénzed, annál boldogabban élsz.","The more money you have the happier you live.");
					Item item2100= new Item(s.getKey(),"Minél hamarább jössz, annál több sütit kapsz.","The sooner you arrive the more cakes you’ll get.");
					Item item2101= new Item(s.getKey(),"Minél kopaszabb vagyok, annál vonzóbb vagyok.","The balder the more attractive I am.");
					Item item2102= new Item(s.getKey(),"Minél hosszabb, annál jobb.","The longer the better.");
					Item item2103= new Item(s.getKey(),"Minél nagyobb Pistike feje, annál több víz megyen bele.","The bigger Pistike's head, the more water goes in.");
					Item item2104= new Item(s.getKey(),"Minél sötétebb van, annál kevésbé látlak.","The darker, the less I can see you.");
					Item item2105= new Item(s.getKey(),"Minél kevésbé látlak, annál jobban tetszel.","The less I can see you, the more I like you.");
					Item item2106= new Item(s.getKey(),"Minél többet beszél, annál kevesebbet mond.","The more he talks, the less he says.");
					Item item2107= new Item(s.getKey(),"Minél vékonyabb a nyaka, annál vékonyabb a dereka.","The thinner her neck, the thinner her waist.");
					Item item2108= new Item(s.getKey(),"Minél zöldebb, annál büdösebb.","The greener, the more stinking.");
					Item item2109= new Item(s.getKey(),"Az, aki szereti az állatokat, nem lehet olyan rossz ember.","The one who likes animals can’t be that bad.");
					Item item2110= new Item(s.getKey(),"Az, akit a sárga irigység emészt, a sógorom.","The person who is green with envy is my brother-inlaw.");
					Item item2111= new Item(s.getKey(),"Aki nem lép egyszerre, nem kap rétest estére. (körülbelül)","He who doesn’t step in line won’t get strudel for supper.");
					Item item2112= new Item(s.getKey(),"Aki hallja, adja át.","The one who can hear it should transmit it.");
					Item item2113= new Item(s.getKey(),"Te voltál az, akiben mindenek fölött megbíztam.","You were the one I trusted above all.");
					Item item2114= new Item(s.getKey(),"Egyre csak mondogatta/hajtogatta…","She kept saying…");
					Item item2115= new Item(s.getKey(),"Állandóan nyaggat a gyerek, hogy vigyem ki a Vidám Parkba.","The child keeps pestering me to take him to the fun fair.");
					...
					Item item2119= new Item(s.getKey(),"Menj addig, míg a lámpához nem érsz.","Keep going till you reach the traffic light.");
					...
					Item item2123= new Item(s.getKey(),"A nagy pénztol a levegobe ugrálok.","Big-big-big money makes me jump for joy.");
					...
					Item item2126= new Item(s.getKey(),"Ha meghallom a saját hangom a rádióban, szívem büszkeséggel telik meg.","The sound of my own voice on the radio makes my heart swell with pride.");
					Item item2127= new Item(s.getKey(),"Mit teszel, ha meglátsz egy csótányt?","What does the sight of a cockroach make you do?");
					Item item2128= new Item(s.getKey(),"Izzadni kezdek, ha meglátok egy miniszoknyás lányt.","The sight of a girl in mini skirt makes me sweat.");
					Item item2129= new Item(s.getKey(),"A harangok hangja gyermekkoromra emlékeztet.","The sound of the bells makes me remember my childhood.");
					Item item2130= new Item(s.getKey(),"Mit teszel, ha meghallod a zongora hangját?","What does the sound of a piano make you do?");
					Item item2131= new Item(s.getKey(),"Azt hiszem, el kéne menned a fogorvoshoz.","I think you ought to go to the dentist.");
					Item item2132= new Item(s.getKey(),"Erosen köhögsz, úgy vélem abba kéne hagynod a dohányzást.","You are getting a smoker's cough, I think you should give up smoking. ");
					Item item2133= new Item(s.getKey(),"Azt javaslom, hogy vegyél hallókészüléket, ha nagyot hallasz.","I suggest that you buy a hearing aid if you are hard of hearing.");
					Item item2134= new Item(s.getKey(),"Jobban tennéd, ha kiküldenéd a gyerekeket.","You'd better send the children out.");
					Item item2135= new Item(s.getKey(),"Azt tanácsolom, hogy pihend ki magad, ha idegösszeroppanásod van.","I advise you to have a complete rest if you have a nervous breakdown.");
					Item item2136= new Item(s.getKey(),"Miért nem kérded meg tole, hogy mi izgatja?","Why don't you ask him what's upsetting him?");
					Item item2137= new Item(s.getKey(),"Miért nem nézed meg a szótárban?","Why not look it up in the dictionary?");
					Item item2138= new Item(s.getKey(),"Mi lenne, ha lekopnál?","How about beating it?");
					Item item2139= new Item(s.getKey(),"Ha rám hallgatsz békén hagyod.","If you take my advice, you'll leave him alone.");
					Item item2140= new Item(s.getKey(),"Ha neked lennék, keresnék magamnak egy barátnot.","If I were you, I'd find a girlfriend.");
					Item item2141= new Item(s.getKey(),"Nem kell mindjárt durváskodni.","There's no need to be rude.");
					Item item2142= new Item(s.getKey(),"Azt javaslom, hogy CASCO-t is kössön.","I recommend you to make a comprehensive policy on your car.");
					Item item2143= new Item(s.getKey(),"Jobb lenne, ha a pénzét bankban tartaná.","It would be better if you kept your money in a bank.");
					Item item2144= new Item(s.getKey(),"Tanácsos lenne, ha abbahagyná az ivást.","It would be advisable for you to give up drinking.");
					Item item2145= new Item(s.getKey(),"Jó lenne, ha fölállnánk és elmennénk.","It would be a good thing if we got up and left.");
					Item item2146= new Item(s.getKey(),"Leszoktam arról, hogy késon keljek.","I've got out of the habit of getting up late.");
					Item item2147= new Item(s.getKey(),"Az a szokásom, hogy kávét iszom reggelire.","I am in the habit of drinking coffee for breakfast.");
					Item item2148= new Item(s.getKey(),"Rászoktam, hogy köszönjek a szomszédomnak.","I've got into the habit of saying 'good morning' to my neighbor.");
					Item item2149= new Item(s.getKey(),"Leszoktam arról, hogy reggelenként fürödjek.","I got out of the habit of having a bath in the morning.");
					Item item2150= new Item(s.getKey(),"Az a szokásom, hogy sört ebédelek.","I am in the habit of drinking beer for lunch.");
					Item item2151= new Item(s.getKey(),"Rászoktam arra, hogy gyorsan vezessek.","I've got into the habit of driving very fast.");
					Item item2152= new Item(s.getKey(),"Nem megy a világítás, mert a villanykörte hiányzik.","The light doesn't work, because the light bulb is missing.");
					Item item2153= new Item(s.getKey(),"A kocsiról hiányzik az egyik lökhárító.","The car has got one of the bumpers missing.");
					Item item2154= new Item(s.getKey(),"A tranzisztorok hiányoznak a zsebrádióból.","The transistors are missing from the pocket radio.");
					Item item2155= new Item(s.getKey(),"Ha hiányoznak a lábai, az asztal nem áll meg.","If the legs are missing, the table won't stand up.");
					Item item2156= new Item(s.getKey(),"Vigyázz, itt hiányzik egy lépcso.","Be careful, there's a stair missing.");
					...
					Item item2165= new Item(s.getKey(),"Nagyon fáj a fejem, rámférne (jól esne) egy kis séta.","I've got such a headache, I could do with a short walk.");
					Item item2166= new Item(s.getKey(),"Rámférne egy fogyókúra, olyn kövér vagyok.","I could do with a slimming course, I am so fat.");
					Item item2167= new Item(s.getKey(),"Jól esne egy zuhany, ragadok a kosztól.","I could do with a shower, I am so sticky.");
					Item item2168= new Item(s.getKey(),"Sajnálom, de elfogyott a cigarettám.","I'm sorry, but I've run out of cigarettes.");
					Item item2169= new Item(s.getKey(),"Momentán abszolute nincs nálam gyufa.","I'm right out of matches.");
					Item item2170= new Item(s.getKey(),"Hamarosan elfogyott az ital a bulin.","We soon ran out of drinks at the party.");
					...
					Item item2174= new Item(s.getKey(),"Kevés volt a hamutartó, így kölcsön kellett kérni.","They were short of ashtrays, so they had to borrow some.");
					Item item2175= new Item(s.getKey(),"A hónap vége felé mindig kevés a pénzem.","At the end of the month I'm always short of money.");
					Item item2176= new Item(s.getKey(),"Azt mondja, nem tud meglenni napi tíz óra alvás nélkül.","He says he can't survive without ten hours' sleep.");
					Item item2177= new Item(s.getKey(),"Nem tudok meglenni nélküled.","I can't do without you.");
					Item item2178= new Item(s.getKey(),"Az ember nem tud meglenni oxigén nélkül.","Humans can't do without oxygen.");
					Item item2179= new Item(s.getKey(),"A virág nem tud meglenni víz nélkül.","Flowers can't do without water.");
					Item item2180= new Item(s.getKey(),"Nem tud meglenni két kocsi nélkül.","She can't survive without two cars.");
					Item item2181= new Item(s.getKey(),"(O) mondta (nekem), hogy találkozunk éjfélkor.","She told me to meet her at midnight.");
					Item item2182= new Item(s.getKey(),"Elmesélte neki élete történetét.","He told her the story of his life.");
					Item item2183= new Item(s.getKey(),"A fiú mondta a lánynak, hogy tartsák meg az eljegyzésüket.","The boy told the girl to plight their troth");
					Item item2184= new Item(s.getKey(),"Ne hazudj!","Don't tell lies.");
					Item item2185= new Item(s.getKey(),"Azt mondta, hogy remek dolog a napon szerelmeskedni.","He said that it was fun to make love in the sun. (Amanda Lear).");
					Item item2186= new Item(s.getKey(),"Azt mondja, hogy nem ér rá.","He says he's busy.");
					Item item2187= new Item(s.getKey(),"Csak azt akarom mondani, hogy ha van rá mód…","I only want to say if there's a way (Superstar).");
					Item item2188= new Item(s.getKey(),"Zseni vagy – mondta Béla Marcinak.","You are a genius, Béla said to Marci.");
					Item item2189= new Item(s.getKey(),"Szép idonk van, nemde? – mondta Juliska.","Nice day, ain't it?, Juliska said.");
					Item item2190= new Item(s.getKey(),"Azt tanácsolom, hogy itt maradj,","I advise you to stay here.");
					Item item2191= new Item(s.getKey(),"Azt javasolta, hogy menjünk el. (Láthatod, hogy a mellékmondat többféleképpen építheto fel.)","She suggested that we go/should go/went.");
					...
					Item item2197= new Item(s.getKey(),"Hogy hívják azt az embert, aki kihúzza a fogadat?","What do you call the person who takes out your tooth?");
					...
					Item item2211= new Item(s.getKey(),"Nagyon jól éreztük magunkat a bulin. ","We had a very good time at the party.");
					Item item2212= new Item(s.getKey(),"A hét végén már jobban fogja érezni magát.","At the end of the week you will feel well.");
					Item item2213= new Item(s.getKey(),"Tegnap érkezett Maggie Budapestre.","Margaret Thatcher arrived in Budapest last night.");
					Item item2214= new Item(s.getKey(),"Végre megérkeztünk az állomásra.","At last we arrived at the station.");
					Item item2215= new Item(s.getKey(),"Egy kedves ifjú pár látható a fényképen.","There is a nice married couple in the photo.");
					Item item2216= new Item(s.getKey(),"Két narancs látható a festményen.","There are two oranges in the picture.");
					...
					Item item2219= new Item(s.getKey(),"Az eloadás végén mind elmentek a kocsmába.","At the end of the play they all went to the pub.");
					Item item2220= new Item(s.getKey(),"Végül senki nem maradt a színpadon.","In the end nobody stayed on the stage.");
					Item item2221= new Item(s.getKey(),"Több órája várok rád.","I have been waiting for you for several hours.");
					Item item2222= new Item(s.getKey(),"Több, mint 3 órája várok rád.","I have been waiting for you for more than 3 hours.");
					...
					Item item2226= new Item(s.getKey(),"Azt mondta, hogy a jövo héten majd meglátogat.","He said he would visit me the next week.");
					Item item2227= new Item(s.getKey(),"Amikor én még kissrác voltam, minden nap fociztam.","When I was a kid I would play football every day.");
					Item item2228= new Item(s.getKey(),"Nem voltam hajlandó megengedni neki, hogy fölszúrja az orromat.","I wouldn't let her prick my nose.");
					Item item2229= new Item(s.getKey(),"Pont olyan vagy, mint az anyósom.","You're just like my mother-in-law.");
					Item item2230= new Item(s.getKey(),"Pont olyan kedves vagy, mint az anyósom.","You're just as nice as my mother-in-law.");
					Item item2231= new Item(s.getKey(),"Úgy dolgozik, mint egy rabszolga (de nem rabszolga).","He works like a slave.");
					...
					Item item2238= new Item(s.getKey(),"Te meg olyan vagy, mint egy gozmozdony.","You're just like a steam engine.");
					Item item2239= new Item(s.getKey(),"Olyan a szemed, mint egy kispárna.","Your eyes are like a little pillow.");
					...
					Item item2243= new Item(s.getKey(),"Elég gazdag ahhoz, hogy megvegye a villát.","He is rich enough to buy the villa.");
					Item item2244= new Item(s.getKey(),"Nem elég okos ahhoz, hogy megértse.","She is not clever enough to understand it.");
					Item item2245= new Item(s.getKey(),"Túl részeg ahhoz, hogy egy szót is kinyögjön.","He is too drunk to speak.");
					Item item2246= new Item(s.getKey(),"Az utca túl sáros ahhoz, hogy Pisti átmenjen a túlsó oldalra.","The street is too muddy for Pisti to cross (it).");
					Item item2247= new Item(s.getKey(),"Túl nagy a szél ahhoz, hogy most vitorlázzunk.","It is too windy for us to sail now.");
					Item item2248= new Item(s.getKey(),"Túl hangos a zene ahhoz, hogy a bébi aludni tudjon.","The music is too loud for the baby to sleep.");
					Item item2249= new Item(s.getKey(),"A vonat nem ment elég lassan ahhoz, hogy fel tudjon ugrani rá.","The train was not slow enough for him to jump on.");
					Item item2250= new Item(s.getKey(),"Túl sok nekem ez a sör ahhoz, hogy megigyam.","That beer is too much for me to drink.");
					Item item2251= new Item(s.getKey(),"A tea túl forró volt ahhoz, hogy a légy világcsúcsot ússzon benne.","The tea was too hot for the fly to beat the world record.");
					...
					Item item2256= new Item(s.getKey(),"Olyan függönyt kell vennem, amelyik megy a fotelhez.","I've got to buy a curtain that matches the armchair.");
					Item item2257= new Item(s.getKey(),"Olyan blúzt vett, amelyik megy a nadrágkosztümjéhez.","She's bought a blouse that goes with her pants-suit.");
					...
					Item item2261= new Item(s.getKey(),"Öreg vagy te már, nem áll jól a láncos dzseki.","You're too old; a chain jacket doesn't suit you.");
					Item item2262= new Item(s.getKey(),"Hu, de jó kis sapka. Hu, és pont jó. Hu de jól áll. Hu, és a sáladhoz is megy.","Hmm, that's a good cap. Hmm, and it fits you. Hmm, and it suits you, too. Hmm, and it goes with your scarf.");
					...
					Item item2268= new Item(s.getKey(),"Meg tudná mondani az utat Denton Cottage felé?","Can you tell me the way to Denton Cottage? (Czobor – Horlai)");
					Item item2269= new Item(s.getKey(),"Az út hosszú volt, az út pedig zsúfolt.","The way was long and the road was busy.");
					...
					Item item2275= new Item(s.getKey(),"Egy pók van a falon. Hu, az egy kaszáspók!","There is a spider on the wall. Hey, it's (a) daddy longlegs.");
					Item item2276= new Item(s.getKey(),"Úttörok állnak a zászló alatt.","There are some pioneers standing under the flag.");
					...
					Item item2280= new Item(s.getKey(),"Két rendor ül egy Zsiguliban.","There are two policemen sitting in a Zsiguli.");
					Item item2281= new Item(s.getKey(),"A rendorök a lányt nézik.","The policemen are looking at the girl.");
					Item item2282= new Item(s.getKey(),"Gumibot van a rendor kezében.","There is a truncheon in the policeman's hand.");
					...
					Item item2285= new Item(s.getKey(),"A macska szereti a romantikus történeteket.","The cat likes romantic stories.");
					Item item2286= new Item(s.getKey(),"Egy bolha egyensúlyozott a macska bajuszán.","There was a flea balancing on the cat's moustache.");
					Item item2287= new Item(s.getKey(),"Fecskék repültek Dél-Afrika felé.","There were swallows flying towards South-Africa.");
					...
					Item item2290= new Item(s.getKey(),"Egy légy csuszkált a kopasz fején.","There was a fly skidding on his bald head.");
					...
					Item item2295= new Item(s.getKey(),"A konyha a fürdoszoba mellett van.","The kitchen is beside the bathroom.");
					Item item2296= new Item(s.getKey(),"Egy csomó fürdoszoba van a házában.","There are a lot of bathrooms in his house.");
					Item item2297= new Item(s.getKey(),"Csak egy ház van az utcában.","There's only one house in the street.");
					Item item2298= new Item(s.getKey(),"Zengo hangú férfikórus énekelte a Bunkócska refrénjét.","There was a sonorous voiced men's chorus singing the refrain of Coshlet.");
					...
					Item item2306= new Item(s.getKey(),"Alig indultunk el, máris defektet kaptunk.","Hardly had we started when the car got a flat tyre.");
					Item item2307= new Item(s.getKey(),"Alig kezdodött a meccs, máris zuhogott.","No sooner had the game begun than it started raining.");
					Item item2308= new Item(s.getKey(),"Alig ültünk le, mikor láttuk, hogy már mennünk is kell.","No sooner had we sat down than we found it was time to go.");
					Item item2309= new Item(s.getKey(),"Alig jött meg, máris mennie kellett.","Hardly had he arrived when he had to leave again.");
					...
					Item item2314= new Item(s.getKey(),"Jobban tetted volna, ha becsukod a szemed.","You'd better have closed your eyes.");
					...
					Item item2324= new Item(s.getKey(),"Senki nem hallotta, hogy elhagyta a házat.","Nobody heard him leave the house.");
					Item item2325= new Item(s.getKey(),"Senki nem hallotta, hogy elhagyta a házat.","Nobody heard him leaving the house.");
					Item item2326= new Item(s.getKey(),"Láttam, hogy ott állank kéz a kézben.","I saw them standing hand in hand.");
					...
					Item item2331= new Item(s.getKey(),"Láttam, hogy kéz a kézben sétálnak a kertben. ","I saw them walking hand in hand in the garden.");
					Item item2332= new Item(s.getKey(),"Hallottam, hogy Juliska énekel a fürdoszobában.","I heard Julia singing in the bathroom.");
					Item item2333= new Item(s.getKey(),"Hallod hogy ugat a Kriszti?","Can you hear Christie bark?");
					Item item2334= new Item(s.getKey(),"Látod azt a kísértetet, amint tetorol tetore ugrál?","Can you see that ghost jumping from rooftop to rooftop?");
					...
					Item item2340= new Item(s.getKey(),"Nem akartam én megenni, épp csak azon voltam, hogy megkóstoljam.","I wasn't going to eat it, I was just about to taste it.");
					Item item2341= new Item(s.getKey(),"Azt mondják, hogy K. gyáva.","K. is said to be a coward.");
					Item item2342= new Item(s.getKey(),"Úgy tunik, K. csatamezot keres. (épp most)","K. seems to be looking for a battlefield.");
					Item item2343= new Item(s.getKey(),"A jelentések szerint K.-nak van egy lova.","K. is reported to have a horse.");
					Item item2344= new Item(s.getKey(),"Úgy vélik, hogy K. ismeri a királyt.","K. is thought to know the king.");
					Item item2345= new Item(s.getKey(),"Azt mondják K.-ról, hogy fiatal korában nagy kujon volt.","K. is said to have been a lady-killer when he was young.");
					Item item2346= new Item(s.getKey(),"Úgy tunik, hogy K. elvesztette a lovát.","K. seems to have lost his horse.");
					Item item2347= new Item(s.getKey(),"A jelentések szerint K. a várba ment.","K. is reported to have left for the castle.");
					Item item2348= new Item(s.getKey(),"Tavaly még úgy tunt, hogy K. ismeri a kapuzáró jelszót.","Last year K. seemed to know the gate locking password.");
					Item item2349= new Item(s.getKey(),"Azt mondták, hogy K. egy gyáva.","K. was said to be a coward.");
					Item item2350= new Item(s.getKey(),"Jelentették, hogy K.-nak van egy lova.","K. was reported to have a horse.");
					Item item2351= new Item(s.getKey(),"Azt mondták, hogy K. elvesztette a lovát.","K. was said to have lost his horse.");
					Item item2352= new Item(s.getKey(),"Jelentették, hogy K. megszökött lovastul.","K. was reported to have run away with his horse.");
					Item item2353= new Item(s.getKey(),"Azt mondják, hogy K.-t otthagyta a lova.","K. is said to have been deserted by his horse.");
					Item item2354= new Item(s.getKey(),"Úgy tunik, hogy K.-t minden gyerek szereti.","K. seems to be loved by every child.");
					Item item2355= new Item(s.getKey(),"Jelentették, hogy K.-t körözi a rendorség.","K. was reported to be wanted by the police.");
					...
					Item item2358= new Item(s.getKey(),"Azt mondják, 14 éves sem volt, mikor elvesztette.","She is said to have been less than fourteen when she lost it.");
					Item item2359= new Item(s.getKey(),"Azt mondják, hogy jobb egy lúdnyak két tyúknyaknál.","One goose neck is said to be better than two hen necks.");
					Item item2360= new Item(s.getKey(),"Feltehetoen vidéken bújkál.","He is supposed to be hiding in the country.");
					Item item2361= new Item(s.getKey(),"Úgy látszott, becsukták az ajtót.","The door seemed to have been closed.");
					...
					Item item2364= new Item(s.getKey(),"Úgy tunt, hogy van még hátra egy pár.","There seemed to be a few more left.");
					Item item2365= new Item(s.getKey(),"Azt mondják, ez már az utolsó mondat.","This sentence is said to be the last one.");
					Item item2366= new Item(s.getKey(),"Úgy látszik Évi megette a zsömlét.","Eve seems to have eaten the roll.");
					Item item2367= new Item(s.getKey(),"A jelentések szerint az ötödikrol zuhant ki.","He is reported to have fallen from the fifth floor.");
					Item item2368= new Item(s.getKey(),"Látszott rajta, hogy egész éjjel sírt.","He seemed to have been crying all night.");
					Item item2369= new Item(s.getKey(),"Azt hitték szegényrol, hogy szegény, pedig gazdag volt.","The poor bloke was thought to be poor though he was rich.");
					Item item2370= new Item(s.getKey(),"Azt mondják róla, hogy nem szeret senkit.","He is said to love nobody.");
					Item item2371= new Item(s.getKey(),"Azt mondják, hogy el kellett utaznia.","She's said to have had to leave.");
					Item item2372= new Item(s.getKey(),"Úgy látszik, nem érdekli semmi.","He doesn't seem to care about anything.");
					...
					Item item2376= new Item(s.getKey(),"Azt hitték, hogy ellopták a kocsiját.","His car was thought to have been stolen.");
					Item item2377= new Item(s.getKey(),"Úgy tartják, hogy Magyarország olyan mint a gyapjú; minden nagymosásnál összemegy.","Hungary is believed to be similar to wool; she shrinks with every big wash.");
					Item item2378= new Item(s.getKey(),"Meddig tart már, hogy levedd azt a szoknyát?","How long will it take you to take off that skirt?");
					Item item2379= new Item(s.getKey(),"Csak az tartott két órát, míg a mosolyt levakarták az arcáról. (Top Secret)","It took them two hours to take the smile off his face.");
					Item item2380= new Item(s.getKey(),"Egy hét is beletelt, mire Józsi kifestette a szobámat.","It took Joe a week to paint my room.");
					Item item2381= new Item(s.getKey(),"Meddig tart már, hogy kicseréld azt a zárat?","How long does it take you to change that lock?");
					Item item2382= new Item(s.getKey(),"Két perc alatt ott voltam.","It took me two minutes to get there.");
					Item item2383= new Item(s.getKey(),"Egy fél nap is lesz, míg kicserélik a fotengelyt.","It will take them half a day to replace the crankshaft.");
					Item item2384= new Item(s.getKey(),"Mennyi ido alatt érész Erzsébetrol Csepelre?","Hoe long does it take you to get to Csepel from Erzsébet.");
					Item item2385= new Item(s.getKey(),"Ha gyalog megyek 20 perc, ha kocsival, 30.","It takes me 20 minutes on foot and 30 minutes by car.");
					Item item2386= new Item(s.getKey(),"Mennyi ido alatt fognak Székesfehérvárról Moszkvába érni?","How long will it take them to get to Moscow from Székesfehérvár?");
					Item item2387= new Item(s.getKey(),"Négy nap alatt értünk Hágába.","It took us four days to get to the Hague.");
					Item item2388= new Item(s.getKey(),"Kevesebb mint 10 perc alatt összeütötte a rántottát.","It took her less than 10 minutes to make scrambled eggs.");
					Item item2389= new Item(s.getKey(),"Mennyi ido alatt olvastad el a 'Háború és Béké'-t?","How long did it take you to read 'War and Peace'?");
					...
					Item item2393= new Item(s.getKey(),"Órát kérj tole a születésnapodra.","Ask him for a watch for your birthday.");
					Item item2394= new Item(s.getKey(),"Greenwich-i ido szerint 5 óra van.","It is 5 hours GMT (Greenwich Mean Time).");
					Item item2395= new Item(s.getKey(),"Találkozzunk hatkor.","Let's meet at 6 o'clock.");
					Item item2396= new Item(s.getKey(),"Nálunk, a Csepeli Munkásotthonban egy tanítási óra 45 perc.","With us, in Csepel Workers' Home, one lesson is 45 minutes.");
					...
					Item item2410= new Item(s.getKey(),"100 forintot raboltak el az idos hölgytol.","They stole 100 forints from the old lady.");
					Item item2411= new Item(s.getKey(),"100 forintot raboltak el az idos hölgytol.","They robbed the old lady of 100 forints.");
					Item item2412= new Item(s.getKey(),"az egyetlen ember az irodában, aki dohányzik.","He's the only person in the office who smokes.");
					Item item2413= new Item(s.getKey(),"Az egyetlen probléma, hogy kicsit drága.","The only problem is that it's rather expensive.");
					Item item2414= new Item(s.getKey(),"Ez az egyetlen lehetoség, hogy meggyozzük ot.","This is the only way to convince him.");
					...
					Item item2417= new Item(s.getKey(),"Bárhová is mész, én veled megyek.","Wherever you go, I'm coming with you.");
					Item item2418= new Item(s.getKey(),"Bárhová is mész, bármit is csinálsz, én ott leszek.","Wherever you go, whatever you do, I'll be there. (Susie)");
					Item item2419= new Item(s.getKey(),"Barki is az, nem akarok találkozni vele.","Whoever it is, I don't want to see him.");
					Item item2420= new Item(s.getKey(),"Akárhogy is fáj, a Fradi itt a sztár.","However much it hurts, Fradi is the first.");
					Item item2421= new Item(s.getKey(),"Bármekkora is a fülem, nem hallok semmit.","However big my ears, I can't hear a thing.");
					Item item2422= new Item(s.getKey(),"Bármibe kerül, én megveszem neked.","Whatever it costs, I'll buy it for you.");
					Item item2423= new Item(s.getKey(),"Akármelyiket veszi el, úgyis megbánja.","Whichever he marries, he'll regret it.");
					...
					Item item2426= new Item(s.getKey(),"Akármennyi pénze is van, hülye oszt kész.","However much money he has, he's stupid and that's it.");
					Item item2427= new Item(s.getKey(),"Bármit is javasolok, mindig ellenkezik.","Whatever I suggest, he always disagrees.");
					...
					Item item2431= new Item(s.getKey(),"Vagyok én olyan lány, mint amilyen legény te vagy.","I am as tough a girl as tough a guy you are.");
					Item item2432= new Item(s.getKey(),"A poros nyomába se léphetsz az elso feleségemnek.","You are nothing like my first wife.");
					Item item2433= new Item(s.getKey(),"Te nem tudod mit beszélsz.","You don't know what you're saying.");
					Item item2434= new Item(s.getKey(),"Pontosan tudom, hogy milyen no volt az elso feleséged.","I know exactly what kind of a woman your first wife was.");
					Item item2435= new Item(s.getKey(),"Igyekezett mindenkinek örömet szerezni.","She tried hard to please everyone.");
					Item item2436= new Item(s.getKey(),"már csak ilyen volt.","She was just like that.");
					Item item2437= new Item(s.getKey(),"De azért nem volt olyan önzo, mint te.","But she wasn't as selfish as you are.");
					Item item2438= new Item(s.getKey(),"Sokkal jobban fozött mint te, és kész.","She was much better at cooking than you and that's it.");
