...
public class Init extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (needLoad) {
				...
				kis_angol_forditasi_gyakorlat1(pm);
				kis_angol_forditasi_gyakorlat2(pm);
	...
	public void kis_angol_forditasi_gyakorlat1(PersistenceManager pm) {
	...
	public void kis_angol_forditasi_gyakorlat2(PersistenceManager pm) {
		Query querySubTheme = pm.newQuery("select from "
				+ SubTheme.class.getName());
		@SuppressWarnings("unchecked")
		List<SubTheme> subThemeList = (List<SubTheme>) pm.newQuery(
